...
Public Class DAL_OrgConfig
    ...
    Public Function UpdateOrgConfig(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal OrgID As String, ByVal Mas_org_ID As String, ByVal Sales_org_ID As String, ByVal Emp_Code As String) As Boolean
        Dim objSQLConn As SqlConnection
        Dim objSQLCmd As SqlCommand
