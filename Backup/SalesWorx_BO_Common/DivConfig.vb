...
#End Region
    ...
    Public Function InsertDivConfig(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal CreatedBy As Integer) As Boolean
        Try
            Return objDivConfig.InsertDivConfig(Err_No, Err_Desc, _sOrg_ID, _sAllow_Manual_FOC, _sOdo_Reading_At_Visit, _sAdvance_PDC_Posting, _sDC_Optional, _sPrintFormat, _sCollection_Output_Folder, _sCRLimit, CreatedBy)
    ...
    Public Function UpdateDivConfig(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal UpdatedBy As Integer) As Boolean
        Try
            Return objDivConfig.UpdateDivConfig(Err_No, Err_Desc, _sOrg_ID, _sAllow_Manual_FOC, _sOdo_Reading_At_Visit, _sAdvance_PDC_Posting, _sDiv_Config_ID, _sDC_Optional, _sPrintFormat, _sCollection_Output_Folder, _sCRLimit, Updatedby)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
