...
Public Class AssetType
    ...
    Public Function InsertAssetType(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal userId As Integer) As Boolean
        ...
        End Try
    End Function
    Public Function InsertAssets(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal userId As Integer, ByVal ASsetType As Integer, ByVal CustID As Integer, ByVal SiteID As Integer, ByVal AssetCode As String, ByVal Description As String, ByVal IsActive As String) As Boolean
        Try
            Return ObjDAlAssetType.InsertAssets(Err_No, Err_Desc, userId, ASsetType, CustID, SiteID, AssetCode, Description, IsActive)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function GetCustomerandSiteID(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal CustNo As String, ByVal OrgID As String) As DataRow
        ...
        End Try
    End Function
    Public Function UpdateAssets(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal userId As Integer, ByVal AssetId As String, ByVal ASsetType As Integer, ByVal CustID As Integer, ByVal SiteID As Integer, ByVal AssetCode As String, ByVal Description As String, ByVal IsActive As String) As Boolean
        Try
            Return ObjDAlAssetType.UpdateAssets(Err_No, Err_Desc, AssetId, ASsetType, userId, CustID, SiteID, AssetCode, Description, IsActive)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    ...
    Public Function FillAssets(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal orgId As String) As DataTable
        ...
        End Try
    End Function
    Public Function GetAssetByID(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal AssetId As String) As DataTable
        Try
            Return ObjDAlAssetType.GetAssetID(Err_No, Err_Desc, AssetId)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
