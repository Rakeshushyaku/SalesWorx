...
Public Class Currency
    ...
    Public Function InsertCurrency(ByRef Err_No As Long, ByRef Err_Desc As String) As Boolean
        Try
            Return ObjDAlCurrency.InsertCurrency(Err_No, Err_Desc, _sCurrencyCode, _sDescription, _dRate, _ddigits)
    ...
    Public Function UpdateCurrency(ByRef Err_No As Long, ByRef Err_Desc As String) As Boolean
        Try
            Return ObjDAlCurrency.UpdateCurrency(Err_No, Err_Desc, _sCurrencyCode, _sDescription, _dRate, _ddigits)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
