<%@ Page Title="Export Rights" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/DefaultLayout.Master" CodeBehind="Rep_ExportRightsbyUsers.aspx.vb" Inherits="SalesWorx_BO.Rep_ExportRightsbyUsers" %>
        ...
        <tr>
            <td id="contentofpage" width="100%" height="76%" class="topshadow">
                <div class="pgtitileposition">
                    <span class="pgtitile3">Export Users and Rights</span></div>
                                ...
                                <td>
                                    ...
                                    <table cellpadding="4" cellspacing="4">
                                        ...
                                        <tr>
                                            ...
                                            <td class="txtSMBold">
                                                <asp:DropDownList ID="drpUser"  CssClass="inputSM"   Width ="250px" runat="server" AutoPostBack="True" >
                                                </asp:DropDownList>
                                            ...
                                            <td> 
                                                <telerik:RadTreeList ID="TreeViewRights" runat="server" 
                                                    ...
                                                    ParentDataKeyNames="PID" Skin="Vista" width="950">
                                                    <Columns>
                                                        <telerik:TreeListBoundColumn DataField="Name" HeaderText="User Name" 
                                                            UniqueName="UserType" ItemStyle-Width="200" HeaderStyle-Width="200">
                                                        </telerik:TreeListBoundColumn>
                                                         <telerik:TreeListBoundColumn DataField="Designation" HeaderText="Designation" 
                                                            UniqueName="Designation" ItemStyle-Width="200"  HeaderStyle-Width="200">
                                                        </telerik:TreeListBoundColumn>
                                                         <telerik:TreeListBoundColumn DataField="UserType" HeaderText="User Type" 
                                                            UniqueName="UserType" ItemStyle-Width="200"  HeaderStyle-Width="200">
                                                        </telerik:TreeListBoundColumn>
