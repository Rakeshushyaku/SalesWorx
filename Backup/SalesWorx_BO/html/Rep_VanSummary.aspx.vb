...
Partial Public Class Rep_VanSummary
    ...
    Private Sub InitReportViewer()
        ...
        End If
            ...
            fromdate = DateAdd(DateInterval.Day, -1, CDate(txtFromDate.Text)).ToString("dd-MMM-yyyy") & " " & EndTime
            todate = CDate(txtToDate.Text).ToString("dd-MMM-yyyy") & " " & EndTime
            ...
            With RVMain
                ...
                .ServerReport.SetParameters(New ReportParameter() {OID, SalesRepID, FDate, TDate, PER})
    ...
    Protected Sub ddlOrganization_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles ddlOrganization.SelectedIndexChanged
        ...
        If Not (ddlOrganization.SelectedItem.Value = "-- Select a value --") Then
            ...
            ddl_Van.DataTextField = "SalesRep_Name"
               ddl_Van.DataBind()
            ddl_Van.Items.Insert(0, New ListItem("-- Select --", "-1"))
