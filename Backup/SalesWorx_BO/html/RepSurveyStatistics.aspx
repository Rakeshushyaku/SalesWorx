<%@ Page Title="Survey Statistics" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="RepSurveyStatistics.aspx.vb" Inherits="SalesWorx_BO.RepSurveyStatistics" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Survey Statistics</span></div>
...
<td style="padding:6px 12px" >
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
          ...
          <td  class="txtSMBold">Organization :</td>
            ...
            <td  class="txtSMBold" align="right">Survey :</td>
            <td><asp:DropDownList CssClass="inputSM" Width ="200px" ID="ddlSurvey" runat="server" 
                    DataTextField="Survey_title" DataValueField="Survey_Id"/>
            </td>
                 <td  class="txtSMBold">
            ...
            <tr>
                ...
                <td width="105" class="txtSMBold"><asp:Label ID="lblEndDatetxt" runat="server" 
                        Text="End Date :" Visible="False"></asp:Label></td>
                <td><asp:Label ID="lblEndDateval" runat="server" Visible="False"></asp:Label>
                </td>
            </tr>      
        </table>
