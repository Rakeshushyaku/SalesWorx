<%@ Page Title="Statement of Van Sales" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="Rep_StatementofVanSales.aspx.vb" Inherits="SalesWorx_BO.Rep_StatementofVanSales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Statement of Van Sales</span></div>
...
<table  border="0" cellspacing="2" cellpadding="2"  width="90%" >
          <tr>
            ...
            <td><asp:DropDownList CssClass="inputSM" ID="ddlVan"  Width ="200px"
                    runat="server"  ></asp:DropDownList>
                     </td>
              <td class="txtSMBold">Documents :</td>
              <td>
                  <asp:DropDownList CssClass="inputSM" ID="ddlType"  Width ="131px"
                    runat="server" AutoPostBack="true"  >
                    <asp:ListItem Text="All" Value="A" Selected="True"></asp:ListItem>
                    <asp:ListItem Text="Outstanding" Value="O"></asp:ListItem>
                    </asp:DropDownList></td>
          </tr> 
