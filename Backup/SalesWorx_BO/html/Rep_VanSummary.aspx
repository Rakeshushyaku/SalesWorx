<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="Rep_VanSummary.aspx.vb" Inherits="SalesWorx_BO.Rep_VanSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Van Summary</span></div>
...
<table  border="0" cellspacing="2" cellpadding="2" >
          ...
          <tr>
              <td class="txtSMBold">
                  Unload Percentage:</td>
              <td>
                  <asp:TextBox ID="txt_Per" runat="server" CssClass="inputSM" Width="150px" onKeypress='return NumericOnly(event)'></asp:TextBox><span  class="txtSMBold">(%)</span>
