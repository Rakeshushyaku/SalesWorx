<%@ Page Title="Van Requisition Details" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/DefaultLayout.Master"
    CodeBehind="VanRequisitionDetails.aspx.vb" Inherits="SalesWorx_BO.VanRequisitionDetails" %>
                        ...
                        <td style="padding: 6px 12px">
                         <table width="100%" cellspacing="3" cellpadding="3"  >
                                                ...
                                                <tr><td class='txtSMBold' >Stock Requisition ID: &nbsp;<span class='txtSM'>
                                                     ...
                                                     <asp:Label ID="lblReqDate" runat="server" Text=""></asp:Label></span></td></tr>
                                                 ...
                                                 <tr><td  colspan=2>
                                                  <asp:GridView Width="100%" ID="gvVanReq" runat="server" EmptyDataText="No product details found."
                                                    EmptyDataRowStyle-Font-Bold="False" EmptyDataRowStyle-HorizontalAlign="Center"  
                                                     CssClass="oldpagetable" AutoGenerateColumns="False"
                                                  ...
                                                  <tr><td class='txtSMBold' colspan=2 ><table border="0" cellpadding="0" cellspacing="0"><tr><td align="center">Signature :</td><td><asp:Image ID="imgSig" 
                                                     ...
                                                     <div class="no-print">
                                                         <asp:Button ID="btnApprove" CssClass="btnInput" runat="server" Text="Approve" />
                                                         <asp:Button ID="Button1" runat="server" CssClass="btnInput" 
                                                             PostBackUrl="~/html/VanRequisitions.aspx" Text="Cancel" /></div>
                                                         </td></tr>
                                                          <tr><td  colspan=2 >&nbsp;</td> </tr> 
