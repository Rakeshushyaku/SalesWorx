...
Partial Public Class CustomerOrderlvlDiscount
        ...
        Try
            ...
            If Me.ddl_org.SelectedIndex > 0 Then
                ...
                If dtTemp.Rows.Count > 0 Then
                    ...
                    Dim fn As String = "CustomerOrderDiscount" + ".xls"
    ...
    Protected Sub btnAddItems_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAddItems.Click
        ...
        If txtMinValue.Text.Trim = "" Or Me.txtMaxValue.Text = "" Then
            Me.lblinfo.Text = "Validation"
            Me.lblMessage.Text = "Please enter the Min/Max Discount"
            Me.lblMessage.ForeColor = Drawing.Color.Red
            Me.MpInfoError.Show()
            ClassUpdatePnl1.Update()
            Exit Sub
        ...
        If Val(txtMinValue.Text) > 100 Or Val(txtMinValue.Text) < 0 Then
            Me.lblinfo.Text = "Validation"
            Me.lblMessage.Text = "Minimum Discount Percentage between 0 to 100"
            Me.lblMessage.ForeColor = Drawing.Color.Red
            Me.MpInfoError.Show()
            ClassUpdatePnl1.Update()
            Exit Sub
        ...
        If Val(txtMaxValue.Text) > 100 Or Val(txtMaxValue.Text) < 0 Then
            Me.lblinfo.Text = "Validation"
            Me.lblMessage.Text = "Maximum Discount Percentage between 0 to 100"
            Me.lblMessage.ForeColor = Drawing.Color.Red
            Me.MpInfoError.Show()
            ClassUpdatePnl1.Update()
            Exit Sub
        ...
        If Val(txtMinValue.Text) > Val(txtMaxValue.Text) Then
            Me.lblinfo.Text = "Validation"
            Me.lblMessage.Text = "Minimum percentage should be less than or equal to maximum percentage"
            Me.lblMessage.ForeColor = Drawing.Color.Red
            Me.MpInfoError.Show()
            ClassUpdatePnl1.Update()
            Exit Sub
        ...
        If ddlCustomer.SelectedItem.Text <> "" Then
            id = ddlCustomer.SelectedItem.Value.Split("$")
            If objCustomer.SaveCustOrderDiscount(Err_No, Err_Desc, id(0), id(1), txtvalue.Text, Me.txtMinValue.Text, Me.txtMaxValue.Text) Then
                BindDiscountData()
                Me.lblinfo.Text = "Information"
                ...
                If btnAddItems.Text = "Add" Then
                    objLogin.SaveUserLog(Err_No, Err_Desc, "I", "MAIN MENU", "CUSTOMER ORDER LVL DISC", ddlCustomer.SelectedItem.Value, "Org Val: " & ddl_org.SelectedItem.Value & " Order Val: " & txtvalue.Text.Trim & " Min Discount:" & txtMinValue.Text & " Max Discount:" & Me.txtMaxValue.Text, CType(Session("User_Access"), UserAccess).UserID.ToString(), "0", "0")
                Else
                    objLogin.SaveUserLog(Err_No, Err_Desc, "U", "MAIN MENU", "CUSTOMER ORDER LVL DISC", ddlCustomer.SelectedItem.Value, "Org Val: " & ddl_org.SelectedItem.Value & " Order Val: " & txtvalue.Text.Trim & " Max Discount:" & txtMinValue.Text & " Max Discount:" & Me.txtMaxValue.Text, CType(Session("User_Access"), UserAccess).UserID.ToString(), "0", "0")
                End If
            Else
                Me.lblinfo.Text = "Information"
