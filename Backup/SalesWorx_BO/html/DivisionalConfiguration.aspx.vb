...
Partial Public Class DivisionalConfiguration
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If drpOrganization.SelectedValue = "0" Then
            ...
            MessageBoxValidation("Please select organization.")
            MPEDivConfig.Show()
            Return
        End If
        If String.IsNullOrEmpty(txtCollectionOutputFolder.Text) Then
            MessageBoxValidation("Please specify collection output folder.")
            MPEDivConfig.Show()
            Return
        End If
        ...
        Try
            ...
            If objDivConfig.CheckDivControl(Err_No, Err_Desc, Me.drpOrganization.SelectedValue.ToString()) Then
                Me.lblMessage.Text = "This organization already exisi"
        ...
        Catch ex1 As SqlClient.SqlException
            If ex1.Number = "2601" Then
                Me.lblMessage.Text = "Organization already exists."
    ...
    Protected Sub btnEdit_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            Dim li As ListItem = drpOrganization.Items.FindByText(Trim(row.Cells(1).Text))
    ...
    Protected Sub btnDelete_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Try
            ...
            If success = True Then
                ...
                Resetfields()
            Else
                MessageBoxValidation("Error occured while deleting configuration.")
                log.Error(Err_Desc)
    ...
    Protected Sub btnDeleteAll_Click()
        Try
            ...
            End If
            If (Success = True) Then
                lblMessage.Text = "Sales Org(s) deleted successfully."
                lblMessage.ForeColor = Drawing.Color.Green
                lblinfo.Text = "Information"
                MpInfoError.Show()
                btnClose.Focus()
                ...
                Resetfields()
            Else
                MessageBoxValidation("Error occured while deleting configuration(s).")
                log.Error(Err_Desc)
    ...
    Sub LoadVanbyDivision()
        ...
        For Each dr As DataRow In dtVan.Rows
            ...
            chkItem = chkSalesRep.Items.FindByValue(dr("SalesRep_ID").ToString())
