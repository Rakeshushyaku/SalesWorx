<%@ Page Title="Customer Survey" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="RepCustomerSurvey.aspx.vb" Inherits="SalesWorx_BO.RepCustomerSurvey" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Customer Survey</span></div>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
           ...
           <tr>
            ...
            <td><asp:DropDownList CssClass="inputSM" ID="ddlOrganization"   Width ="150px"
               ...
               <td class="txtSMBold"  >Survey :</td>
            <td><asp:DropDownList CssClass="inputSM" ID="ddlSurvey" Width ="200px" runat="server" AutoPostBack="true" DataTextField="Survey_title" DataValueField="Survey_Id"/>
            </td>
              <td>&nbsp;
          ...
          <tr>
                 ...
                 <td class="txtSMBold" >Customer :</asp:Label></td>
                 <td  class="txtSMBold">
                <asp:DropDownList CssClass="inputSM" Width ="200px" ID="ddlCustomer" runat="server" AutoPostBack="false" DataTextField="Name" DataValueField="ID"/>                        
              </td>
