<%@ Page Title="Price Variation Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="Rep_PriceVariation.aspx.vb" Inherits="SalesWorx_BO.Rep_PriceVariation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Price Variation Report</span></div>
...
<table  border="0" cellspacing="2" cellpadding="2"  width="100%" >
          <tr>
            ...
            <td><asp:DropDownList CssClass="inputSM" ID="ddl_Van"  Width ="200px"
          ...
          <tr>
              ...
              <td>
                  <asp:DropDownList CssClass="inputSM" ID="ddl_Customer"  Width ="225px"
                    runat="server" AutoPostBack="true"  >
                    
                    </asp:DropDownList></td>
                                                        <td class="txtSMBold">Item:</td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlSKU" runat="server" AutoPostBack="true" 
                                                                CssClass="inputSM" Width="225px">
                                                            </asp:DropDownList>
              </td>
              <td>
                  &nbsp;</td>
          ...
          <tr>
              <td class="txtSMBold">
                  From Date:</td>
              <td>
                  <asp:TextBox ID="txtfromDate" runat="server" CssClass="inputSM" Width="150px"></asp:TextBox>
                  <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" 
                      CssClass="cal_Theme1" Format="dd-MMM-yyyy" PopupButtonID="txtfromDate" 
                      TargetControlID="txtfromDate" />
              </td>
              <td class="txtSMBold">
                  To Date:</td>
              <td>
                  <asp:TextBox ID="txtToDate" runat="server" CssClass="inputSM" Width="150px"></asp:TextBox>
                  <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" 
                      CssClass="cal_Theme1" Format="dd-MMM-yyyy" PopupButtonID="txtToDate" 
                      TargetControlID="txtToDate" />
              </td>
              <td class="txtSMBold">
                  Type:</td>
              <td>
                  <asp:DropDownList ID="ddlType" runat="server" CssClass="inputSM" >
                   <asp:ListItem Value="B" Selected="True">Both</asp:ListItem>
                   <asp:ListItem Value="I">Increased</asp:ListItem>
                   <asp:ListItem Value="D">Decreased</asp:ListItem>
                  </asp:DropDownList>
