    ...
    Private Sub BindData()
        ...
        Try
            ...
            ElseIf (From_Message_Date.Text <> "" And To_Message_Date.Text = "" And SalesRep_ID.SelectedItem.Value = "-- Select a Van --") Then
                ...
                SearchQuery = "  and  A.Message_Date>='" & MsgDat(1) & "-" & MsgDat(0) & "-" & MsgDat(2) & " 00:00:00' AND A.Message_Date<='" & MsgDat(1) & "-" & MsgDat(0) & "-" & MsgDat(2) & " 23:59:59'"
            ElseIf (From_Message_Date.Text <> "" And To_Message_Date.Text <> "" And SalesRep_ID.SelectedItem.Value = "-- Select a Van --") Then
                Dim MsgDat As Array = From_Message_Date.Text.Split("/")
                Dim ToDat As Array = To_Message_Date.Text.Split("/")
                SearchQuery = " and  A.Message_Date>='" & MsgDat(1) & "-" & MsgDat(0) & "-" & MsgDat(2) & " 00:00:00' AND A.Message_Date<='" & ToDat(1) & "-" & ToDat(0) & "-" & ToDat(2) & " 23:59:59'"
            ElseIf (From_Message_Date.Text <> "" And To_Message_Date.Text = "" And SalesRep_ID.SelectedItem.Value <> "-- Select a Van --") Then
                Dim MsgDat As Array = From_Message_Date.Text.Split("/")
                SearchQuery = " And B.SalesRep_Name='" & SalesRep_ID.SelectedItem.Text & "' and  A.Message_Date>='" & MsgDat(1) & "-" & MsgDat(0) & "-" & MsgDat(2) & " 00:00:00' AND A.Message_Date<='" & MsgDat(1) & "-" & MsgDat(0) & "-" & MsgDat(2) & " 23:59:59'"
            ElseIf (From_Message_Date.Text <> "" And To_Message_Date.Text <> "" And SalesRep_ID.SelectedItem.Value <> "-- Select a Van --") Then
                Dim MsgDat As Array = From_Message_Date.Text.Split("/")
                Dim ToDat As Array = To_Message_Date.Text.Split("/")
                SearchQuery = " And B.SalesRep_Name='" & SalesRep_ID.SelectedItem.Text & "' and  A.Message_Date>='" & MsgDat(1) & "-" & MsgDat(0) & "-" & MsgDat(2) & " 00:00:00' AND A.Message_Date<='" & ToDat(1) & "-" & ToDat(0) & "-" & ToDat(2) & " 23:59:59'"
            ElseIf (From_Message_Date.Text = "" And To_Message_Date.Text <> "" And SalesRep_ID.SelectedItem.Value <> "-- Select a Van --") Then
                SearchQuery = " And B.SalesRep_Name='" & SalesRep_ID.SelectedItem.Text & "'"
            End If
