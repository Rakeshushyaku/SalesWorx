<%@ Page Title="Audit Survey" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="RepAuditSurvey.aspx.vb" Inherits="SalesWorx_BO.RepAuditSurvey" %>
...
<td style="padding:6px 12px" >
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
          ...
          <tr>
               <td  class="txtSMBold" >Van :</asp:Label></td>
                 <td width="105" class="txtSMBold">
                <asp:DropDownList CssClass="inputSM" ID="ddlCustomer" Width ="200px" runat="server" AutoPostBack="true" DataTextField="Name" DataValueField="ID"/>                        
              </td>
          </tr>
