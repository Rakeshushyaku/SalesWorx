<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="Rep_SalesbyVan.aspx.vb" Inherits="SalesWorx_BO.Rep_SalesbyVan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Sales by Van</span></div>
...
<table  border="0" cellspacing="2" cellpadding="2" >
          ...
          <%--           <asp:BoundField DataField="Scanned_Closing" ItemStyle-HorizontalAlign="center" HeaderText="Scanned" >
           ...
           <tr> 
              <td class="txtSMBold">Area:</td>           
            <td> 
                  
                       <asp:DropDownList ID="ddlArea" runat="server" CssClass="inputSM">
                       </asp:DropDownList>
           ...
           <tr class="txtSMBold"> 
            ...
            <td style="margin-left:5px;margin-right:5px" colspan="2"> 
