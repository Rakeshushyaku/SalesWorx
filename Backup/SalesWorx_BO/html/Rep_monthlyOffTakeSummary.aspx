<%@ Page Title="Off Take Summary Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="Rep_monthlyOffTakeSummary.aspx.vb" Inherits="SalesWorx_BO.Rep_monthlyOffTakeSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#f6f6f6">
	...
	<span class="pgtitile3">Off Take Summary Report</span></div>
