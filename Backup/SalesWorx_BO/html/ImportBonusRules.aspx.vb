                            ...
                            For idx = 0 To TempTbl.Rows.Count - 1
                                ...
                                If OrgID <> "0" Then
                                    ...
                                    Else
                                        ...
                                        If objProduct.SaveBonusData(Err_No, Err_Desc, OrderItem, OrgID, OrderUOM, BonusItem, BonusUOM, Type, CLng(FromQty), CLng(ToQty), CLng(GetQty), 0, FromDate, ToDate, CType(Session.Item("USER_ACCESS"), UserAccess).UserID, "0") = True Then
