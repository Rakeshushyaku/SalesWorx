<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="RepWarehousePurchase.aspx.vb" Inherits="SalesWorx_BO.RepWarehousePurchase" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Warehouse Purchase</span></div>
          ...
          <tr>
            ...
            <td>
                &nbsp;<asp:DropDownList ID="ddlAgency" runat="server" CssClass="inputSM" 
                    DataTextField="Price_List_Type" DataValueField="Price_List_ID" Width="200px">
                </asp:DropDownList>
