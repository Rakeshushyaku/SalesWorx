<%@ Page Title="Van Requisitions" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/DefaultLayout.Master"
    CodeBehind="VanRequisitions.aspx.vb" Inherits="SalesWorx_BO.VanRequisitions" %>
        ...
        <tr>
            <td id="contentofpage" width="100%" height="76%" class="topshadow">
                <div class="pgtitileposition">
                    <span class="pgtitile3">Van Requisitions</span></div>
                                            ...
                                            <td>
                                                <asp:GridView Width="100%" ID="gvVanReq" runat="server" EmptyDataText="No details found."
                                                    ...
                                                    <Columns>
                                                        <%--<asp:TemplateField>
                                                            <HeaderTemplate>
                                                                <asp:CheckBox ID="cbSelectAll" onclick="CheckAll(this)" ToolTip="Select/Unselect All"
                                                                    runat="server" />
                                                                <asp:ImageButton ToolTip="Delete Selected Items " ID="btnDeleteAll" runat="server" OnClick="btnDeleteAll_Click"
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:ImageButton ToolTip="Delete Configuration" ID="btnDelete" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"Div_Config_ID") %>' OnClick="btnDelete_Click"
                                                                    runat="server" CausesValidation="false"  ImageUrl="~/images/delete-13.png" OnClientClick="javascript:return confirm('Would you like to delete the selected configuration?');" />
                                                                <asp:ImageButton ID="btnEdit" ToolTip="Edit Configuration" runat="server" CausesValidation="false" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"Div_Config_ID") %>'   ImageUrl="~/images/edit-13.png"   OnClick="btnEdit_Click"  />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>--%>
                                                        <asp:BoundField DataField="StockRequisition_ID" Visible="false"  HeaderText="Stock Requisition ID" SortExpression="StockRequisition_ID">
                                                        ...
                                                        <asp:TemplateField >
                                                         <ItemTemplate>
                                                            <asp:HyperLink  runat="server"  ID="hyp" Text="Details" NavigateUrl='<%# DataBinder.Eval(Container.DataItem, "StockRequisition_ID","VanRequisitionDetails.aspx?id={0}")%>'></asp:HyperLink>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
