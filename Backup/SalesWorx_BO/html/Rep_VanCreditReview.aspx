<%@ Page Title="Van Credit Review" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="Rep_VanCreditReview.aspx.vb" Inherits="SalesWorx_BO.Rep_VanCreditReview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Van Credit Review</span></div>
...
<table  border="0" cellspacing="2" cellpadding="2"  width="70%" >
          <tr>
            ...
            <td class="style2"><asp:DropDownList CssClass="inputSM" ID="ddlVan"  Width ="200px"
          ...
          <tr>
              <td class="txtSMBold">
                  Percentage</td>
              <td>
                  <asp:TextBox ID="txtPerc" runat="server" CssClass="inputSM" Width="150px" onKeypress='return NumericOnly(event)'></asp:TextBox>
