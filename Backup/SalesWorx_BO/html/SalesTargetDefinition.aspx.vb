    ...
    If IsNothing(Session("USER_ACCESS")) Then
        ...
        Try
            If Not IsPostBack Then
                ...
                ddlOrganization.Items.Add("-- Select a Organization --")
                ...
                ddl_importOrg.Items.Add("-- Select a Organization --")
                ...
                ddl_ExportOrg.Items.Add("-- Select a Organization --")
                ...
                Me.ddlVan.Items.Insert(0, "--Select--")
                Me.ddlVan.Items(0).Value = ""


                Me.ddl_ExportVan.Items.Clear()
                Me.ddl_ExportVan.Items.Insert(0, "--All--")
...
End Sub
    ...
    Private Sub ddlOrganization_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlOrganization.SelectedIndexChanged
            ...
            ddlVan.DataBind()
            ddlVan.Items.Insert(0, New ListItem("-- Select --", "-1"))
    ...
    Sub LoadYear()
        ...
        ddl_ImportYear.Items.Insert(0, New ListItem("-- Select --", 0))

        ddl_ImportMonth.Items.Clear()
        ddl_ImportMonth.Items.Insert(0, New ListItem("-- Select --", 0))
        ...
        ddl_ExportYear.Items.Insert(0, New ListItem("-- Select --", 0))

        ddl_ExportMonth.Items.Clear()
        ddl_ExportMonth.Items.Insert(0, New ListItem("-- Select --", 0))
    End Sub
 Sub LoadMonth()
        ddlMonth.Items.Clear()
   ...
   End Sub
    ...
    Private Sub Btn_Save_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btn_Save.Click
        ...
        End If
        If ddlVan.SelectedItem.Value = "-1" Then
            MessageBoxValidation("Please select the van")
            ClassUpdatePnl1.Update()
            Exit Sub
        End If
        If ddlYear.SelectedItem.Value = "0" Then
            MessageBoxValidation("Please select the target year")
            ClassUpdatePnl1.Update()
            Exit Sub
        End If
        If ddlMonth.SelectedItem.Value = "0" Then
            MessageBoxValidation("Please select the target month")
            ClassUpdatePnl1.Update()
            Exit Sub
        End If
        HSaveClick.Value = "1"
        ...
        If ddl_ValueType.SelectedItem.Value = "Q" Then
           If Not ValidateQty() Then
            MessageBoxValidation("You have not entered any target quantity.Please enter at least one target quantity")
            ClassUpdatePnl1.Update()
            Exit Sub
           End If
        ElseIf ddl_ValueType.SelectedItem.Value = "V" Then
            If Not ValidateValue() Then
            MessageBoxValidation("You have not entered any target value.Please enter at least one target value")
            ClassUpdatePnl1.Update()
            Exit Sub
           End If
        ElseIf ddl_ValueType.SelectedItem.Value = "B" Then
            ...
            If bNoRow = False Then
                MessageBoxValidation("Please enter at least one target quantity and value")
                ClassUpdatePnl1.Update()
                Exit Sub
            End If
        ...
        If _objSalesTarget.SaveSalesTarget(Err_No, Err_Desc, CType(Session("User_Access"), UserAccess).UserID, ddlVan.SelectedItem.Value, ddlYear.SelectedItem.Value, ddlMonth.SelectedItem.Value, ddl_ValueType.SelectedItem.Value, dt) Then
                MessageBoxValidation("Sales Target saved")
                ClassUpdatePnl1.Update()
                Cache.Remove("TargetDef")
                LoadTargetDefinition()
        ...
        Else
            MessageBoxValidation("Sales Target could not be saved.Please contact the administrator.")
        End If
        End If
    End Sub
    ...
    Private Sub Btn_Export_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btn_Export.Click
        ...
        ExportToExcel("SalesTarget.xls", exportdt)
    End Sub
        ...
        End If
          ...
          If dt.Rows.Count Then
                ...
                If seldr.Length > 0 Then
                     LoadPriceListMP()
                Else
                 MessageBoxValidation("You have not entered any Target quantity. You can load target value from quantity only if you define target quantity")
                End If
          End If
    ...
    Private Sub ddl_ImportYear_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddl_ImportYear.SelectedIndexChanged
         ...
         For i As Integer = 1 To 12
            ddl_ImportMonth.Items.Add(New ListItem(CDate(i & "/01/1900").ToString("MMM"), i.ToString))
           Next
                ddl_ImportMonth.Items.Insert(0, New ListItem("-- Select --", 0))
    End Sub
...
Private Function DoXLSUpload() As DataTable
    ...
    Private Sub ddl_ExportOrg_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddl_ExportOrg.SelectedIndexChanged
         Dim objUserAccess As UserAccess
            ...
            ddl_ExportVan.Items.Insert(0, New ListItem("-- All --", "-1"))
    End Sub
    ...
    Private Sub ddl_ExportYear_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddl_ExportYear.SelectedIndexChanged
        ddl_ExportMonth.Items.Clear()
         ...
         For i As Integer = 1 To 12
            ddl_ExportMonth.Items.Add(New ListItem(CDate(i & "/01/1900").ToString("MMM"), i.ToString))
           Next
                ddl_ExportMonth.Items.Insert(0, New ListItem("-- Select --", 0))
    End Sub
End Class