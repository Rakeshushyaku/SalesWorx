<%@ Page Title="Sales by Agency" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="Rep_SalesByAgency.aspx.vb" Inherits="SalesWorx_BO.Rep_SalesByAgency" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Sales by Agency</span></div>
...
<table  border="0" cellspacing="2" cellpadding="2" >
          ...
          <%--           <asp:BoundField DataField="Scanned_Closing" ItemStyle-HorizontalAlign="center" HeaderText="Scanned" >
           ...
           <tr valign="top"> 
            ...
            <td style="margin-left:5px;margin-right:5px; width:300px" > 
                 <telerik:RadComboBox ID="ddl_Agency" Width="250px" runat="server" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" AutoPostBack="true"
                CssClass="inputSM"      >
                       </telerik:RadComboBox>
            </td>   
