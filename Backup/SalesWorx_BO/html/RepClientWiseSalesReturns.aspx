<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="RepClientWiseSalesReturns.aspx.vb" Inherits="SalesWorx_BO.RepClientWiseSalesReturns" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Client Wise  Sales/Returns </span></div>
...
<table  border="0" cellspacing="2" cellpadding="2">
          ...
          <tr> 
            ...
            <td>
             ...
             <td><asp:Button ID="SearchBtn" runat="server" 
                        CssClass="btnInput" Text="Search" />
              </td>
          </tr>   
          ...
          <tr>
              ...
              <td>
                  <asp:DropDownList ID="ddlType" runat="server" 
                      ...
                      <asp:ListItem Text="Bar Graph" Value="BG"></asp:ListItem>
                      <asp:ListItem Text="Pie Graph" Value="PG"></asp:ListItem>
                      <asp:ListItem Text="Polar Graph" Value="RG"></asp:ListItem>
                  </asp:DropDownList>
              </td>
              <td class="txtSMBold">
                  &nbsp;</td>
