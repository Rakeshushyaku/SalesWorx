<%@ Page Title="Cash Van Audit Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="RepCashVanAudit.aspx.vb" Inherits="SalesWorx_BO.RepCashVanAudit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Cash Van Audit Report</span></div>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
          ...
          <tr>
            ...
            <td class="txtSMBold">&nbsp;</td>
                 ...
                 <td class="txtSMBold">
                <asp:DropDownList CssClass="inputSM" ID="ddlVan" runat="server"  Width ="200px"
