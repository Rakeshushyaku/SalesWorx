<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="Rep_OutofStock.aspx.vb" Inherits="SalesWorx_BO.Rep_OutofStock" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Out of Stock</span></div>
...
<table  border="0" cellspacing="2" cellpadding="2">
          <tr>
            ...
            <td><asp:DropDownList CssClass="inputSM" ID="ddlOrganization"   Width ="150px"
             ...
             <td><asp:DropDownList CssClass="inputSM" ID="ddlOutlet" 
          ...
          <tr>
              <td class="txtSMBold">
                  Date:</td>
              <td>
                  <asp:TextBox ID="txtDate" runat="server" CssClass="inputSM" Width="150px"></asp:TextBox>
                  &nbsp;
                  <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" 
                      CssClass="cal_Theme1" Format="dd-MMM-yyyy" PopupButtonID="txtDate" 
