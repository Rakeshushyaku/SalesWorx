<%@ Page Title="Article Movements" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="Rep_ArticleMovements.aspx.vb" Inherits="SalesWorx_BO.Rep_ArticleMovements" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Article Movements</span></div>
...
<table  border="0" cellspacing="2" cellpadding="2" >
          ...
          <tr> 
            <td  class="txtSMBold">Document Type :</td>
            <td >
                <asp:DropDownList CssClass="inputSM" ID="ddlDocument"  Width ="150px"
                runat="server" DataTextField="Customer" DataValueField="CustomerID">
                <asp:ListItem Text="All" Value="ALL"></asp:ListItem>
                <asp:ListItem Text="Invoice" Value="I"></asp:ListItem>
                 <asp:ListItem Text="Credit Note" Value="C"></asp:ListItem>
                </asp:DropDownList>            
            </td>            
            <td>
