<%@ Page Title="Sales Districts" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/DefaultLayout.Master" CodeBehind="AdminSalesDistrict.aspx.vb" Inherits="SalesWorx_BO.AdminSalesDistrict" %>
        ...
        <tr>
            <td id="contentofpage" width="100%" height="76%" class="topshadow">
                <div class="pgtitileposition">
                    <span class="pgtitile3">Sales District Management</span></div>
                            ...
                            <asp:UpdatePanel ID="ClassUpdatePnl" runat="server" UpdateMode="conditional">
                                <ContentTemplate>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>
                                                <asp:GridView Width="300" ID="grdSalesDistrict" runat="server" EmptyDataText="No Sales District to Display"
                                    ...
                                    <asp:Panel ID="DetailPnl" runat="server" Style="display: none" Width="400" CssClass="modalPopup">
                                      <asp:Panel ID="DragPnl" Font-Size ="13px"  runat="server" Style="cursor: move; background-color: #3399ff;
                                            ...
                                            Sales District Details</asp:Panel>
                                        ...
                                        <asp:HiddenField ID="HidVal" runat="server" Value="-1" />
                                         <table width="450px" border="0" cellspacing="2" cellpadding="2" >
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtDescription" runat="server" TabIndex="1" CssClass="inputSM"
                                                        ></asp:TextBox>
                                                </td>
