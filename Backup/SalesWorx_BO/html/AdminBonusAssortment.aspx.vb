    ...
    Protected Sub btnAddItems_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAddItems.Click
        ...
        Try
            ...
            If Me.btnAddItems.Text = "Add" Then
                PlanId = objProduct.SaveBonusPlan(Err_No, Err_Desc, Me.ddl_org.SelectedValue.ToString(), Me.txtDescription.Text, CType(Session("User_Access"), UserAccess).UserID, PlanId, IIf(Me.chActive.Checked = True, "Y", "N"), Me.StartTime.SelectedDate.Value, Me.EndTime.SelectedDate.Value)
            ...
            If Me.btnAddItems.Text = "Update" Then
                Dim success As Boolean = objProduct.UpdateBonusPlan(Err_No, Err_Desc, Me.lblPlanId.Text, Me.txtDescription.Text, CType(Session("User_Access"), UserAccess).UserID, IIf(Me.chActive.Checked = True, "Y", "N"), Me.StartTime.SelectedDate.Value, Me.EndTime.SelectedDate.Value)
