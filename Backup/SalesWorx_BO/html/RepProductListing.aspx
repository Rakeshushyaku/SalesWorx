<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="RepProductListing.aspx.vb" Inherits="SalesWorx_BO.RepProductListing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Product Listing</span></div>
...
<table  border="0" cellspacing="2" cellpadding="2">
          <tr>
            <td width="85" class="txtSMBold">Organization :</td>
            ...
            <td width="85" class="txtSMBold">Type :</td>
            <td>
                <asp:DropDownList CssClass="inputSM" ID="ddlProductType" Width ="200px" runat="server" >
          ...
          <tr> 
            ...
            <td><asp:TextBox ID="txtItemCode" CssClass="inputSM" Width ="200px" runat="server"></asp:TextBox>
             </td>
                <td width="75" class="txtSMBold">Description :</td>
            <td><asp:TextBox ID="txtDescription" CssClass="inputSM" Width ="200px" runat="server"></asp:TextBox> 
                     </td>      
          </tr>
        </table>
        </ContentTemplate>
     ...
     <asp:Panel ID="Panel11" CssClass="overlay" runat="server">
         ...
         <img src="../images/Progress.gif" alt="Processing..." style="vertical-align:middle;" />            
           <span style="font-size:12px; font-weight:bold; color:#3399ff;">Processing... </span>
               ...
               <asp:UpdateProgress ID="UpdateProgress2" AssociatedUpdatePanelID="UPModal" DisplayAfter="10"
                    runat="server">
                    <ProgressTemplate>
