...
Partial Public Class AdminSalesDistrict
    ...
    Private Sub BindData()
        Dt = objSalesDistrict.SearchSalesDistrictGrid(Err_No, Err_Desc, txtFilterVal.Text)
    ...
    Protected Sub btnDeleteAll_Click()
        Try
            ...
            Next
            If (Success = True) Then
                lblMessage.Text = "Sales Districts(s) deleted successfully."
                lblMessage.ForeColor = Drawing.Color.Green
                lblinfo.Text = "Information"
                MpInfoError.Show()
                btnClose.Focus()
                ...
                Resetfields()
            Else
                lblMessage.Text = "Some Sales Districts(s) could not be deleted."
                lblMessage.ForeColor = Drawing.Color.Green
                lblinfo.Text = "Information"
                MpInfoError.Show()
                btnClose.Focus()
