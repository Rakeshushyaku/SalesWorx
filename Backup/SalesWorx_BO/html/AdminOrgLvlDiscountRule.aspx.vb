...
End Function
    ...
    Protected Sub btnDeleteAll_Click()
        Try
            ...
            Next
            If (Success = True) Then
                lblMessage.Text = "Discount Rule(s) deleted successfully."
                lblMessage.ForeColor = Drawing.Color.Green
                lblinfo.Text = "Information"
                MpInfoError.Show()
                btnClose.Focus()
                ...
                Resetfields()
            Else
                lblMessage.Text = "Discount Rule(s) could not be deleted."
                lblMessage.ForeColor = Drawing.Color.Green
                lblinfo.Text = "Information"
                MpInfoError.Show()
                btnClose.Focus()
   ...
   End Sub
    ...
    Protected Sub btnEdit_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            HidVal.Value = Lbl.Text
            ddl_Client.Items.Add(New ListItem(row.Cells(1).Text, LblInfo_Key.Text))
            If Not ddl_Client.Items.FindByValue(LblInfo_Key.Text) Is Nothing Then
                ddl_Client.Items.FindByValue(LblInfo_Key.Text).Selected = True
            End If
