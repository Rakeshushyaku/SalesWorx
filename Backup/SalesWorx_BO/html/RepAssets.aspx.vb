...
Partial Public Class RepAssets
    ...
    Protected Sub SearchBtn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles SearchBtn.Click
        ...
        Active = New ReportParameter("Active", CStr(IIf(Me.chkActive.Checked = True, "Yes", "No")))
        ...
        With RVMain
            ...
            .ServerReport.SetParameters(New ReportParameter() {OrgName, OrgID, AssetType, Customer, Active})
