<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="Rep_HeldPDC.aspx.vb" Inherits="SalesWorx_BO.Rep_HeldPDC" %>
...
<table  border="0" cellspacing="2" cellpadding="2" >
   <tr>
              ...
              <td>
                  <asp:TextBox ID="txt_CollectionRef" runat="server" CssClass="inputSM" 
          ...
          <tr> 
                 ...
                 <td class="txtSMBold">From:</td><td><asp:TextBox  ID="txtfromDate"  Width ="150px" CssClass="inputSM" runat="server"></asp:TextBox> 
