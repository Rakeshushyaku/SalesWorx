...
Partial Public Class ImportVanLoad
    ...
    Sub Filldropdowns()
        ...
        ddl_Organization.Items.Insert(0, "--Select Organisation--")
            ...
            If (file_import.HasFile) Then
                ...
                Else
                    ...
                    lblmsgPopUp.Text = RetMessage
                       ...
                       If Not ddl_org.Items.FindByValue(ddl_Organization.SelectedItem.Value) Is Nothing Then
                            ddl_org.Items.FindByValue(ddl_Organization.SelectedItem.Value).Selected = True
                       End If
        ...
        Try
           ...
           PoRefno = "PO-" & Now.ToString("ddMMyyyyhhmmss")
            ...
            If success = True Then
                lblMessage.Text = "Successfully Confirmed."
               ...
               BindGrid()
            Else
                lblMessage.Text = "Error occured while confirming."
                lblMessage.ForeColor = Drawing.Color.Green
                lblinfo.Text = "Information"
                MpInfoError.Show()
                btnClose.Focus()
