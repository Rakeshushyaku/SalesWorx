...
Partial Public Class Rep_StatementofCustomerAccount
...
Dim Err_No As Long
    ...
    Private ReportPath As String = "StatementofCustomerAccount"

    Private Const PageID As String = "P295"
    ...
    Private Sub BindData()
        ...
        Try
         ...
         If ddlOrganization.SelectedValue = "-1" Then
                ...
                Exit Sub
         End If
         If ddl_customer.SelectedValue = "-1" Then
                MessageBoxValidation("Please select a customer")
                Exit Sub
         End If
        InitReportViewer()
        Catch ex As Exception
    ...
    Private Sub InitReportViewer()
        Try
            ...
            With RVMain
                ...
                .ServerReport.SetParameters(New ReportParameter() {ORGID, Customer_ID, Site_ID})
