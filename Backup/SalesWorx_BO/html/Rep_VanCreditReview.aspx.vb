...
Partial Public Class Rep_VanCreditReview
    ...
    Private ReportPath As String = "VanCreditLimitReview"

    Private Const PageID As String = "P300"
    ...
    Private Sub InitReportViewer()
        Try
            ...
            Type = New ReportParameter("PERC", txtPerc.Text.Trim)
            ...
            With RVMain
                ...
                .ServerReport.SetParameters(New ReportParameter() {ORGID, FSRID, Type})
