...
Partial Public Class RepCustomerSurvey
    ...
    Private ReportPath As String = "CustomerSurveyDetails"
    ...
    Private Sub InitReportViewer(ByVal FilterValue As String)
        Try
            ...
            With RVMain
                ...
                .ServerReport.SetParameters(New ReportParameter() {Searchvalue, SID, CustID, Survey, QuestID, OrgID, OrgName})
    ...
    '    GVCustSurvey.AllowPaging = False
    '    Dim dt As New DataTable
    '    dt = ViewState("dt")
    '    GVCustSurvey.DataSource = dt
    '    GVCustSurvey.DataBind()
    '    Dim sw As New StringWriter()
    '    Dim hw As New HtmlTextWriter(sw)
    '    GVCustSurvey.RenderControl(hw)
