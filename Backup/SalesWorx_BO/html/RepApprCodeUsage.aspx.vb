...
Partial Public Class RepApprCodeUsage
    ...
    Protected Sub SearchBtn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles SearchBtn.Click
        ...
        If VanIds = "" Then
            Dim AllItems As IList(Of RadComboBoxItem) = ddl_Van.Items
            For Each li As RadComboBoxItem In AllItems
                If VanIds = "" Then
                    VanIds = li.Value & ","
                Else
                    VanIds = VanIds & li.Value & ","
        ...
        With RVMain
            ...
            .ServerReport.SetParameters(New ReportParameter() {OrgID, VanID, Start_Date, End_Date, OrgName})
