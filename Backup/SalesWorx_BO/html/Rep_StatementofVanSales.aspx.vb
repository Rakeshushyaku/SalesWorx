...
Partial Public Class Rep_StatementofVanSales
    ...
    Private ReportPath As String = "StatementofVanSales"

    Private Const PageID As String = "P294"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Dim objUserAccess As UserAccess
                            ...
                            ddlVan.DataBind()
                            ddlVan.Items.Insert(0, New ListItem("-- Select a value --", "-1"))
    ...
    Private Sub BindData()
        ...
        Try
         ...
         If ddlOrganization.SelectedValue = "-1" Then
                ...
                Exit Sub
         End If
         If ddlVan.SelectedValue = "-1" Then
    ...
    Private Sub InitReportViewer()
        Try
            ...
            With RVMain
                ...
                .ServerReport.SetParameters(New ReportParameter() {ORGID, FSRID, Fromdate, Todate, Type})
...
If ddlType.SelectedItem.Value = "A" Then
