...
Partial Public Class HeldNewCustomer
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not IsPostBack Then
                ...
                txtFromDate.Text = "" ' Format(Now().Date.AddDays(-7), "dd/MM/yyyy")
    ...
    Private Sub BindData()
        ...
        Try
            ...
            ObjCommon = New Common()
            If (ddlCustomer.SelectedIndex <= 0 And ddlVan.SelectedIndex <= 0 And txtFromDate.Text = "" And txtToDate.Text = "") Then
                SearchQuery = ""
            Else
    ...
    Private Sub SearchBtn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SearchBtn.Click
        If Me.ddlOrganization.SelectedIndex <= 0 Then
            MessageBoxValidation("Please select a organization")
            Exit Sub
        End If

        If (Me.txtFromDate.Text <> "" And Me.txtToDate.Text = "" Or Me.txtFromDate.Text = "" And Me.txtToDate.Text <> "") Then
            MessageBoxValidation("Please enter from and to date")
            Exit Sub
        End If
        If Me.txtFromDate.Text <> "" And Me.txtToDate.Text <> "" Then
    ...
    Protected Sub btnApprove_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnApprove.Click
        ...
        If GVOrders.Rows.Count <= 0 Then
            MessageBoxValidation("There is no data in the list")
            Exit Sub
        End If
        ...
        If bCheck = False Then
            MessageBoxValidation("Please select atleast one order from the list")
            Exit Sub
        End If
        ...
        If bSuccess = True Then
            BindRefreshData()
            MessageBoxValidation("Successfully updated")
            lblMessage.ForeColor = Drawing.Color.Green
            lblinfo.Text = "Validation"
            lblMessage.Text = "Successfully updated"
            MpInfoError.Show()
        Else
            MessageBoxValidation("Error occured while updating records")
            Exit Sub
        End If
        Me.Panel.Update()
    ...
    Protected Sub lbRelease_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Try
            ...
            Else
                MessageBoxValidation("Error occured while updating record")
            End If
        Catch ex As Exception
            Err_No = "34310"
            log.Error(Err_Desc)
    ...
    Protected Sub lbOrdNo_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            Me.lblOrderDate.Text = row.Cells(2).Text
            Me.lblCustomerName.Text = row.Cells(4).Text
            Me.lblTelNO.Text = row.Cells(5).Text
            Me.lblOrdAmount.Text = row.Cells(6).Text
    ...
    Protected Sub btnConcile_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnConcile.Click
        If Me.lblOrdRef.Text = "" Then
            MessageBoxValidation("There is no order to reconcile")
            Exit Sub
        End If
