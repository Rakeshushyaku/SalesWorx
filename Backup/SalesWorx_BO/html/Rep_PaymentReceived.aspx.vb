...
Partial Public Class Rep_PaymentReceived
    ...
    Private Sub InitReportViewer(ByVal fromdate As Date, ByVal Todate As Date, ByVal UID As Integer)
        Try
            ...
            PayType = New ReportParameter("PaymentType", ddlPay.SelectedItem.Value)
            ...
            With RVMain
                ...
                .ServerReport.SetParameters(New ReportParameter() {USRID, OID, SalesRepID, FDate, TDate, PayType})
