<%@ Page Title="Import Route Plan" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/DefaultLayout.Master" CodeBehind="ImportRoutePlan.aspx.vb" Inherits="SalesWorx_BO.ImportRoutePlan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Import Route Plan</span></div>
	<div id="pagenote" >This screen may be used to import route plans for vans. Route plans need to be created for each month for the vans.</div>	
    ...
    <td><asp:FileUpload ID="ExcelFileUpload" runat="server" /></td>
        <td>     <asp:Button ID="BtnImport" runat="server" Text="Import" CssClass="btnInputBlue" />
                  <asp:Button ID="DummyImBtn" style="display:none"  runat="server" Text="Reimport" />
        </td>  
         <td>     <asp:Button ID="BtnReimport" runat="server" Text="Reimport" 
