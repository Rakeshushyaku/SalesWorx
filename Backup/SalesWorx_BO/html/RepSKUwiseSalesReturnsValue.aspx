<%@ Page Title="SKU wise Sales / Returns Quantity / Value" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="RepSKUwiseSalesReturnsValue.aspx.vb" Inherits="SalesWorx_BO.RepSKUwiseSalesReturnsValue" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">SKU wise Sales / Returns Quantity / Value</span></div>
     ...
     <tr> 
          <td class="txtSMBold">
            ...
            <td> <asp:DropDownList CssClass="inputSM" ID="ddlOrganization"  Width ="200px" AutoPostBack="true"
                ...
                <td  class="txtSMBold">
                    Agency:</td>
                <td><asp:DropDownList CssClass="inputSM" ID="ddlAgency"   Width ="150px"
