...
Partial Public Class Rep_ReturnsReconciliation
    ...
    Private ReportPath As String = "ReturnsReconciliation"

    Private Const PageID As String = "P293"
    ...
    Private Sub BindData()
        ...
        Try
         ...
         If Not IsDate(txtfromDate.Text) Then
            MessageBoxValidation("Invalid From date")
            Exit Sub
         End If
        If Not IsDate(txtToDate.Text) Then
         MessageBoxValidation("Invalid To date")
         Exit Sub
        End If
        InitReportViewer()
        Catch ex As Exception
    ...
    Private Sub InitReportViewer()
        Try
            ...
            Dim OrderNo As New ReportParameter
            If txt_order.Text.Trim <> "" Then
                OrderNo = New ReportParameter("OrderNo", txt_order.Text)
            Else
             OrderNo = New ReportParameter("OrderNo", "")
            End If

            Dim ReturnNo As New ReportParameter
            If txt_rma.Text.Trim <> "" Then
                ReturnNo = New ReportParameter("RMANo", txt_rma.Text)
            Else
                ReturnNo = New ReportParameter("RMANo", "")
            End If
            ...
            With RVMain
                ...
                .ServerReport.SetParameters(New ReportParameter() {CustomerID, SiteID, Fromdate, Todate, OrderNo, ReturnNo})
