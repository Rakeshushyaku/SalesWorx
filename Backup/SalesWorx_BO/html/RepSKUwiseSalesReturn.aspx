<%@ Page Title="SKU wise Returns Periodwise" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="RepSKUwiseSalesReturn.aspx.vb" Inherits="SalesWorx_BO.RepSKUwiseSalesReturn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#f6f6f6">
	...
	<span class="pgtitile3">SKU wise Returns Periodwise</span></div>
...
<table  border="0" cellspacing="2" cellpadding="2" >
     <tr> 
          <td class="txtSMBold">
            ...
            <td>
                     <asp:DropDownList CssClass="inputSM" ID="ddSKU"   Width ="200px"
