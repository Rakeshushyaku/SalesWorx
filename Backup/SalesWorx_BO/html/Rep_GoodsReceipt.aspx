<%@ Page Title="Goods Receipt" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="Rep_GoodsReceipt.aspx.vb" Inherits="SalesWorx_BO.Rep_GoodsReceipt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Goods Receipt</span></div>
...
<table  border="0" cellspacing="2" cellpadding="2" >
          ...
          <tr> 
            <td  class="txtSMBold">From Date(Tr. Dt.) :</td>
            <td>
            ...
            <td  class="txtSMBold">To Date(Tr. Dt.) :</td>
            <td>
