<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="RepSales_WeeklyMonthly.aspx.vb" Inherits="SalesWorx_BO.RepSales_WeeklyMonthly" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#f6f6f6">
	...
	<span class="pgtitile3">Weekly/Monthly/Quarterly/Yearly Sales Reports</span></div>
...
<table  border="0" cellspacing="2" cellpadding="2" >
   <tr>
              ...
              <td class="txtSMBold">
                  Outlet :</td>
              <td>
                  <asp:DropDownList ID="ddlCustomer" runat="server" CssClass="inputSM" 
                      DataTextField="Outlet" DataValueField="CustomerID" Width="200px">
                  </asp:DropDownList>
     ...
     <tr> 
          ...
          <tr> 
            ...
            <td>
                ...
                <asp:DropDownList ID="ddlFromYear" runat="server" CssClass="inputSM" 
                    AutoPostBack="True">
                </asp:DropDownList>
                
                <asp:DropDownList ID="ddlFromMonth" runat="server" CssClass="inputSM" 
                    >
                </asp:DropDownList>
            </td>
            <td  class="txtSMBold">To Date :</td>
            <td>
                <asp:DropDownList ID="ddltoYear" runat="server" CssClass="inputSM" AutoPostBack="True" 
                    >
                </asp:DropDownList>
                  
                <asp:DropDownList ID="ddltoMonth" runat="server" CssClass="inputSM" 
                  >
                </asp:DropDownList>
