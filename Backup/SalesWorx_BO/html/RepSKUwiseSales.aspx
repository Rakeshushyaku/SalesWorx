<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="RepSKUwiseSales.aspx.vb" Inherits="SalesWorx_BO.RepSKUwiseSales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#f6f6f6">
	...
	<span class="pgtitile3">SKU-Wise Sales Reports</span></div>
...
<table  border="0" cellspacing="2" cellpadding="2" >
      <tr>
              ...
              <td class="txtSMBold">
                  SKU :</td>
              <td>
                  <asp:DropDownList ID="ddlSKU" runat="server" CssClass="inputSM" 
                      Width="200px">
                  </asp:DropDownList>
