<%@ Page Title="Currency Management " Language="vb" AutoEventWireup="false" MasterPageFile="~/html/DefaultLayout.Master"
        ...
        <tr>
            <td id="contentofpage" width="100%" height="76%" class="topshadow">
                <div class="pgtitileposition">
                    <span class="pgtitile3">Currency Management</span></div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddFilterBy" runat="server" AutoPostBack ="true" OnSelectedIndexChanged ="ddFilterBy_SelectedIndexChanged" CssClass="inputSM" TabIndex="2">
                                                    ...
                                                    <asp:ListItem Value="Currency Code">Currency Code</asp:ListItem>
                                ...
                                <ContentTemplate>
                                                        ...
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:ImageButton ToolTip="Delete Currency Code" ID="btnDelete" OnClick="btnDelete_Click"
                                                                    runat="server" CausesValidation="false"  ImageUrl="~/images/delete-13.png" OnClientClick="javascript:return confirm('Would you like to delete the selected currency code?');" />
                                    ...
                                    <asp:Panel ID="DetailPnl" runat="server" Style="display: none" Width="350" CssClass="modalPopup">
                                      <asp:Panel ID="DragPnl" Font-Size ="13px"  runat="server" Style="cursor: move; background-color: #3399ff;
                                            ...
                                            Currency Code Details</asp:Panel>
                                        ...
                                        <asp:HiddenField ID="HidVal" runat="server" Value="-1" />
                                         <table width="450px" border="0" cellspacing="2" cellpadding="2" >
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtCurrencyCode" runat="server" TabIndex="1" CssClass="inputSM"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtDescription" TabIndex="2" CssClass="inputSM" runat="server"></asp:TextBox>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtRate" TabIndex="3" CssClass="inputSM" runat="server"></asp:TextBox>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlDigits" CssClass="inputSM" runat="server" TabIndex="4" Width="128px">
