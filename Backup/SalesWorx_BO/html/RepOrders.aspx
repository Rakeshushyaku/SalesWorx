<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="RepOrders.aspx.vb" Inherits="SalesWorx_BO.RepOrders" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Orders</span></div>
          ...
          <tr> 
            ...
            <td>
                ...
                <asp:DropDownList ID="ddlOrderType"  Width ="150px" runat="server" CssClass="inputSM">
                    ...
                    <asp:ListItem Value="Proforma Order">Proforma Order</asp:ListItem>
                </asp:DropDownList>
