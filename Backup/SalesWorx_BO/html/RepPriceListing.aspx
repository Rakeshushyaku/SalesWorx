<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="RepPriceListing.aspx.vb" Inherits="SalesWorx_BO.RepPriceListing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Price Listing</span></div>
...
<table  border="0" cellspacing="2" cellpadding="2">
          <tr>
            ...
            <td>
                <asp:DropDownList CssClass="inputSM" ID="ddlAgency" Width="200px" 
                 ...
                 <td  class="txtSMBold">UOM:</td>
            <td>
                <asp:DropDownList ID="ddlUOM"  CssClass="inputSM" Width="200px"
                    runat="server" DataTextField="Price_List_Type" 
                    DataValueField="Price_List_ID" AutoPostBack="True">
                </asp:DropDownList>
                               </td>
          ...
          <tr> 
            <td  class="txtSMBold">Price List Type :</td>
            <td>
                <asp:DropDownList CssClass="inputSM" ID="ddlType" Width="200px" 
                    runat="server" DataTextField="Price_List_Type" DataValueField="Price_List_ID">
                </asp:DropDownList>
            </td>
            <td class="txtSMBold">Product:</td>
            <td>   
            <asp:DropDownList ID="drpProduct" Width="200px" runat="server" 
                    CssClass="inputSM">
                </asp:DropDownList> 
