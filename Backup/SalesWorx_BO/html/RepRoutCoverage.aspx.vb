...
Partial Public Class RepRoutCoverage
    ...
    Private ReportPath As String = "RouteCoverage"

    Private Const PageID As String = "P215"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Try
                ...
                txt_ToDate.Text = Format(Now().Date, "dd-MMM-yyyy")
    ...
    Protected Sub SearchBtn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles SearchBtn.Click
        ...
        DistributorCode = New ReportParameter("DistributorCode", "")
        ...
        With RVMain
            ...
            .ServerReport.SetParameters(New ReportParameter() {OrgID, VanID, Start_Date, End_Date, DistributorCode})
