...
Partial Public Class _POP_CustomerListingNew
    ...
    Sub RemovefromVisitPlan(ByVal sender As Object, ByVal e As EventArgs)
        ...
        seldr = PlannedVisits.Select("Customer_ID=" & CType(row.Cells(0).FindControl("CustomerID"), HiddenField).Value & " and Site_Use_ID=" & CType(row.Cells(0).FindControl("SiteID"), HiddenField).Value)
        ...
        Try
            ...
            End If
                ...
                If (DayValue = "V") Then
                    ...
                    strScript += "window.opener.document.aspnetForm.ctl00_ContentPlaceHolder1_HDay" & Request.QueryString("DayRef") & ".value='" & DayValue & CommStr & CustomeInfrm & "';"
                    Session("HDay" & Request.QueryString("DayRef") & "") = DayValue & CommStr & CustomeInfrm
                Else
                    strScript += "window.opener.document.aspnetForm.ctl00_ContentPlaceHolder1_HDay" & Request.QueryString("DayRef") & ".value='" & DayValue & CommStr & "';"
                ...
                strScript += "var par = document.location.search;"
    ...
    Private Function GetCusInformation() As String
        Try
            ...
            For Each gr As GridViewRow In CustomerGrid.Rows
                ...
                _tempSiteID = CType(gr.FindControl("SiteID"), HiddenField).Value
            ...
            For i As Integer = 0 To 31
                ...
                If Not (HValu Is Nothing) Then
                    ...
                    For j As Integer = 1 To HValArr.Length - 1
                        ...
                        If SubArray.Length > 0 Then
                            If SubArray(0).ToString() = CusID Then
                                Str.Append(i)
                                Str.Append(",")
                            End If
                        End If
        ...
        Try
            ...
            If (FromDefaultPlan()) Then
                ...
                If Not (Session("HDay" & Request.QueryString("DayRef") & "") Is Nothing) And Not Date_List Is Nothing Then
                    ...
                    If (Arr(0) = "O") Then
                        strScript += "window.opener.document.aspnetForm.ctl00_ContentPlaceHolder1_Cell" & Request.QueryString("DayRef") & ".value ='Y';"
                        strScript += "window.opener.document.aspnetForm.ctl00_ContentPlaceHolder1_HDay" & Request.QueryString("DayRef") & ".value='X';"
                        Dim HValu As String
                        If (UserComments.Text <> "") Then
                        ...
                        For i As Integer = 0 To DatArr.Length - 1
                            strScript += "window.opener.document.aspnetForm.ctl00_ContentPlaceHolder1_HDay" & DatArr(i) & ".value='" & HValu & "';"
                            strScript += "window.opener.document.aspnetForm.ctl00_ContentPlaceHolder1_Cell" & DatArr(i) & ".value ='Y';"
                        Next
                    Else
            ...
            If (FromDefaultPlan()) Then
                If Not (Session("HDay" & Request.QueryString("DayRef") & "") Is Nothing) And Not Date_List Is Nothing Then
                    ...
                    If (Arr(0) = "O") Then
                        ...
                        strScript += "window.opener.document.aspnetForm.ctl00_ContentPlaceHolder1_Cell" & Request.QueryString("DayRef") & ".value ='Y';"
                        strScript += "window.opener.document.aspnetForm.ctl00_ContentPlaceHolder1_HDay" & Request.QueryString("DayRef") & ".value='" & HValu & "';"
                        For i As Integer = 0 To DatArr.Length - 1
                            strScript += "window.opener.document.aspnetForm.ctl00_ContentPlaceHolder1_HDay" & DatArr(i) & ".value='" & HValu & "';"
                            strScript += "window.opener.document.aspnetForm.ctl00_ContentPlaceHolder1_Cell" & DatArr(i) & ".value ='Y';"
                        Next
    ...
    Private Sub ResetAllBtn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ResetAllBtn.Click
        Try
            ...
            strScript += "window.opener.document.aspnetForm.ctl00_ContentPlaceHolder1_Cell" & Request.QueryString("DayRef") & ".value ='Y';"
            strScript += "window.opener.document.aspnetForm.ctl00_ContentPlaceHolder1_HDay" & Request.QueryString("DayRef") & ".value='" & "X" & CommStr & "';"

            For Each Dr As DataRow In TempTable.Rows
                Dim DayValue As Integer = CInt(Dr.Item(0))
                strScript += "window.opener.document.aspnetForm.ctl00_ContentPlaceHolder1_Cell" & DayValue & ".value ='Y';"
                strScript += "window.opener.document.aspnetForm.ctl00_ContentPlaceHolder1_HDay" & DayValue & ".value='" & "X" & CommStr & "';"
