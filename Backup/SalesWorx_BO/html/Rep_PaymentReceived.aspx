<%@ Page Title="Payment Received Summary" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="Rep_PaymentReceived.aspx.vb" Inherits="SalesWorx_BO.Rep_PaymentReceived" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Payment Received Summary</span></div>
...
<table  border="0" cellspacing="2" cellpadding="2" >
          ...
          <tr> 
            <td  class="txtSMBold">Payment Type :</td>
            <td >
                <asp:DropDownList CssClass="inputSM" ID="ddlPay"  Width ="150px"
                runat="server" >
                <asp:ListItem Text="All" Value="ALL"></asp:ListItem>
                <asp:ListItem Text="Cash" Value="CASH"></asp:ListItem>
                 <asp:ListItem Text="Current Cheque" Value="CURR-CHQ"></asp:ListItem>
