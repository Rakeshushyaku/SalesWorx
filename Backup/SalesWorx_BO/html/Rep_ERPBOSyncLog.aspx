<%@ Page Title="ERP to Back Office Sync Log" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="Rep_ERPBOSyncLog.aspx.vb" Inherits="SalesWorx_BO.Rep_ERPBOSyncLog" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">ERP to Back Office Sync Log</span></div>
...
<table  border="0" cellspacing="2" cellpadding="2" >
      ...
      <tr>
            <td  class="txtSMBold">ERP Table :</td>
            <td><telerik:RadComboBox ID="ddl_ERPTable" runat="server" 
                  Width="290px"    >
                       </telerik:RadComboBox> <asp:Button CssClass="btnInputGrey" ID="SearchBtn" runat="server" Text="Search" />
              </td>
