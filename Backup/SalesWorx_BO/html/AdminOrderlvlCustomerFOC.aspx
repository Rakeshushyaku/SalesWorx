<%@ Page Title="Customer FOC Discount Rules" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/DefaultLayout.Master" CodeBehind="AdminOrderlvlCustomerFOC.aspx.vb" Inherits="SalesWorx_BO.AdminOrderlvlCustomerFOC" %>
...
<script type="text/javascript" >
   ...
   <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#f6f6f6">
                <tr>
                    <td id="contentofpage" width="100%" height="76%" class="topshadow">
                        <div class="pgtitileposition">
                            <span class="pgtitile3">Customer FOC Discount Rules</span></div>  
                    ...
                    runat="server" DataTextField="Description" DataValueField="MAS_Org_ID" AutoPostBack="true"></asp:DropDownList></td></tr>
           ...
           <telerik:RadMultiPage ID="RadMultiPage1" runat="server"    Width="100%" SelectedIndex="0" BorderStyle="Groove">
                          ...
                          <asp:PostBackTrigger  ControlID="btnImportWindowFOC"  />
                               ...
                               <td>
                                 <asp:Button ID="btnExportFOC" 
                                                                                                              runat="server" CssClass="btnInputOrange" Text="Export" TabIndex ="11" />
                                                        <asp:Button ID="btnImportWindowFOC" runat="server" CssClass="btnInputGreen" Text="Import" TabIndex ="12" />
    ...
    <telerik:RadComboBox ID="ddlItems" Filter="Contains"  EmptyMessage ="Please enter Item code/Name"
                                               ...
                                               <td></td>
                                                 <td >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                                              ...
                                                                                                              runat="server" CssClass="btnInputBlue" Text="Add" TabIndex ="8" />
                                                        <asp:Button ID="btnFOCClear" runat="server" CssClass="btnInputRed" Text="Reset" TabIndex ="9" />
    ...
    <td> <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="conditional">
          ...
          <td>
           <asp:Button ID="btnImportFOC" runat="server" Text="Import" CssClass="btnInputGrey" /> <asp:Button ID="Button3" CssClass="btnInputRed" TabIndex="5" runat="server"
                                    CausesValidation="false" Text="Close" />
