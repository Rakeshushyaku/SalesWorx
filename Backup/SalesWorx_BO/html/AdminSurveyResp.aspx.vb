...
Partial Public Class AdminSurveyResp
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            While MinOptCnt <= MaxOptCnt
                Me.ddlOptCount.Items.Add(MinOptCnt)
                MinOptCnt += 1
            End While
            ResetFields()
            ToggleEnabled(False)
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        If Me.ddSurvey.SelectedIndex > 0 Then
            ...
            If objSurvey.GetSurveyDate(Err_No, Err_Desc) <= Now.Date Then
                ...
                Me.lblMessage.Text = "Survey start date should be greater than today's date for add response."
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSave.Click
        If Me.ddlQuestions.SelectedIndex <= 0 Or Me.ddlResponsType.SelectedIndex <= 0 Then
            Me.lblinfo.Text = "Validation"
            Me.lblMessage.Text = "Question and response type are required."
            Me.lblMessage.ForeColor = Drawing.Color.Red
            Me.MpInfoError.Show()
            Exit Sub
        End If
        ...
        Try
            ...
            If Me.btnSave.Text = "Save" Then
                If ddlResponsType.SelectedValue.ToString <> 1 And ddlResponsType.SelectedValue.ToString <> 4 Then
    ...
    Protected Sub btnModify_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnModify.Click
        If Me.ddSurvey.SelectedIndex > 0 Then
            ...
            If objSurvey.GetSurveyDate(Err_No, Err_Desc) <= Now.Date Then
                Me.lblinfo.Text = "Validation"
                Me.lblMessage.Text = "Survey start date should be greater than today's date for modify response."
                Me.lblMessage.ForeColor = Drawing.Color.Red
                Me.MpInfoError.Show()
                Exit Sub
            End If
    ...
    Protected Sub btnDelete_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnDelete.Click
        If Me.ddSurvey.SelectedIndex > 0 Then
            ...
            If objSurvey.GetSurveyDate(Err_No, Err_Desc) <= Now.Date Then
                Me.lblinfo.Text = "Validation"
                Me.lblMessage.Text = "Survey start date should be greater than today's date for delete response."
                Me.lblMessage.ForeColor = Drawing.Color.Red
                Me.MpInfoError.Show()
                Exit Sub
            End If
    ...
    Protected Sub ddlResponsType_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles ddlResponsType.SelectedIndexChanged
        If Me.ddlResponsType.SelectedIndex > 0 Then
            If Me.ddlResponsType.SelectedValue.ToString() <> 1 And Me.ddlResponsType.SelectedValue.ToString() <> 4 Then
