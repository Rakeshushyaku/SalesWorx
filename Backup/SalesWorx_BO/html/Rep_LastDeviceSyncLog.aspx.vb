...
Partial Public Class Rep_LastDeviceSyncLog
    ...
    Private Sub BindData()
        ...
        Try
            ...
            InitReportViewer(Me.ddlHours.SelectedValue, van)
    ...
    Private Sub InitReportViewer(ByVal hours As Integer, ByVal van As String)
        Try
            ...
            FHours = New ReportParameter("Hours", hours.ToString())
            ...
            With RVMain
                ...
                .ServerReport.SetParameters(New ReportParameter() {SalesRepID, OID, FHours, LastSyncBefore, SType})
