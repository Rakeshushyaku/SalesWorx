<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="Rep_Collections.aspx.vb" Inherits="SalesWorx_BO.Rep_Collections" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Collection Listing</span></div>
                          ...
                          <ContentTemplate >
                            <table border="0" cellspacing="2" cellpadding="2">
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList CssClass="inputSM" ID="ddlOrganization" Width ="150px" runat="server" DataTextField="Description"
                                    ...
                                    <td>
                                        <asp:DropDownList CssClass="inputSM" ID="ddVan" Width ="150px" runat="server" DataTextField="SalesRep_Name" DataValueField="SalesRep_ID">
                                        </asp:DropDownList> &nbsp;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ajaxToolkit:CalendarExtender CssClass="cal_Theme1" ID="calendarButtonExtender" Format="dd-MMM-yyyy"
                                    ...
                                    <td>
                                        ...
                                        <ajaxToolkit:CalendarExtender CssClass="cal_Theme1" ID="CalendarExtender1" Format="dd-MMM-yyyy"
