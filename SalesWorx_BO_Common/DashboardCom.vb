...
Public Class DashboardCom
    ...
    Function GetVanLog(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal UserID As Integer, ByVal startdate As Date, ByVal enddate As Date) As DataSet
        ...
        End Try
    End Function
    Function LoadDashVisitStatistics(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal Van As String, ByVal MonthYear As String) As DataTable
        Try
            Return ObjDALDashboard.LoadDashVisitStatistics(Err_No, Err_Desc, Van, MonthYear)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function LoadDashTRXStatistics(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal Van As String, ByVal MonthYear As String) As DataTable
        Try
            Return ObjDALDashboard.LoadDashTRXStatistics(Err_No, Err_Desc, Van, MonthYear)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    ...
    End Function
    Function LoadDashBoard(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal Van As String, ByVal MonthYear As String) As DataSet
        Try
            Return ObjDALDashboard.LoadDashBoard(Err_No, Err_Desc, Van, MonthYear)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Function LoadDashBoardVanLog(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal Van As String, ByVal MonthYear As String) As DataSet
        Try
            Return ObjDALDashboard.LoadDashBoardVanLog(Err_No, Err_Desc, Van, MonthYear)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
