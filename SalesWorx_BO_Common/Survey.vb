...
Public Class Survey
        ...
        Try
            ...
            If FilterBy = "Type" Then
                ...
                Dim key As String = ht.Values.OfType(Of String)() _
                  ...
                  .Where(Function(htKVP) htKVP.Key.Contains(FilterValue)) _
                  .Select(Function(htKVP) htKVP.Value) _
                  .FirstOrDefault()
            ...
            Return ObjDAlSurvey.SearchSurveyGrid(Err_No, Err_Desc, FilterBy, FilterValue)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function LoadSurveyData(ByRef Err_No As Long, ByRef Err_Desc As String) As DataTable
        Try
            Return ObjDAlSurvey.GetSurveyData(Err_No, Err_Desc)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    ...
    Public Function DeleteVanAuditPlan(AuditorID As String, AuditYear As String, AuditMonth As String, SalesRep_ID As String, UserId As String, ByRef Err_No As Long, ByRef Err_Desc As String) As Boolean
        Try
            ObjDAlSurvey.dtSalesRepSelected = _dtSR
            Return ObjDAlSurvey.DeleteVanAuditPlan(AuditorID, AuditYear, AuditMonth, SalesRep_ID, UserId, Err_No, Err_Desc)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function InsertVanAuditPlan(AuditorID As String, AuditYear As String, AuditMonth As String, SalesRep_ID As String, UserId As String, ByRef Err_No As Long, ByRef Err_Desc As String) As Boolean
        Try
            ObjDAlSurvey.dtSalesRepSelected = _dtSR
            Return ObjDAlSurvey.InsertVanAuditPlan(AuditorID, AuditYear, AuditMonth, SalesRep_ID, UserId, Err_No, Err_Desc)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    ...
    Function GetSurveyAudit(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal UD_SUB_QRY As String) As DataTable
        ...
        End Try
    End Function
    Function GetFsrForVanAudit(OrgID As String, AuditYear As String, AuditMonth As String, ByRef Err_No As Long, ByRef Err_Desc As String) As DataTable
        Try
            Return ObjDAlSurvey.GetFsrForVanAudit(OrgID, AuditYear, AuditMonth, Err_No, Err_Desc)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Function GetAssignedFsrForVanAudit(OrgID As String, Auditor_ID As String, AuditYear As String, AuditMonth As String, ByRef Err_No As Long, ByRef Err_Desc As String) As DataTable
        Try
            Return ObjDAlSurvey.GetAssignedFsrForVanAudit(OrgID, Auditor_ID, AuditYear, AuditMonth, Err_No, Err_Desc)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    ...
    Public Function GetSurveyType(ByRef Err_No As Long, ByRef Err_Desc As String) As DataTable
        Try
            ...
            dt = ObjDAlSurvey.GetSurveyType(Err_No, Err_Desc)
    ...
    Public Function GetAvailFSRBySurveyID(ByRef Err_No As Long, ByRef Err_Desc As String, SurveyID As Integer) As DataTable
        Try
            ...
            Dim dt As New DataTable
            dt = ObjDAlSurvey.GetAvailFSRBySurveyID(Err_No, Err_Desc, SurveyID)
    ...
    Public Function GetAssignedFSRBySurveyID(ByRef Err_No As Long, ByRef Err_Desc As String, SurveyID As Integer) As DataTable
        Try
            ...
            Dim dt As New DataTable
            dt = ObjDAlSurvey.GetAssignedFSRBySurveyID(Err_No, Err_Desc, SurveyID)
        ...
        End Try
    End Function
    Public Function LoadResponseTypes(ByRef Err_No As Long, ByRef Err_Desc As String) As DataTable
        Try
            Return ObjDAlSurvey.GetResponsesType(Err_No, Err_Desc)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function GetSurveyDetailsByID(ByRef Err_No As Long, ByRef Err_Desc As String, SurveyID As Integer) As DataTable
        Try
            Return ObjDAlSurvey.GetSurveyDetailsByID(Err_No, Err_Desc, SurveyID)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function GetSurveyResponsesBySurveyID(ByRef Err_No As Long, ByRef Err_Desc As String, SurveyID As Integer) As DataTable
        Try
            Return ObjDAlSurvey.GetSurveyResponsesBySurveyID(Err_No, Err_Desc, SurveyID)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function GetSurveyQuestionsBySurveyID(ByRef Err_No As Long, ByRef Err_Desc As String, SurveyID As Integer) As DataTable
        Try
            Return ObjDAlSurvey.GetSurveyQuestionsBySurveyID(Err_No, Err_Desc, SurveyID)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function UpdateSurveyStatus(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal SurvId As Integer, OldStatus As String, NewStatus As String) As Boolean
        Try
            Return ObjDAlSurvey.UpdateSurveyStatus(Err_No, Err_Desc, SurvId, OldStatus, NewStatus)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function CheckSurveyStatus(ByRef Err_No As Long, ByRef Err_Desc As String, SurveyID As String) As Boolean
        Try
            Return ObjDAlSurvey.CheckSurveyStatus(Err_No, Err_Desc, _sSurveyID)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function SaveSurvey(ByRef Err_No As Long, ByRef Err_Desc As String, SurveyID As Integer, SurveyTitle As String, StartDate As DateTime, EndDate As DateTime, SurveyType As String, dtFSRAssigned As DataTable, dtQuestions As DataTable, dtResponses As DataTable, MessageMode As String, Createdby As Integer) As Boolean
        Try

            Return ObjDAlSurvey.InsertSurvey(Err_No, Err_Desc, SurveyID, SurveyTitle, StartDate, EndDate, SurveyType, dtFSRAssigned, dtQuestions, dtResponses, MessageMode, CreatedBy)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function CheckduplicateSurvey(ByRef Err_No As Long, ByRef Err_Desc As String, SurveyID As String) As Boolean
        Try
            Return ObjDAlSurvey.CheckSurveyTitle(Err_No, Err_Desc, _sTitle, SurveyID)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
