...
#End Region
    ...
    End Function
    Public Function UpdateOrgConfig(ByRef Err_No As Long, ByRef Err_Desc As String, DocPrefix As String) As Boolean
        Try
            Return objOrgConfig.UpdateOrgConfig(Err_No, Err_Desc, _sOrg_ID, _sMas_Org_ID, _sSales_org_ID, _sEmp_Code, DocPrefix)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
