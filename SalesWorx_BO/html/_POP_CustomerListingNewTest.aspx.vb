...
Partial Public Class _POP_CustomerListingNewTest
    ...
    Private Sub BindEmptymap()
        Try
            ...
            'Dim geocodevalues = String.Join(",", oGeocodeList.ToArray())
            ScriptManager.RegisterStartupScript(Page, GetType(Page), "alert", "alert('StartupScript');", True)

            Page.ClientScript.RegisterClientScriptBlock(Me.GetType, "MyScript", "locationList = undefined; message = undefined;", True)


            ' RadAjaxManager1.ResponseScripts.Add("locationList = undefined; message = undefined;")
