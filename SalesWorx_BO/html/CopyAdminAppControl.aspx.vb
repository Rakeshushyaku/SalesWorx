...
Partial Public Class CopyAdminAppControl
    ...
    Private Sub LoadParamTypes()
        ...
        Me.ddlFilterBy.ClearSelection()
        Me.ddlFilterBy.Text = ""
        Dim dt As New DataTable
        dt = objControl.LoadAppParamType(Err_No, Err_Desc)
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button1.Click
        Try
            ...
            If Me.ddlFilterBy.SelectedIndex <= 0 Then
                MessageBoxValidation("Please select a parameter type.", "Valiation")
                Exit Sub
            End If
            ...
            For Each gvr As GridViewRow In gvParams.Rows
                ...
                Dim ddList As RadComboBox = DirectCast(gvr.FindControl("drpValue"), RadComboBox)
            ...
            If success = True Then
                ...
                BindData()
            Else
                MessageBoxValidation("Error occured while updating control parameter.", "Valiation")
            End If

        Catch ex As Exception
            MessageBoxValidation("Error occured while updating application control parameters.", "Valiation")
            log.Error(GetExceptionInfo(ex))
        End Try
    End Sub
    ...
    Protected Sub RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs)
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            Dim lblType As Label = DirectCast(e.Row.FindControl("lblControlType"), Label)
            Dim ControlKey As String = gvParams.DataKeys(e.Row.RowIndex).Value
            Dim ddList As RadComboBox = DirectCast(e.Row.FindControl("drpValue"), RadComboBox)
