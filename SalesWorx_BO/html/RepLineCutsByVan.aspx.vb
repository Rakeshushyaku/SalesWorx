...
Public Class RepLineCutsByVan
    ...
    Private ReportPath As String = "LineCutByVan"
    Private Const PageID As String = "P364"
    ...
    Private Sub SearchBtn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SearchBtn.Click
        Try
            If ValidateInputs() Then
                ...
                Me.hTSMonth.Value = CDate(txtToDate.SelectedDate).ToString("dd-MMM-yyyy")
                ...
                If Not String.IsNullOrEmpty(ddl_Customer.SelectedValue) Then
                    ...
                    End If
                    HCustomer_ID.Value = ids(0)
                    HSiteID.Value = ids(1)
                Else
                    HCustomer_ID.Value = "0"
                    HSiteID.Value = "0"
                ...
                Dim y As DataTable
                y = objRep.GetLineCutsByVanSummary(Err_No, Err_Desc, Me.hfOrgID.Value, vanstr, CDate(txtFromDate.SelectedDate).ToString("dd-MMM-yyyy"), CDate(txtToDate.SelectedDate).ToString("dd-MMM-yyyy"), HCustomer_ID.Value, HSiteID.Value)
                ...
                Me.lblSelTodate.Text = CDate(txtToDate.SelectedDate).ToString("dd-MMM-yyyy")
    ...
    Sub Export(format As String)
        Try
            ...
            Dim y As DataTable
            y = objRep.GetLineCutsByVanSummary(Err_No, Err_Desc, ddlOrganization.SelectedItem.Value, VanStr, CDate(txtFromDate.SelectedDate).ToString("dd-MMM-yyyy"), CDate(txtToDate.SelectedDate).ToString("dd-MMM-yyyy"), HCustomer_ID.Value, HSiteID.Value)
            ...
            Customer_ID = New ReportParameter("Customer_ID", HCustomer_ID.Value)


            Dim SiteID As New ReportParameter
            SiteID = New ReportParameter("SiteID", HSiteID.Value)
            ...
            rview.ServerReport.SetParameters(New ReportParameter() {org, vans, sdat, SalesorgName, VanName, Currency, DecimalDigits, TotAssigned, TotBilled, BillCutPercent, TDate, Customer_ID, SiteID})
            ...
            If format = "PDF" Then
                ...
                Response.AddHeader("Content-disposition", "attachment;filename=LineCutsByVan.pdf")
                Response.AddHeader("Content-Length", bytes.Length)


            ElseIf format = "Excel" Then
                Response.ContentType = "application/excel"
                Response.AddHeader("Content-disposition", "filename=LineCutsByVan.xls")
                Response.AddHeader("Content-Length", bytes.Length)
            End If
    ...
    Protected Sub lblBilled_Click(sender As Object, e As EventArgs)
        Try
            ...
            Dim CustID As Label = DirectCast(row.FindControl("lblCustomerID"), Label)
            Dim SiteID As Label = DirectCast(row.FindControl("lblSiteID"), Label)

            HSelCustomer_ID.Value = CustID.Text
            HSelSiteID.Value = SiteID.Text
            rgZeroBilled.Rebind()
