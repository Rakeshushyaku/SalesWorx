<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Rep_ReturnDetails.aspx.vb" Inherits="SalesWorx_BO.Rep_ReturnDetails"  Title="Return Details"%>
        ...
        <asp:HiddenField ID="lblCurrency" runat="server" />
         <div class="table-responsive" id="Detailed"  runat="server">
                   ...
                   <telerik:RadTabStrip ID="Salestab" runat="server" Skin="Windows7" MultiPageID="RadMultiPage21"
                    SelectedIndex="0">
                    <Tabs>
                        <telerik:RadTab Text="Credit Note Details" runat="server">
                        </telerik:RadTab>
