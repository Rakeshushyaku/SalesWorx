<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/DashboardSection.Master" CodeBehind="DashboardSalesbyAgency.aspx.vb" Inherits="SalesWorx_BO.DashboardSalesbyAgency" %>
    ...
    var param = document.getElementById('<%= HUID.ClientID %>').value;
          ...
          $("#chart3").kendoChart({
              ...
              dataSource: {
                  ...
                  transport: {
                      read: {
                      url: "Chart.asmx/GetSalesbyAgency", //specify the URL which should create new records. This is the Create method of the Products.asmx service.
              ...
              legend: {
                  ...
                  position: "right",
                  labels: { font: "12px Calibri", color: "black",
                      background: "white"
                  }
              ...
              categoryAxis:
                {
                    labels: { font: "12px Calibri" }
                },
              valueAxis:
                {
                    labels: { font: "12px Calibri" }
                },
                seriesColors: ["#CCCC66", "#6699FF", "#33CCFF", "#FF99CC", "#FF9933", "#FFFF99", "#FFCC99", "#9999FF"],
              series: [{
              field: "Amount",
                  categoryField: "Description",
                  labels: { font: "12px Calibri", color: "white",
                      background: "black"
                  }
