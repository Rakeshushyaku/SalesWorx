...
Partial Public Class AssignBonusPlanToCustomer1
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        If Me.ddOraganisation.SelectedIndex > 0 Then 'And ddlBonusPlan.SelectedItem.Text <> "-- Select a Plan --" Then
            Try
                Err_No = Nothing
                Err_Desc = Nothing
                Dim CustSite() As String
    ...
    Protected Sub btnFilter_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnFilter.Click
        If Me.ddOraganisation.SelectedIndex > 0 Then 'And Me.ddlBonusPlan.SelectedIndex > 0 Then
            BindDefault()
            BindSelected()
        Else
