<%@ Page Title="Incentive Commission Management " Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master"
    CodeBehind="ManageIncentiveCommission.aspx.vb" Inherits="SalesWorx_BO.ManageIncentiveCommission" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
    ...
    <script type="text/javascript">
     ...
     <asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
          ...
          <h4>Incentive Commission  Management</h4>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <telerik:RadComboBox Skin="Simple"  ID="ddFilterBy" Width="100%" Height="250px" TabIndex="2" runat="server">
                                                    <Items>
                                                        ...
                                                        <telerik:RadComboBoxItem Value="Classification" Text="Classification"></telerik:RadComboBoxItem>
                                                      </Items>
                                                </telerik:RadComboBox>
                                            </div>
                                        </div>
                                     ...
                                     <div  class="row">
                                            ...
                                            <div class="form-group">   
                                                <label>
                                                  ...
                                                  <telerik:RadButton ID="btnExport" Skin="Simple" Text="Export Commission" runat="server" CssClass="btn btn-info" OnClick="btnExport_Click"></telerik:RadButton>
                  ...
                  <div class="table-responsive">
                            <asp:UpdatePanel ID="ClassUpdatePnl" runat="server" UpdateMode="conditional">
                                <ContentTemplate>
                                                ...
                                                <asp:GridView Width="100%" ID="gvIncentiveCommission" runat="server" EmptyDataText="No Incentive Commission to Display"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                 <asp:LinkButton  runat="server" CommandName="Status" ID="lbChangeStatus_Target"  Text='<%# Bind("Status")%>'  OnClientClick=<%# "javascript:return checkconfirm('" + Eval("Is_Active") + "');"%> OnClick ="lbChangeStatus_Commission_Click"  ></asp:LinkButton>
                                                        ...
                                                        <asp:BoundField DataField="Commission" DataFormatString="{0:#,###.00}" HeaderText="Commission"
                                    ...
                                    <script type="text/javascript">
                                        $(window).resize(function () {
                                            var win = $find('<%= MPECommission.ClientID%>');
                                            if (win) {
                                                if (!win.isClosed()) {
                                                    win.center();
                                                }
                                    ...
                                    <telerik:RadWindow ID="MPECommission" Title= "Incentive Commission  Details" runat="server" Skin="Windows7" Behaviors="Move,Close"
                           ...
                           <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="conditional">
                               ...
                               <asp:HiddenField ID="HidVal" runat="server" Value="-1" />
                                    <div class="popupcontentblk">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="form-group">
                                                    <telerik:RadComboBox ID="ddl_org" Width ="100%" runat="server" AutoPostBack="true"   TabIndex="4" Skin="Simple" Filter="Contains"  >
                                            ...
                                            <div class="col-sm-7">
                                                <div class="form-group">
                                                          <telerik:RadComboBox Skin="Simple" Filter="Contains" ID="ddlClassification" Width="100%" Height="250px"
                                                    runat="server" DataTextField="Classification" DataValueField="Classification" EnableLoadOnDemand="True" AutoPostBack="true" EmptyMessage="Please type Classification" OnSelectedIndexChanged ="ddlClassification_SelectedIndexChanged">
                                                </telerik:RadComboBox>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-7">
                                                <div class="form-group">
                                                    <telerik:RadComboBox ID="ddl_UOM" Width ="100%" runat="server"    TabIndex="4" Skin="Simple" Filter="Contains"  >
                                            ...
                                            <div class="col-sm-7">
                                                <div class="form-group">
                                                     <telerik:RadNumericTextBox RenderMode="Lightweight" runat="server" ID="txtCommission"   Width="190px" MaxValue ="9999" MinValue ="0"  >
                                            ...
                                            <div class="col-sm-7">
                                                <div class="form-group">
                                                    <telerik:RadMonthYearPicker RenderMode="Lightweight" ID="month_picker" runat="server" Width="238px"  >
                                                     </telerik:RadMonthYearPicker>
                                                </div>
                                            </div>
                                            <div class="col-sm-5">
                                    ...
                                    <script type="text/javascript">
                                        $(window).resize(function () {
                                            var win = $find('<%= MPECommission_import.ClientID%>');
                                            if (win) {
                                                if (!win.isClosed()) {
                                                    win.center();
                                                }
                                     ...
                                     <telerik:RadWindow ID="MPECommission_import" Title= "Import Incentive Commission  Details" runat="server" Skin="Windows7" Behaviors="Close"
                            ...
                            ControlToValidate="file_import" Display="Dynamic"  ErrorMessage="*Upload only .xls and .xlsx Files" ValidationExpression="^(.)+(.xls|.XLS|.xlsx|.XLSX)$"></asp:RegularExpressionValidator>
                                                  <br />
                                                    ...
                                                    <asp:Button ID="btn_CancelImport"  CssClass ="btn btn-danger"  TabIndex="6" runat="server" CausesValidation="false"
                                                        Text="Cancel" />
                                                     </ContentTemplate>
                                                    </asp:UpdatePanel>  
                                                    </div>
