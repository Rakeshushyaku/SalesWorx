...
Public Class Rep_EOTSummary
    ...
    Private ReportPath As String = "Van_EOTSummary"
    ...
    Sub Export(format As String)
        ...
        If format = "PDF" Then
            ...
            Response.AddHeader("Content-disposition", "attachment;filename=Van_EOT.pdf")
            Response.AddHeader("Content-Length", bytes.Length)
        ElseIf format = "Excel" Then
            Response.ContentType = "application/excel"
            Response.AddHeader("Content-disposition", "filename=Van_EOT.xls")
            Response.AddHeader("Content-Length", bytes.Length)
        End If
