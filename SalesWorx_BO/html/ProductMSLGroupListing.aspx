<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="ProductMSLGroupListing.aspx.vb" Inherits="SalesWorx_BO.ProductMSLGroupListing" %>
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn UniqueName="TotalItems"
                         ...
                         >
                           ...
                           <telerik:GridBoundColumn UniqueName="TotalCustomer"
                            SortExpression="TotalCustomers" HeaderText="Tot.Customers Assigned" DataField="TotalCustomers"
                         >
                            <ItemStyle Wrap="false" /></telerik:GridBoundColumn>
