<%@ Page Title="Audit Survey" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="RepAuditSurvey.aspx.vb" Inherits="SalesWorx_BO.RepAuditSurvey" %>
   ...
   <telerik:RadAjaxPanel runat="server" ID="g">
       ...
       <asp:HiddenField ID="HUID" runat="server" />
            ...
            Status</label>
                 ...
                 <telerik:RadComboBox Skin="Simple" Width ="100%" ID="ddl_Status" runat="server" AutoPostBack="false">                        
                     <Items>
                         <telerik:RadComboBoxItem Text="All" Value="0" Selected="true"  />
                         <telerik:RadComboBoxItem Text="Initialised" Value="N" />
       ...
       <div id="RepDiv" runat="server" visible="false" >
        ...
        <table>
            ...
            <tr>
                ...
                <td class="txtSMBold">
                <asp:Label ID="Label2" runat="server" CssClass="inputSM" Visible="False"></asp:Label>
                </td>
                <td  align="left" class="txtSMBold"><asp:Label ID="Label3" runat="server" 
