<%@ Page Title="Copy Route Plan" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="CopyRoutePlan.aspx.vb" Inherits="SalesWorx_BO.CopyRoutePlan" %>
   ...
   <telerik:RadWindowManager ID="RadWindowManager1"  Skin="Simple" runat="server" EnableShadow="true">
    ...
    <div class="row">
            ...
            <div class="col-sm-4"> <label>To</label>
                <telerik:RadComboBox ID="RP_ID" CssClass="input" TabIndex ="3" Width ="100%" runat="server" Skin="Simple"
                    DataTextField="Details" DataValueField="FSR_Plan_ID">
                </telerik:RadComboBox>
            </div>
        <div class="col-sm-4">
