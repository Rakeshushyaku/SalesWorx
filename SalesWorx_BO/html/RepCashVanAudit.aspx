<%@ Page Title="Cash Van Audit Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="RepCashVanAudit.aspx.vb" Inherits="SalesWorx_BO.RepCashVanAudit" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <telerik:RadComboBox Skin="Simple" Filter="Contains" ID="ddlOrganization"   Width ="100%"
                 ...
                 <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>
             <asp:Label ID="lblCustVan" runat="server" Text="Van"></asp:Label> <em><span>&nbsp;</span>*</em></label>
