...
Public Class TargetVsSalesbyMonths

    Public Sub New()
    End Sub

    Public Sub New(ByVal AgencyName As String, ByVal unit As String, ByVal Description As String, ByVal DispOrder As String, MonthYear As Date, Count As String)
