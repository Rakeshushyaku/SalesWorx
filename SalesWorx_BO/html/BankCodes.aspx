<%@ Page Title="BANK Code Management" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master"
    CodeBehind="BankCodes.aspx.vb" Inherits="SalesWorx_BO.BankCodes" %>
        ...
        function TestCheckBox() {
            ...
            for (var n = 0; n < Inputs.length; ++n)
                if (Inputs[n].type == 'checkbox' && Inputs[n].id.indexOf(TargetChildControl, 0) >= 0 && Inputs[n].checked) {
                    return confirm('Would you like to delete the selected BANK code?');
                    return true;
                }
     ...
     <h4>Bank Code Management</h4>
        ...
        <asp:Panel ID="Panel1" runat="server">      </asp:Panel> 
                    ...
                    <Items>
                        ...
                        <telerik:RadComboBoxItem Value="Bank Code" Text="Bank Code"></telerik:RadComboBoxItem>
                        ...
                        <div class="table-responsive">
                            <asp:UpdatePanel ID="ClassUpdatePnl" runat="server" UpdateMode="conditional">
                                <ContentTemplate>
                                                ...
                                                <asp:GridView Width="100%" ID="gvBankCode" runat="server" EmptyDataText="No Items to Display"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            ...
                                                            <HeaderStyle HorizontalAlign="Left" Width="100px" CssClass="display-block text-wrap"  />
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="chkDelete" runat="server"  />
                                                                <asp:ImageButton ToolTip="Delete Bank Code" ID="btnDelete" OnClick="btnDelete_Click"
                                                                    runat="server" CausesValidation="false"  ImageUrl="~/images/delete-13.png" OnClientClick="javascript:return confirm('Would you like to delete the selected Bank code?');" />
                                                                <asp:ImageButton ID="btnEdit" ToolTip="Edit Bank Code" runat="server" CausesValidation="false"
                                                                      ImageUrl="~/images/edit-13.png"   OnClick="btnEdit_Click" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Code_Value")%>' />
                                                            </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="Left" Width="100px" CssClass="display-block text-wrap"  />
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="Code_Value" HeaderText="Bank Code" SortExpression="Code_Value">
                                                            <ItemStyle Wrap="False" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="Code_Description" HeaderText="Description" SortExpression="Code_Description">
                                                            <ItemStyle Wrap="False" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="Custom_Attribute_4" HeaderText="Currency" SortExpression="Custom_Attribute_4">
                                                            <ItemStyle Wrap="False" />
                                                        </asp:BoundField>
                                                        <asp:TemplateField Visible="False">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblReason" runat="server" Text='<%# Bind("Code_Value")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                    ...
                                    <telerik:RadWindow ID="MPEDetails" Title= "Bank Code Details" runat="server" Skin="Windows7" Behaviors="Move,Close"
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="popupcontentblk">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="form-group">
                                                    <asp:TextBox ID="txtBankCode" runat="server" TabIndex="1" Width="100%" MaxLength="50"  ></asp:TextBox>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="form-group">
                                                    <asp:TextBox ID="txtDescription" runat="server" TabIndex="2" Width="100%" MaxLength="100"></asp:TextBox>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="form-group">
                                                    <telerik:RadComboBox id="ddl_country" runat="server" TabIndex="3" Width="100%" Skin="Simple"  ></telerik:RadComboBox>
