...
Partial Public Class Rep_SalesByAgency
    ...
    Private ReportPath As String = "SalesbyAgency_V2"
    ...
    Sub BindOverAllReport()
        Try
            ...
            dt = objRep.GetSalesReturnsbyAgency(Err_No, Err_Desc, HorgID.Value, HVan.Value, HUID.Value, HType.Value, Fromdate.ToString("dd-MMM-yyyy"), Todate.ToString("dd-MMM-yyyy"), HAgency.Value, HItem.Value, Hcustomer.Value)
    ...
    Sub BindReport()
        ...
        dt = objRep.GetSalesReturnsbyAgencyDetailed(Err_No, Err_Desc, HorgID.Value, HVan.Value, HUID.Value, HType.Value, Fromdate.ToString("dd-MMM-yyyy"), Todate.ToString("dd-MMM-yyyy"), HAgency.Value, HItem.Value, Hcustomer.Value)
    ...
    Sub Export(format As String)
        ...
        If format = "PDF" Then
            ...
            Response.AddHeader("Content-disposition", "attachment;filename=SalesbyAgency.pdf")
            Response.AddHeader("Content-Length", bytes.Length)
        ElseIf format = "Excel" Then
            Response.ContentType = "application/excel"
            Response.AddHeader("Content-disposition", "filename=SalesbyAgency.xls")
            Response.AddHeader("Content-Length", bytes.Length)
        End If
    ...
    Protected Sub gvRep_ItemCommand(sender As Object, e As GridCommandEventArgs)
        ...
        If e.CommandName = RadGrid.ExportToExcelCommandName Then
            ...
            gvRep.ExportSettings.FileName = "SalesbyAgency"
        End If
