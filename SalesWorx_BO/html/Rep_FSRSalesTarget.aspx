<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="Rep_FSRSalesTarget.aspx.vb" Inherits="SalesWorx_BO.Rep_FSRSalesTarget" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Sales Target</span></div>
...
<table  border="0" cellspacing="2" cellpadding="2" >
          ...
          <%--           <asp:BoundField DataField="Scanned_Closing" ItemStyle-HorizontalAlign="center" HeaderText="Scanned" >
           ...
           <tr> 
            <td width="105" class="txtSMBold">Target Year :</td>
            <td class="style1">
                <asp:DropDownList ID="ddlYear"  runat="server"  CssClass="inputSM">
                                    </asp:DropDownList>
            </td>
             <td width="105" class="txtSMBold">Target Month:</td>
            <td >
                     <asp:DropDownList ID="ddlMonth"   runat="server"  CssClass="inputSM">
                                    </asp:DropDownList>
                     </td>
                     <td></td>
          </tr>
