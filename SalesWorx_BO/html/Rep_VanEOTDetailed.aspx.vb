...
Public Class Rep_VanEOTDetailed
    ...
    Private ReportPath As String = "Van_EOTDetailed_new"
    Dim dv As New DataView
    Private Const PageID As String = "P358"
    ...
    Sub LoadStock()
        ...
        tdt = ObjReport.GetDailyStockReport(Err_No, Err_Desc, horg.Value, hvan.Value, "0", CDate(hDate.Value).ToString("dd-MMM-yyyy"))
        gvrep_stock.DataSource = tdt
    ...
    Private Sub gvRep_PreRender(sender As Object, e As EventArgs) Handles gvRep.PreRender
        ...
        Next
    End Sub
    Private Sub dgv_Stock_SortCommand(ByVal source As Object, ByVal e As GridSortCommandEventArgs) Handles gvrep_stock.SortCommand
        ViewState("SortField") = e.SortExpression
        SortDirectionStock = "flip"
        LoadStock()
    End Sub
    Private Sub dgvdgv_Stock_PageIndexChanged(ByVal source As Object, ByVal e As GridPageChangedEventArgs) Handles gvrep_stock.PageIndexChanged
    ...
    Sub Export(format As String)
        ...
        If format = "PDF" Then
            ...
            Response.AddHeader("Content-disposition", "attachment;filename=Van_EOTDetailed.pdf")
            Response.AddHeader("Content-Length", bytes.Length)
        ElseIf format = "Excel" Then
            Response.ContentType = "application/excel"
            Response.AddHeader("Content-disposition", "filename=Van_EOTDetailed.xls")
            Response.AddHeader("Content-Length", bytes.Length)
        End If
    ...
    Protected Sub ViewDetails_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Response.Redirect("Rep_VanEOTDetailed.aspx?SID=" & sid & "&Vdate=" & vdate)
