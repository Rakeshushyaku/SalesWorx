<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="Rep_ProductStock.aspx.vb" Inherits="SalesWorx_BO.Rep_ProductStock" %>
...
<table  border="0" cellspacing="2" cellpadding="2" width="99%">
          <tr>
            ...
            <td><telerik:RadComboBox Skin="Simple" Filter="Contains" ID="ddlOrganization"   Width ="250px"
                    runat="server" DataTextField="Description" DataValueField="MAS_Org_ID" Enabled="false"
                                        AutoPostBack="True">
                </telerik:RadComboBox>
              </td>
              <td class="txtSMBold">Principal :</td>
             <td><telerik:RadComboBox Skin="Simple" Filter="Contains" ID="ddlAgency" 
                    runat="server" DataTextField="Agency"  Width ="250px" 
                     DataValueField="Agency" AutoPostBack="True">
               </telerik:RadComboBox></td>
          </tr> 
          <tr> 
            <td  class="txtSMBold">SKU :</td>
            <td>
                <telerik:RadComboBox Skin="Simple" Filter="Contains" ID="ddlSKU" runat="server" CssClass="inputSM" 
                     Width="250px">
                </telerik:RadComboBox>
                &nbsp;
                </td>
