...
Partial Public Class ChangePassword
    ...
    Sub MessageBoxInfo(ByVal str As String)
        MessageBoxValidation(str, "Information")
        Exit Sub
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            ...
            If txtOldPwd.Text.Trim() = "" Then
                MessageBoxValidation("Please enter Old password", "Validation")
                Valid = False
                Exit Sub
            End If

            If txtNewPwd.Text.Trim() = "" Then
                MessageBoxValidation("Please enter New password", "Validation")
                Valid = False
                Exit Sub
            End If

            If txtConfirmPwd.Text.Trim() = "" Then
                MessageBoxValidation("Please enter Confirm password", "Validation")
                Valid = False
                Exit Sub
            End If
            ...
            If txtConfirmPwd.Text.Trim() <> txtNewPwd.Text.Trim() Then
                MessageBoxValidation("New password and confirm password do not match.", "Information")
                Return
            End If
            ...
            Else
                ...
                If Err_No = 74213 Then
                    MessageBoxValidation("Error occured while changing the password.", "Information")
                End If
            End If
        Catch ex As Exception
            log.Error(GetExceptionInfo(ex))
