<%@ Page Title="Monthly FOC Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="RepMonthlyFOC.aspx.vb" Inherits="SalesWorx_BO.RepMonthlyFOC" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <telerik:RadComboBox Filter="Contains" DataTextField="Description" DataValueField="MAS_Org_ID" AutoPostBack="True" 

Skin="Simple"  ID="ddlOrganization" Width="100%" runat="server">
                                            </telerik:RadComboBox>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
        ...
        <div id="rpt" runat="server" visible="false" style="padding-top: 5px">
            ...
            <div class="row" id="MainContent_summary">
                <div class="col-sm-4 col-md-3 col-lg-2-1">
                    <div class="widgetblk widgetblkinsmall">
                        Total Value(<asp:Label ID="lblTargetCurr" runat="server"></asp:Label>)<div class="text-primary">
                ...
                <div class="col-sm-4 col-md-3 col-lg-2-1">
                    <div class="widgetblk widgetblkinsmall">
                       Total Volume <asp:Label ID="lblSalesCurr" runat="server" Visible ="false" ></asp:Label><div class="text-primary">
            ...
            <div class="table-responsive">
               ...
               <telerik:RadGrid id="gvVans" AllowSorting="True" AutoGenerateColumns="False" Skin="Simple" Width="100%" BorderColor="LightGray"
                                PageSize="11" AllowPaging="True" runat="server" DataSourceID="SqlDataSource1" ShowFooter="true"
                                GridLines="None" >
...
DataSourceID="SqlDataSource1" 
                  ...
                  <PagerStyle Mode="NextPrevAndNumeric"></PagerStyle>
                                                        <Columns>
                                                        <telerik:GridBoundColumn Visible="false" HeaderStyle-HorizontalAlign="Left" DataField="Van" HeaderText="Van/FSR"
                                                                  SortExpression ="Van" >
                                                             ...
                                                             <telerik:GridBoundColumn    HeaderStyle-HorizontalAlign="Left" DataField="Description" 

HeaderText="Product"
                                                                  SortExpression ="Description" >
                                                                <ItemStyle Wrap="False" />
                                                             </telerik:GridBoundColumn>
                                                             <telerik:GridBoundColumn    HeaderStyle-HorizontalAlign="Left" DataField="Primary_UOM_Code" 

HeaderText="UOM"
                                                                  SortExpression ="Primary_UOM_Code" >
                                                                <ItemStyle Wrap="False" />
                                                             </telerik:GridBoundColumn>
                                                          <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Right" DataField="FOCQty" HeaderText="Volume"
                                            SortExpression="Volume" Aggregate="Sum" AllowFiltering="false">
                                         <ItemStyle Wrap="False" HorizontalAlign ="Right"  />
                                             <HeaderStyle Wrap ="true" HorizontalAlign ="Center" />
                                            <FooterStyle HorizontalAlign="right" Font-Bold="true" BackColor="#eff9ff" ForeColor="#000" Font-Size="15px" />
                                                                </telerik:GridBoundColumn> 
                                                               
                                                             <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Right" DataField="FOCValue" HeaderText="Value"
                                            SortExpression="FOCValue" Aggregate="Sum" AllowFiltering="false" >
                                         <ItemStyle Wrap="False" HorizontalAlign ="Right"  />
                                             <HeaderStyle Wrap ="true" HorizontalAlign ="Center" />
                                            <FooterStyle HorizontalAlign="right" Font-Bold="true" BackColor="#eff9ff" ForeColor="#000" Font-Size="15px" />
                                                                </telerik:GridBoundColumn> 
                                                          
                                                             <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Right" DataField="ZeroPricedFOC" HeaderText="Zero Priced FOC Volume"
                                            SortExpression="ZeroPricedFOC" Aggregate="Sum" AllowFiltering="false">
                                         <ItemStyle Wrap="False" HorizontalAlign ="Right"  />
                                             <HeaderStyle Wrap ="true" HorizontalAlign ="Center" />
                                            <FooterStyle HorizontalAlign="right" Font-Bold="true" BackColor="#eff9ff" ForeColor="#000" Font-Size="15px" />
                                                                </telerik:GridBoundColumn> 
                                                     ...
                                                     <GroupByExpressions>
                                                         ...
                                                         <telerik:GridGroupByExpression>
                                                            <SelectFields>
                                                                <telerik:GridGroupByField HeaderText="Van/FSR" FieldName="Van"   
                                                                   ></telerik:GridGroupByField>
                                                   
                                                            </SelectFields>
                                                                 <GroupByFields>
                                                                     <telerik:GridGroupByField FieldName="Van" >
                          ...
                          <%--  <telerik:RadGrid ID="" AllowSorting="True" AutoGenerateColumns="False" Skin="Simple" Width="100%" BorderColor="LightGray"
                                PageSize="8" AllowPaging="false" runat="server" DataSourceID="SqlDataSource1" ShowFooter="true" AllowFilteringByColumn="true"
                                GroupingSettings-RetainGroupFootersVisibility="true" GroupingSettings-GroupContinuesFormatString="" GroupingSettings-
...
GroupContinuedFormatString=""
                                ...
                                <MasterTableView AutoGenerateColumns="false" TableLayout="Auto" ShowFooter="true" AllowFilteringByColumn="true"
                                    ...
                                    <CommandItemTemplate>
                                       ...
                                       <asp:ImageButton ID="Button" runat="server" AlternateText="Clear filter" ToolTip="Clear filter" OnClick="Button_Click" 

ImageUrl="~/images/Clearfilter.png" />
                                   </div>
                                    </CommandItemTemplate>
                                    <PagerStyle Mode="NextPrevAndNumeric"></PagerStyle>
                                    ...
                                    <Columns>
                                         ...
                                         <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Van" HeaderText="Van" AutoPostBackOnFilter ="true" 
                            SortExpression="Van"  Aggregate ="Count" FooterText ="Total : "  AllowFiltering ="true" ShowFilterIcon ="false"
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign ="Left"  />
                                 ...
                                 <FooterStyle HorizontalAlign="Left" Font-Bold="true" BackColor="#eff9ff" ForeColor="#000" Font-Size="15px" />
                                        ...
                                        <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Right" DataField="FOCValue" HeaderText="Value"
                                            SortExpression="Value" Aggregate="Sum" AllowFiltering="false">
                                         <ItemStyle Wrap="False" HorizontalAlign ="Right"  />
                                             <HeaderStyle Wrap ="true" HorizontalAlign ="Center" />
                                            <FooterStyle HorizontalAlign="right" Font-Bold="true" BackColor="#eff9ff" ForeColor="#000" Font-Size="15px" />
                                        </telerik:GridBoundColumn>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SWXConnectionString %>"
                            SelectCommand="Rep_MonthlyFOCByVan" SelectCommandType="StoredProcedure">
