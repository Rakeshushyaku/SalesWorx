...
Partial Public Class AdminPOS_MasterSetUp
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If Me.ddl_Question.SelectedItem.Value = "0" Then
            ...
            'Me.MpInfoError.Show()
            'Me.MPECurrency.Show()
            lblPop.Text = "Question is required."
            MPEDetails.VisibleOnPageLoad = True
            Exit Sub
        End If
        ...
        If Me.txtCode.Text = "" Or Me.txtDescription.Text = "" Then
            ...
            'Me.MpInfoError.Show()
            'Me.MPECurrency.Show()
            lblPop.Text = "Code and description are required."
            MPEDetails.VisibleOnPageLoad = True
            Exit Sub
        End If
...
Regex("(^[-+]?\d+(,?\d*)*\.?\d*([Ee][-+]\d*)?$)|(^[-+]?\d?(,?\d*)*\.\d+([Ee][-+]\d*)?$)")
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        If Me.txtCode.Text = "" Or Me.txtDescription.Text = "" Then
            ...
            'Me.MpInfoError.Show()
            'Me.MPECurrency.Show()
            lblPop.Text = "Code and description rate are required."
            MPEDetails.VisibleOnPageLoad = True
            Exit Sub
        End If
    ...
    Protected Sub btnEdit_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            If Not ddl_QGroup.Items.FindItemByValue(lbl_GroupCode.Text) Is Nothing Then
                ddl_QGroup.ClearSelection()
                ddl_QGroup.Items.FindItemByValue(lbl_GroupCode.Text).Selected = True
            End If
            loadddlQuestion()
            If Not ddl_Question.Items.FindItemByValue(lbl_CodeType.Text) Is Nothing Then
                ddl_Question.ClearSelection()
                ddl_Question.Items.FindItemByValue(lbl_CodeType.Text).Selected = True
            End If
    ...
    Sub loadFilterQuestion()
        ...
        ddQuestion.DataBind()
        ddQuestion.Items.Insert(0, New RadComboBoxItem("-- Select a value --", "0"))
    End Sub
    Sub loadddlQuestion()
        Dim dt As New DataTable
        dt.Columns.Add("Question")
        ...
        ddl_Question.Items.Insert(0, New RadComboBoxItem("-- Select a value --", "0"))
    End Sub
