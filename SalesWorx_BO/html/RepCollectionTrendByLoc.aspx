<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="RepCollectionTrendByLoc.aspx.vb" Inherits="SalesWorx_BO.RepCollectionTrendByLoc" %>
...
.k-chart svg{
     ...
     <script>
         ...
         function createlineChart() {
             ...
             $("#chart3").kendoChart({
                 ...
                 title: { text: "Delayed % by Location ", align: "center", font: "bold 12px Segoe UI", color: "black" },
                 seriesDefaults: {
                     style: "smooth",
         ...
         function createChart3() {
             ...
             var param5 = document.getElementById('<%= HLoc.ClientID%>').value;

             if (param1 != "" && param2 != "" & param3!="") {

                 $.ajax({
                     type: "POST", contentType: "application/json;charset=utf-8", url: "Chart.asmx/CollectionTrendByLoc", data: '{param1:"' + param1 + '",param2:"' + param2 + '",param3:"' + param3 + '", param4:"' + param4 + '", param5:"' + param5 + '"}', dataType: "json", success: function (response)
                     {
   ...
   <asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
       <h4>Delayed Trend By Location</h4>
       ...
       <p><br /><br /></p>
         ...
         <telerik:RadPivotGrid RenderMode="Lightweight" AllowPaging="true"  PageSize="10"
          ...
          <TotalsSettings GrandTotalsVisibility="None"  />
                                                    <Fields>
                                                          <telerik:PivotGridRowField DataField="Area" ZoneIndex="0" Caption="Area " >
                                                                </telerik:PivotGridRowField>
                                                        <telerik:PivotGridColumnField DataField="Year" SortOrder="None">
                 
                                                        </telerik:PivotGridColumnField>

                                                        <telerik:PivotGridAggregateField DataField="Paid On Time"     >
                                                        </telerik:PivotGridAggregateField>
                                                        <telerik:PivotGridAggregateField DataField="Delayed" >
                                                        </telerik:PivotGridAggregateField>
                                                        <telerik:PivotGridAggregateField DataField="Delayed Percentage" >
                                                        </telerik:PivotGridAggregateField>
