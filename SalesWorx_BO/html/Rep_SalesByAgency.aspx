<%@ Page Title="Sales by Agency" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="Rep_SalesByAgency.aspx.vb" Inherits="SalesWorx_BO.Rep_SalesByAgency" %>
  ...
  <script type="text/javascript">
      ...
      function createChart3() {
          ...
          var dataSource = {
              ...
              transport: {
                  read: {
                      url: "Chart.asmx/GetRepSalesbyAgency", //specify the URL which should create new records. This is the Create method of the Products.asmx service.
          ...
          $("#chart3").kendoChart({
              ...
              series: [{
                  ...
                  tooltip: {
                      ...
                      format: "{0:N2}",
                      font: "12px Segoe UI",
                      template: "Agency : ${category}  <br>Sales: #=dataItem.Amount# ",
                      color: "white",
                      background: "black"
                  },
...

               {
                   ...
                   tooltip: {
                       ...
                       format: "{0:N2}",
                       font: "12px Segoe UI",
                       template: "Agency : ${category}  <br>Returns: #=dataItem.ReturnAmount# ",
                       color: "white",
                       background: "black"
                   },
      ...
      function createChart4() {
          ...
          var dataSource = {
              ...
              transport: {
                  read: {
                      url: "Chart.asmx/GetRepNetSalesbyAgency", //specify the URL which should create new records. This is the Create method of the Products.asmx service.
                      contentType: "application/json; charset=utf-8", // tells the web service to serialize JSON
                      type: "POST", //use HTTP POST request as the default GET is not allowed for ASMX
                      dataType: "json"
                  }
          ...
          $("#chart4").kendoChart({
              ...
              tooltip: {
                  visible: true,
                  format: "{0:N2}",
                  template: "Agency : ${category}  <br> Net  Sales : #=dataItem.Amount# ",
                  font: "12px Segoe UI",
                  color: "white",
                  background: "black"
              },
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <telerik:RadDatePicker ID="txtFromDate"  Width ="100%"  runat="server">
                                                  ...
                                                  <telerik:RadMonthYearPicker RenderMode="Lightweight" ID="txtFromMonth" runat="server" Visible="false"  >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <telerik:RadDatePicker ID="txtToDate"  Width ="100%"  runat="server">
                                                  ...
                                                  <telerik:RadMonthYearPicker RenderMode="Lightweight" ID="txtToMonth" runat="server" Visible="false" >
                                                            <DateInput ReadOnly="true" DisplayDateFormat="MMM-yyyy">
                                                        </DateInput>
 ...
 <div class="overflowx">
                        <telerik:RadAjaxPanel ID="RadAjaxPanel4" runat ="server"  >
                                                    ...
                                                    <MasterTableView AutoGenerateColumns="false" TableLayout="Auto" Width="100%" GridLines="None" BorderColor="LightGray"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Sales" HeaderText="Total Sales Value<i class='fa fa-info-circle'></i>"
                                                                  SortExpression ="Sales" DataType="System.Double" DataFormatString="{0:N2}" HeaderTooltip="Total sales value">
                                                                <ItemStyle Wrap="False"  HorizontalAlign="Right"  />
                                                                <HeaderStyle HorizontalAlign="Center" />
                                                           </telerik:GridBoundColumn>
                                                            <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Returns" HeaderText="Total Returns Value<i class='fa fa-info-circle'></i>"
                                                                  SortExpression ="Returns" DataType="System.Double" DataFormatString="{0:N2}" HeaderTooltip="Total returns value">
                                                                <ItemStyle Wrap="False"  HorizontalAlign="Right"  />
                                                                <HeaderStyle HorizontalAlign="Center" />
                                                           </telerik:GridBoundColumn>
                                                             <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Net" HeaderText="Net Sales Value<i class='fa fa-info-circle'></i>"  
    ...
    <h5 class='text-right'>Currency <span class='text-blue'><strong><asp:Label ID="lbl_Currency1" runat="server" Text=""></asp:Label></strong></span></h5>
                                                ...
                                                <telerik:RadPivotGrid RenderMode="Lightweight" AllowPaging="true"  PageSize="10"
                                                    ...
                                                    <Fields>
                                                          <telerik:PivotGridRowField DataField="Agency" ZoneIndex="0" Caption="Salesman " >
                                                        ...
                                                        <telerik:PivotGridAggregateField DataField="Net" Caption="Net Sales" >
                                                        </telerik:PivotGridAggregateField>
                                                    </Fields>
