<%@ Page Title="Import Stock Load" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="ImportStock_Update.aspx.vb" Inherits="SalesWorx_BO.ImportStock_Update" %>
                          ...
                          <hr/>
                            ...
                            <asp:UpdatePanel ID="ClassUpdatePnl" runat="server" UpdateMode="conditional">
                                <ContentTemplate>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="conditional">
                                        ...
                                        <p> <asp:Label ID="lblmsgPopUp" runat="server" Text="" ForeColor="Maroon" Font-Bold="true"></asp:Label></p>
                                          <div class="col-xs-12">                
                                        <div class="row">
                                            <div  class="col-sm-3">
                            ...
                            ControlToValidate="file_import" Display="Dynamic"  ErrorMessage="*Upload only .xls and .xlsx Files" ValidationExpression="^(.)+(.xls|.XLS|.xlsx|.XLSX)$"></asp:RegularExpressionValidator>
                                            ...
                                            <div class="form-group">
                                               ...
                                               <asp:GridView Width="100%" ID="dgvErros" runat="server" EmptyDataText="No Error Log to display"
                                                        EmptyDataRowStyle-Font-Bold="true" Font-Size ="12px" CssClass="tablecellalign" AutoGenerateColumns="False" 
                                                        AllowPaging="true" AllowSorting="false" PageSize="5" CellPadding="6" >
                                                        ...
                                                        <Columns>
                                                           ...
                                                           <%-- <asp:BoundField HeaderStyle-HorizontalAlign="Left"    HeaderStyle-Wrap="false" DataField="Van_location"
                                                            ...
                                                            <asp:BoundField  HeaderStyle-HorizontalAlign="Left"    HeaderStyle-Wrap="false" DataField="Lot_Qty"
