<%@ Page Title="Returns Reconciliation" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="Rep_ReturnsReconciliation.aspx.vb" Inherits="SalesWorx_BO.Rep_ReturnsReconciliation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Returns Reconciliation</span></div>
...
<table  border="0" cellspacing="2" cellpadding="2">
          ...
          <tr>
              <td class="txtSMBold">
                  Return Ref no.</td>
              <td>
                  <asp:TextBox  ID="txt_rma"  Width ="150px" CssClass="inputSM" runat="server"></asp:TextBox> </td>
              <td class="txtSMBold">
                  Order Ref No.</td>
              <td>
                  <asp:TextBox  ID="txt_order"  Width ="150px" CssClass="inputSM" runat="server"></asp:TextBox> 
