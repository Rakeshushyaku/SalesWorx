...
Partial Public Class POP_DefaultPlan
    ...
    Protected Sub CallCloseEvent(ByVal DayValue As String, ByVal ButtonType As String)
        ...
        ' '' ''    strScript += "opener.document.getElementById('MainContent_Action_Mode').value ='MODIFY';"
        ' '' ''Else
        ' '' ''    ' ''strScript += "window.opener.document.aspnetForm.ctl00_ContentPlaceHolder1_Action_Mode.value ='ADD';"
        ' '' ''    strScript += "opener.document.getElementById('MainContent_Action_Mode').value ='ADD';"
        ' '' ''End If
        ...
        ' '' ''strScript += "opener.document.getElementById('MainContent_CheckRefresh').value ='Y';"
        ' '' ''strScript += "opener.document.getElementById('MainContent_FromPopUp').value ='Y';"
        ' '' ''strScript += "opener.document.getElementById('MainContent_ISRefreskClick').value ='N';"
        ' '' ''strScript += "opener.document.getElementById('MainContent_Cell" & Request.QueryString("DayRef") & "').value ='Y';"
        ...
        ' '' ''    End If
        ' '' ''End If
        ' '' ''strScript += "opener.document.getElementById('MainContent_HDay" & Request.QueryString("DayRef") & "').value='" & DayValue & Ucomments & Time & "';"
        ' '' ''strScript += "opener.document.getElementById('MainContent_DayRef').value='" & Request.QueryString("DayRef") & "';"

        ' '' ''strScript += "self.opener.document.getElementById('MainContent_Button1').click();"
        '' '' '' ''   If (Request.QueryString("Mode") = "MODIFY") Then
        ...
        strScript += "GetRadWindow().BrowserWindow.MainContent_ISRefreskClick.value ='N';"
        ...
        If (Not ButtonType = "Reset") Then
            ...
            End If
        End If
        strScript += "GetRadWindow().BrowserWindow.MainContent_HDay" & Request.QueryString("DayRef") & ".value='" & DayValue & Ucomments & Time & "';"
