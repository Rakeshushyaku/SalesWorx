<%@ Page Title="Assign Bonus Plan To Customer" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master"
    CodeBehind="AssignBonusPlanToCustomers.aspx.vb" Inherits="SalesWorx_BO.AssignBonusPlanToCustomers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function CheckAll(cbSelectAll) {
            debugger;
            TargetBaseControl =   document.getElementById('<%= Me.ClassUpdatePnl.ClientID %>');
         ...
         function CheckAll2(cbSelectAll) {
             debugger;
               TargetBaseControl2=   document.getElementById('<%= Me.UpdatePanelCustomerAssign.ClientID %>');
            if (TargetBaseControl2 == null) return false;
            var TargetChildControl2 = "chkDelete";
          <%--  var TimeCon = document.getElementById('<%= Me.ClassUpdatePnl.ClientID %>');--%>

            var Inputs = TargetBaseControl2.getElementsByTagName("input");

            for (var n = 0; n < Inputs.length; ++n)
                if (Inputs[n].type == 'checkbox' && Inputs[n].id.indexOf(TargetChildControl2, 0) >= 0) {
                Inputs[n].checked = cbSelectAll.checked;
            }
 ...
 <asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h4>Assign Bonus Plan To Customers</h4>
           ...
           <%-- <p id="pagenote">This screen may be used to assign bonus plan to customers</p>--%>
            ...
            <div class="row">
                <div class="col-sm-3">
                          ...
                          <%--   <telerik:RadComboBox ID="ddl_Customer" Skin="Simple"   runat="server" Filter="Contains"  EmptyMessage="Please type Customer No./Name" EnableLoadOnDemand="True" Width="100%"  AutoPostBack="true" />--%>
                ...
                <div class="col-sm-3">
                  ...
                  <div class="col-sm-3">
                                   <div class="form-group">
                                   <label>Filter By Customer</label>
                              <telerik:RadTextBox runat ="server" ID="txtFilterCAssign" EmptyMessage ="Please type Customer No./Name/Channel " Skin ="Simple"  Width ="100%"   ></telerik:RadTextBox>
                          <%--   <telerik:RadComboBox ID="ddl_Customer" Skin="Simple"   runat="server" Filter="Contains"  EmptyMessage="Please type Customer No./Name" EnableLoadOnDemand="True" Width="100%"  AutoPostBack="true" />--%>
                ...
                <div class="col-sm-3">
                                   <div class="form-group">  
                                          <label><span style ="visibility:hidden;"> 1</span></label>              
                                    <asp:Button ID="btnFilterCAssigned" runat="server" Text="Filter" CssClass ="btn btn-primary"  />
                                                                   <asp:Button  ID="btnResetCAssigned" runat="server" Text="Reset"  CssClass ="btn btn-danger" />
                                      
                               </div> 
                    </div>         
                   </div>           
                               <table  border="0" cellspacing="0" cellpadding="0"  width="100%" class="custm-table">
                            <tr>
                                <td width="100%">
              ...
              ToolTip ="Click here to download the log" runat ="server"
               Text ="View Log" Visible="false" ></asp:LinkButton>
                                        ...
                                        <tr>
                                            <td width="48%" style="border:1px solid #000000">
                                               
                                                 <%--<telerik:RadListBox ID="lstDefault"  AutoPostBack ="false"   runat ="server"   Width="100%" Height ="340px"   SelectionMode ="Multiple"   > </telerik:RadListBox>--%>
                                               <div class="table-responsive">
       <asp:UpdatePanel ID="ClassUpdatePnl" runat="server" UpdateMode="conditional">
                                <ContentTemplate>
                                 
                                                <asp:GridView Width="100%" ID="gvCustumerAvail" runat="server" EmptyDataText="No Customer to Display"
                                                    EmptyDataRowStyle-Font-Bold="true"  AutoGenerateColumns="False" Height ="10"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="CustAvailSiteID" Text ='<%#Eval("CustSiteID") %>'  runat="server" Visible ="false" ></asp:Label>
                                                            </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="Left" Width="100px" CssClass="display-block"  />
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="Customer_No" HeaderText="Customer No." SortExpression="Currency_Code">
                                                            <ItemStyle Wrap="False" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="Customer_Name" HeaderText="Customer Name" SortExpression="Description">
                                                            <ItemStyle Wrap="False" />
                                                        </asp:BoundField>
                                                       <asp:BoundField DataField="CustSiteID" HeaderText="Customer Name" SortExpression="Description" Visible ="false" >
                                                            <ItemStyle Wrap="False" />
                                                        </asp:BoundField>
                                                    </Columns>
                                             ...
                                             <td width="48%" style="border:1px solid #000000;">
                                                ...
                                                <%--<telerik:RadListBox ID="lstSelected"  AutoPostBack ="false" runat ="server" Width="100%"   Height ="340px"  SelectionMode ="Multiple"     >   </telerik:RadListBox>--%>
                                                    <div class="table-responsive">
       <asp:UpdatePanel ID="UpdatePanelCustomerAssign" runat="server" UpdateMode="conditional">
                                <ContentTemplate>
                                 
                                                <asp:GridView Width="100%" ID="gvCustumerAssign" runat="server" EmptyDataText="No Customer to Display"
                                                    EmptyDataRowStyle-Font-Bold="true"  AutoGenerateColumns="False"  Height ="10" 
                                                    AllowPaging="True" AllowSorting="true"  PageSize="15" CellPadding="0" CellSpacing="0" CssClass="tablecellalign">
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                                <asp:CheckBox ID="cbSelectAll" onclick="CheckAll2(this)" ToolTip="Select/Unselect All"
                                                                    runat="server" />
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="chkDelete" runat="server"  CssClass="checkboxvalign" />
                                                                 <asp:Label ID="CustAssignedSiteID" Text ='<%#Eval("CustSiteID") %>'  runat="server" Visible ="false" ></asp:Label>
                                                            </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="Left" Width="100px" CssClass="display-block"  />
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="Customer_No" HeaderText="Customer No." SortExpression="Currency_Code">
