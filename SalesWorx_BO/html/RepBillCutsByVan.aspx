<%@ Page Title="Bill Cuts By Van" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="RepBillCutsByVan.aspx.vb" Inherits="SalesWorx_BO.RepBillCutsByVan" %>
    ...
    <telerik:RadAjaxPanel ID="l" runat="server">
        ...
        <div id="rpt" runat="server"  style="padding-top: 5px">
            ...
            <div class="row" id="MainContent_summary">
                <div class="col-sm-4 col-md-3 col-lg-2-1">
                    <div class="widgetblk widgetblkinsmall">
                       Overall Unique Outlets <div class="text-primary">
                ...
                <div class="col-sm-4 col-md-3 col-lg-2-1">
                    <div class="widgetblk widgetblkinsmall">
                       Overall Billed Outlets<div class="text-primary">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <h5>To Date <strong><span class="text-blue"><asp:Label runat="server" ID="lbl_ToSelDate"></asp:Label></span></strong></h5>
                </div>
           ...
           ReloadOnShow="true"  VisibleStatusbar="false" Height ="515px" BorderColor ="Black"  Width ="700px"  skin="Windows7"  >
               <ContentTemplate>
                           <telerik:RadAjaxPanel runat="server" ID="RadAjaxPanel1">
                            ...
                            <telerik:RadGrid ID="gvVans" AllowSorting="True" AutoGenerateColumns="False" Skin="Simple" Width="100%" BorderColor="LightGray"
                                ...
                                <MasterTableView AutoGenerateColumns="false" TableLayout="Auto" ShowFooter="true" AllowFilteringByColumn="true"
                                    ...
                                    <Columns>
                                         ...
                                         <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Van" HeaderText="Van/FSR" AutoPostBackOnFilter ="true" 
                            SortExpression="Van"  Aggregate ="Count" FooterText ="Total Vans/FSR : "  AllowFiltering ="true" ShowFilterIcon ="false"
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign ="Left"  />
                                 ...
                                 <FooterStyle HorizontalAlign="Left" Font-Bold="true" BackColor="#eff9ff" ForeColor="#000" Font-Size="15px" />
                                           ...
                                           <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Right" DataField="TotCustAssigned" HeaderText="Outlets Assigned"
                                            SortExpression="TotCustAssigned"  AllowFiltering="false">
                                ...
                                <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Right" DataField="TotCustPlanned" HeaderText="Outlets Planned"
                                         ...
                                         <telerik:GridTemplateColumn UniqueName="TotBilled" AllowFiltering="false" DataField ="TotBilled"
                                                    InitializeTemplatesFirst="false" HeaderText="Outlets Billed" SortExpression ="TotBilled">
                                      ...
                                      <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Right" DataField="BillPercentage" HeaderText="Bill Cuts %"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SWXConnectionString %>"
                            SelectCommand="Rep_BillCutByVan" SelectCommandType="StoredProcedure">
