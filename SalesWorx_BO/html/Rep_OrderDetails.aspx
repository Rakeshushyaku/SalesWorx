...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="l" runat="server">
            ...
            <asp:HiddenField ID="HOrderType" runat="server" />
            ...
            <telerik:RadMultiPage ID="RadMultiPage21" runat="server" SelectedIndex="0">
                <telerik:RadPageView ID="RadPageView1" runat="server">
                    <div class="p-l-15 p-r-15 p-t-15">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label><strong>Credit Customer</strong> </label>
                                    <asp:Label ID="lbl_creditCustomername" runat="server" Text=""></asp:Label>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <label><strong>CC Name & Tel No.</strong> </label>
                        ...
                        <table class="table text-right">
                            <tr id="discountRow" runat="server">
                                <td>
                                    <asp:Label ID="lbl_DiscountHead" runat="server" Text="Discount Amount" Font-Bold="true"></asp:Label></td>
                                <td width="95px">
                                    <asp:Label ID="lbl_discount" runat="server" Text="" Font-Bold="true"></asp:Label></td>
                                <td width="95px">&nbsp;</td>
                                <td width="95px">&nbsp;</td>
                                <td width="95px">&nbsp;</td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="lbl_NetHead" runat="server" Text="Net Amount" Font-Bold="true"></asp:Label></td>
                                <td>
                                    <asp:Label ID="lbl_Net" runat="server" Text="" Font-Bold="true"></asp:Label></td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="lbl_VATHead" runat="server" Text="VAT Amount" Font-Bold="true"></asp:Label></td>
                                <td>
                                    <asp:Label ID="lbl_vatAmount" runat="server" Text="" Font-Bold="true"></asp:Label></td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="lbl_TotalHead" runat="server" Text="Total" Font-Bold="true"></asp:Label></td>
                                <td>
                                    <asp:Label ID="lbl_total" runat="server" Text="" Font-Bold="true"></asp:Label></td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
                ...
                <telerik:RadPageView ID="RadPageView2" runat="server">
                    <div class="p-l-15 p-r-15 p-t-15">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label><strong>Shipping Instruction</strong> </label>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label><strong>Signed By</strong> </label>
                ...
                <telerik:RadPageView ID="RadPageView3" runat="server">
                    <div class="p-l-15 p-r-15 p-t-15">
                        ...
                        <asp:DataList ID="ImgList"  runat="server" CellSpacing="3" RepeatLayout="Table" CssClass="hidebr table">
                        ...
                        <td>
                            ...
                            <asp:HiddenField ID="HThumbNail" Value='<%#Eval("Attrib_value_2")%>' runat="server" />
                        </td>
                    </tr>--%>
                                    <tr>
                                        <td style="vertical-align: middle; text-align: center; padding: 0 !important; border: 0;">
                                            <asp:HiddenField ID="HfileTYpe" runat="server" Value='<%#Eval("Attrib_value_2")%>'></asp:HiddenField>
                                            <p>
                                                <a href="javascript:OpenDialog('<%#Eval("SRC") %>')">
                                            ...
                                            <%--  </td>
                                        <td style="vertical-align: middle; text-align: center; padding: 0 !important; border: 0;">
                                              <asp:HiddenField ID="HiddenField1" runat="server" Value='<%#Eval("Attrib_value_2")%>'></asp:HiddenField>--%>
                        ...
                        <asp:DataList ID="PdfList"  runat="server" CellSpacing="3" RepeatLayout="Table" CssClass="hidebr table">
                            ...
                            <asp:HiddenField ID="HThumbNail" Value='<%#Eval("Attrib_value_2")%>' runat="server" />
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle; text-align: center; padding: 0 !important; border: 0;">
                                            ...
                                            <p>
                                                <a href="javascript:OpenDialog('<%#Eval("SRC") %>')">
                                                    <asp:HyperLink ID="hlp" runat="server" NavigateUrl='<%#Eval("SRC")%>' Target="_blank" Text="View"></asp:HyperLink>
