<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="RepCollectionListing.aspx.vb" Inherits="SalesWorx_BO.RepCollectionListing" %>
                                                        ...
                                                        <Columns>
                                                         <telerik:GridTemplateColumn uniqueName="Collection_Ref_No"  HeaderStyle-HorizontalAlign="Left"    HeaderStyle-Wrap="false" DataField="Collection_Ref_No" SortExpression ="Collection_Ref_No"
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Image ImageUrl="~/images/cheque.png" Visible='<%# Bind("Chequeimageshow")%>' runat="server" ID="imgcheque" />
                                                            </ItemTemplate>
