...
Partial Public Class Rep_RevenueDispersion
    ...
    Private ReportPath As String = "RevenueDispersion"

    Private Const PageID As String = "P109"
    ...
    Sub Export(format As String)
        ...
        If format = "PDF" Then
            ...
            Response.AddHeader("Content-disposition", "attachment;filename=RevenueDispersion.pdf")
            Response.AddHeader("Content-Length", bytes.Length)
        ElseIf format = "Excel" Then
            Response.ContentType = "application/excel"
            Response.AddHeader("Content-disposition", "filename=RevenueDispersion.xls")
            Response.AddHeader("Content-Length", bytes.Length)
        End If
    ...
    Sub BindReport()
        ...
        dt = objRep.GetRevenueDispersion(Err_No, Err_Desc, ddlOrganization.SelectedValue, hVan.Value, CType(Session.Item("USER_ACCESS"), UserAccess).UserID, CDate(txtFromDate.SelectedDate))
        gvRep.DataSource = dt
        gvRep.DataBind()
    End Sub
