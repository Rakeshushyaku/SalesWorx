<%@ Page Title="Daily Coverage Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="Rep_DailyCoverageReport.aspx.vb" Inherits="SalesWorx_BO.Rep_DailyCoverageReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Daily Covergae Report</span></div>
...
<table  border="0" cellspacing="2" cellpadding="2" >
          <tr>
           ...
           <%-- <asp:DropDownList CssClass="inputSM" ID="ddlVan"   Width ="150px"
                 ...
                 <telerik:RadComboBox Filter="Contains" Skin="Simple" EnableCheckAllItemsCheckBox="true"
                                                    CheckBoxes="true" EmptyMessage="Select a van" ID="ddlVan" Width="200px" runat="server">
                                                </telerik:RadComboBox>
                &nbsp;
