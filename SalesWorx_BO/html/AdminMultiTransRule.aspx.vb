...
Public Class AdminMultiTransRule
    ...
    Private Const PageID As String = "P371"
    ...
    Private Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        Try
            ...
            If Me.ddl_Org.SelectedIndex > 0 Then
                ...
                dtOriginal = objProduct.ExportMultiTransRule(Err_No, Err_Desc, ddl_Org.SelectedItem.Value)
                ...
                dtTemp.Columns.Add("PromoItemCode")
                dtTemp.Columns.Add("PromoQty")
                ...
                If dtTemp.Rows.Count > 0 Then
                    ...
                    Dim fn As String = "MutliTransBonusRules" + Now.ToString("ddMMMyyHHmmss") + ".xls"
                ...
                Try
                    ...
                    If ViewState("FileType") IsNot Nothing And ViewState("FileName") IsNot Nothing Then
                        ...
                        If TempTbl.Columns.Count = 7 Then
                            If Not (TempTbl.Columns(0).ColumnName.ToLower = "salesitemcode" And TempTbl.Columns(1).ColumnName.ToLower = "salesqty" And TempTbl.Columns(2).ColumnName.ToLower = "promoitemcode" And TempTbl.Columns(3).ColumnName.ToLower = "promoqty" And TempTbl.Columns(4).ColumnName.ToLower = "validfrom" And TempTbl.Columns(5).ColumnName.ToLower = "validto" And TempTbl.Columns(6).ColumnName.ToLower = "isactive") Then
                                Me.lblUpMsg.Text = "Please check the template columns are correct"
                                Me.MPEImport.VisibleOnPageLoad = True
                                Exit Sub
                            End If
                        ElseIf TempTbl.Columns.Count = 8 Then
                            If Not (TempTbl.Columns(0).ColumnName.ToLower = "salesitemcode" And TempTbl.Columns(1).ColumnName.ToLower = "salesqty" And TempTbl.Columns(2).ColumnName.ToLower = "promoitemcode" And TempTbl.Columns(3).ColumnName.ToLower = "promoqty" And TempTbl.Columns(4).ColumnName.ToLower = "validfrom" And TempTbl.Columns(5).ColumnName.ToLower = "validto" And TempTbl.Columns(6).ColumnName.ToLower = "isactive" And TempTbl.Columns(7).ColumnName.ToLower = "transaction_type") Then
                                Me.lblUpMsg.Text = "Please check the template columns are correct"
                                Me.MPEImport.VisibleOnPageLoad = True
                                Exit Sub
                            End If
                        ...
                        If TempTbl.Rows.Count > 0 Then
                            ...
                            For idx = 0 To TempTbl.Rows.Count - 1
                                ...
                                Dim TransType As String = "0"
                                If TempTbl.Columns.Count = 8 Then
                                    TransType = IIf(TempTbl.Rows(idx)(6) Is DBNull.Value, "Y", TempTbl.Rows(idx)(7).ToString())
                                End If
                                ...
                                If isValidRow = True Then
                                    If objProduct.CheckMultiTransRuleExists(Err_No, Err_Desc, "0", RedItem, ddl_Org.SelectedValue, FromDate, ToDate, TransType) = True Then
                                        RowNo = idx + 2
                                ...
                                Else
                                    ...
                                    If objProduct.SaveMultiTransRule(Err_No, Err_Desc, ddl_Org.SelectedItem.Value, RedItem, RedQty, GivenItem, GivenQty, ISActive, CType(Session.Item("USER_ACCESS"), UserAccess).UserID, FromDate, ToDate, RuleID, TransType) = True Then
                    ...
                    Session.Remove("dtMultiRules")
                    Session("dtMultiRules") = dtErrors.Copy


                    Dim fn As String = System.Configuration.ConfigurationManager.AppSettings("ExcelPath") & "UploadLog\" & "MultiTransLog_" & Now.ToString("yyyyMMdd") + ".txt"
                    DataTable2CSV(dtErrors, fn, vbTab)
                    If dtErrors.Rows.Count > 0 Then
                        lbLog.Visible = True
                    End If
                    Session.Remove("MultiTransLogInfo")
                    Session("MultiTransLogInfo") = fn
    ...
    Protected Sub lbLog_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbLog.Click
        Try
            ...
            If Not Session("MultiTransLogInfo") Is Nothing Then
                Dim fileValue As String = Session("MultiTransLogInfo")
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If String.IsNullOrEmpty(Me.ddlGivenItem.SelectedValue) Then
            lblmsgPopUp.Text = "Please select the promo item"
            MPEAdd.VisibleOnPageLoad = True
            Return
        End If
        ...
        If String.IsNullOrEmpty(txtGivenQty.Text) Or txtGivenQty.Text = "0" Then
            lblmsgPopUp.Text = "Please enter the promo quantity"
            MPEAdd.VisibleOnPageLoad = True
            Return
        End If
        If IsNumeric(txtRedQty.Text) = False Or IsNumeric(txtGivenQty.Text) = False Then
            lblmsgPopUp.Text = "Sales and promo qty should be in number"
        ...
        End If
        If objProduct.CheckMultiTransRuleExists(Err_No, Err_Desc, "0", ddlRedItem.SelectedValue, ddl_Org.SelectedValue, Me.StartTime.SelectedDate.Value, Me.EndTime.SelectedDate.Value, ddl_transactionType.SelectedItem.Value) Then
        ...
        Try
            ...
            Dim RuleID As String = "0"
            If objProduct.SaveMultiTransRule(Err_No, Err_Desc, ddl_Org.SelectedItem.Value, ddlRedItem.SelectedValue, txtRedQty.Text, ddlGivenItem.SelectedValue, txtGivenQty.Text, IIf(rsActive.Checked = True, "Y", "N"), CType(Session("User_Access"), UserAccess).UserID, Me.StartTime.SelectedDate.Value, Me.EndTime.SelectedDate.Value, RuleID, ddl_transactionType.SelectedItem.Value) = True Then
                ...
                objProduct.SaveMultiTrxCategoryMap(Err_No, Err_Desc, RuleID, dtCategory, CType(Session("User_Access"), UserAccess).UserID)
                success = True
    ...
    Protected Sub gvRules_ItemCommand(sender As Object, e As GridCommandEventArgs) Handles gvRules.ItemCommand
        ...
        Try
            If e.CommandName = "DeleteSelected" Then
                ...
                If objProduct.DeleteMultiTransRule(Err_No, Err_Desc, RuleID.Text) Then
        ...
        Catch ex As Exception
            Err_No = "64224"
            log.Error(Err_Desc)
            Response.Redirect("information.aspx?mode=1&errno=" & Err_No & "&msg=" & AppMsgHandler.GetErrorMessage("PHX_006") & "&next=AdminMultiTransRule.aspx&Title=Message", False)
            If Err_Desc Is Nothing Then
                log.Error(GetExceptionInfo(ex))
            Else
                log.Error(Err_Desc)
    ...
    Protected Sub btnEdit_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            Dim lblTransaction_Type As Label = DirectCast(item.FindControl("lblTransaction_Type"), Label)
            ...
            LoadCategory()
            If Not ddl_transactionType.FindItemByValue(lblTransaction_Type.Text) Is Nothing Then
                ddl_transactionType.FindItemByValue(lblTransaction_Type.Text).Selected = True
            End If



            Dim dtCategory As New DataTable
            dtCategory = objProduct.GetMultTrxCategoryMap(Err_No, Err_Desc, RuleID.Text)
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        End If
        If objProduct.CheckMultiTransRuleExists(Err_No, Err_Desc, Me.lblRule.Value, ddlRedItem.SelectedValue, ddl_Org.SelectedValue, Me.StartTime.SelectedDate.Value, Me.EndTime.SelectedDate.Value, ddl_transactionType.SelectedItem.Value) Then
            lblmsgPopUp.Text = "Same rule already exists with the specified date range"
            Me.MPEAdd.VisibleOnPageLoad = True
            Return
        End If
        ...
        Try
            ...
            If objProduct.UpdateMultiTransRule(Me.lblRule.Value, Me.txtRedQty.Text, Me.txtGivenQty.Text, IIf(Me.rsActive.Checked = True, "Y", "N"), CType(Session("User_Access"), UserAccess).UserID, Err_No, Err_Desc, StartTime.SelectedDate.Value, EndTime.SelectedDate.Value, ddl_transactionType.SelectedItem.Value) = True Then
                Dim dtCategory As New DataTable
                dtCategory.Columns.Add("Category")
                For Each item As RadComboBoxItem In ddl_Category.CheckedItems
                    Dim dr As DataRow
                ...
                objProduct.SaveMultiTrxCategoryMap(Err_No, Err_Desc, Me.lblRule.Value, dtCategory, CType(Session("User_Access"), UserAccess).UserID)
                success = True
                MessageBoxValidation("Successfully Saved.", "Information")
                gvRules.Rebind()
                MPEAdd.VisibleOnPageLoad = False
    ...
    Private Sub btndownloadTemp_Click(sender As Object, e As EventArgs) Handles btndownloadTemp.Click
        Dim Filename As String = System.Configuration.ConfigurationManager.AppSettings("ExcelTemplatePath") & "MultiTransaction.xls"
