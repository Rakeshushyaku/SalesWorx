<%@ Page Title="Redemption Rules" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="AdminRedemptionRule.aspx.vb" Inherits="SalesWorx_BO.AdminRedemptionRule" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        ...
        <contenttemplate>
                        ...
                        <asp:Button ID="btnAdd" runat="server" CausesValidation="false"  CssClass="btn btn-success"
                                          ...
                                          <telerik:RadWindow ID="MPEImport" Title= "Import Redemption Rules" runat="server" Skin="Windows7" Behaviors="Move,Close"
    ...
    <asp:UpdatePanel ID="Panel" runat="server" UpdateMode="Conditional">
        ...
        <contenttemplate>
                               ...
                               <telerik:RadWindow ID="MPEAdd" Title= "Add/Modify Redemption Rules" runat="server" Skin="Windows7" Behaviors="Move,Close"
                     ...
                     <asp:UpdatePanel ID="UpdatePanel2" runat="server" >
                         <ContentTemplate>
                              ...
                              <asp:HiddenField ID="lblRule" runat="server" Value="-1" />
                                        ...
                                        <div class="row">
		                                    <div class="col-sm-4">
			                                    <label>Return Item<em><span>&nbsp;</span>*</em> </label>
		                                    </div>
		                                    <div class="col-sm-7">
			                                    <div class="form-group">
                                                    <telerik:RadComboBox  Skin ="Simple" ID="ddlRedItem" EnableLoadOnDemand="true"  EmptyMessage ="Please enter Return Product code/Name"
                                            ...
                                            <div class="row">
		                                    <div class="col-sm-4">
			                                    <label>Return Qty<em><span>&nbsp;</span>*</em> </label>
		                                    </div>
		                                    <div class="col-sm-7">
			                                    <div class="form-group">
		                                    ...
		                                    <div class="col-sm-7">
			                                    <div class="form-group">
                                                    <telerik:RadComboBox Skin ="Simple" ID="ddlGivenItem"   Height ="100px"
                                                        EnableLoadOnDemand="true"  EmptyMessage ="Please enter Sales Product code/Name"
       ...
       <telerik:GridTemplateColumn UniqueName="DeleteColumn" Visible ="false"   AllowFiltering ="false"   
           ...
           <HeaderStyle  />
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                         ...
                                         <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="RedItem" HeaderText="Return Item" AutoPostBackOnFilter ="true" 
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign ="Left"  />
                                 ...
                                 <FooterStyle HorizontalAlign="Left" Font-Bold="true" BackColor="#eff9ff" ForeColor="#000" Font-Size="15px" />
                                           ...
                                           <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Center" DataField="RedQty" HeaderText="Return Qty"
                                         ...
                                         <ItemStyle Wrap="False" HorizontalAlign ="Right"  />
                                            ...
                                            <FooterStyle HorizontalAlign="right" Font-Bold="true" BackColor="#eff9ff" ForeColor="#000" Font-Size="15px" />
                                                 ...
                                                 <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="GivenItem" HeaderText="Sales Item" AutoPostBackOnFilter ="true" 
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign ="Left"  />
                                 ...
                                 <FooterStyle HorizontalAlign="Left" Font-Bold="true" BackColor="#eff9ff" ForeColor="#000" Font-Size="15px" />
                                           ...
                                           <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Center" DataField="GivenQty" HeaderText="Sales Qty"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SWXConnectionString %>"
                            SelectCommand="app_LoadRedemptionRules" SelectCommandType="StoredProcedure">
