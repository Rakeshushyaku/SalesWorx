<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="Rep_StockNotes.aspx.vb" Inherits="SalesWorx_BO.Rep_StockNotes" %>
                ...
                <MasterTableView AutoGenerateColumns="false" TableLayout="Auto" Width="100%" GridLines="None" BorderColor="LightGray"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn UniqueName="Orig_Sys_Document_Ref" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Wrap="false" DataField="Orig_Sys_Document_Ref" SortExpression="Orig_Sys_Document_Ref"
                         ...
                         <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="DocTittle" HeaderText="Doc Type"
                            SortExpression="DocTittle">
                            <ItemStyle Wrap="True" />
                        ...
                        <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Amount" HeaderText="Amount"
                            SortExpression="Transaction_Amt" DataType="System.Double" DataFormatString="{0:N2}">
