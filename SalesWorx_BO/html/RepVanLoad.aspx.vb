...
Partial Public Class RepVanLoad
    ...
    Private ReportPath As String = "VanLoadReport"

    Private Const PageID As String = "P234"
    ...
    Private Sub Export(Format As String)
        Try
            ...
            If Format = "PDF" Then
                ...
                Response.AddHeader("Content-disposition", "attachment;filename=VanLoad.pdf")
                Response.AddHeader("Content-Length", bytes.Length)
            ElseIf Format = "Excel" Then
                Response.ContentType = "application/excel"
                Response.AddHeader("Content-disposition", "filename=VanLoad.xls")
                Response.AddHeader("Content-Length", bytes.Length)
            End If
    ...
    Private Sub BindReport()
        Try
            ...
            dt = ObjReport.GetVanload(Err_No, Err_Desc, ddlOrganization.SelectedItem.Value, van, item, CDate(txtFromDate.SelectedDate).ToString("dd-MMM-yyyy"), CDate(txtToDate.SelectedDate).ToString("dd-MMM-yyyy"))
            gvRep.DataSource = dt
            gvRep.DataBind()
