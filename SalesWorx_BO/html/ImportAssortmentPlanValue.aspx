<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="ImportAssortmentPlanValue.aspx.vb" Inherits="SalesWorx_BO.ImportAssortmentPlanValue" %>
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <asp:Label ID="lblPlanName"  runat ="server" cssClass="text-primary"></asp:Label> 
                                                         <asp:Label ID="lblTransType" Visible ="false" runat ="server" ></asp:Label>   
                                                    </div>
                                                </div>
                                            </div>
                <div class="row">
                            ...
                            <asp:UpdatePanel ID="Panel" runat="server" UpdateMode="Conditional" >
                             <Triggers>
                                ...
                                <ContentTemplate>
                                                    ...
                                                    <telerik:RadWindow ID="MPEImport" Title= "Import Assortment Plan" runat="server" Skin="Windows7" Behaviors="Move,Close"
