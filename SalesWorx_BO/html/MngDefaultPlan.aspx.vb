...
Partial Public Class MngDefaultPlan
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (FromPopUp.Value = "Y" And Not ISRefreskClick.Value = "Y") Then
            ...
            Me.StartTime.SelectedDate = Session("Start_Date")
            Start_Date.SelectedDate = Session("Start_Date")
            End_Date.SelectedDate = Session("End_Date")
            ...
            StartDate = Start_Date.SelectedDate
            EndDate = End_Date.SelectedDate
        ...
        If Action_Mode.Value = "ADD" Or Action_Mode.Value = "SAVE" Then
            ...
            Dim seldate As Date
            seldate = CDate(Me.StartTime.SelectedDate)
            Dim Sdate As String
            Sdate = DateAdd(DateInterval.Day, -1 * (seldate.Day - 1), seldate).ToString("MM-dd-yyyy")
            Dim Edate As String
            Edate = DateAdd(DateInterval.Day, -1, DateAdd(DateInterval.Month, 1, CDate(Sdate))).ToString("MM-dd-yyyy")
            Start_Date.SelectedDate = Sdate
            End_Date.SelectedDate = LastDayOfMonth(Sdate)
        ...
        ElseIf Action_Mode.Value = "MODIFY" Or Action_Mode.Value = "UPDATE" Then
            ...
            Try
                ...
                If (Err_Desc Is Nothing) Then
                    ...
                    Me.StartTime.SelectedDate = ObjRoutePlan.SDate
                    Start_Date.SelectedDate = ObjRoutePlan.SDate
                    End_Date.SelectedDate = ObjRoutePlan.EDate
                    ...
                    If (Err_Desc Is Nothing) Then
                        ...
                        If (CalDataSet.Tables("DefaultPlan").Rows.Count() > 0) Then
                            ...
                            CalPanel.Visible = True
                            Session("Start_Date") = Start_Date.SelectedDate
                            Session("End_Date") = End_Date.SelectedDate
                            DefPlanCalendar.VisibleDate = CDate(StartDate)
                            Action_Mode.Value = "MODIFY"
                        End If
                    End If
    ...
    Private Sub SaveBtn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SaveBtn.Click
        ...
        Try
            ...
            If (CalPanel.Visible = True) Then
                Dim SDate As String = Start_Date.SelectedDate
                Dim EDate As String = End_Date.SelectedDate
            ...
            Else
                MessageBoxValidation("Please click the Show/Refresh Calender to define default plan and Click on save", "Validation")
            End If
        Catch ex As Exception
            If Err_No = 0 Then
                Err_No = "74010"
                ...
                If Action_Mode.Value = "ADD" Then
                    ...
                    If (EndDate.Day >= e.Day.Date.Day And e.Day.Date.Day >= StartDate.Day And e.Day.Date.Month = StartDate.Month And e.Day.Date.Month = EndDate.Month) Then
                        ...
                        If IsWeekEnd = False Then
                            If IsOffDay(e.Day.Date) Then
                                e.Cell.BackColor = System.Drawing.Color.FromName("#ffffdd")
                                Dtype = "W"
                            End If
                        End If
                        If e.Cell.BackColor = System.Drawing.Color.FromName("#EEEEEE") And (IsOffDay(e.Day.Date)) Then
                            Dtype = "M"
                        End If
                        If e.Cell.BackColor = System.Drawing.Color.FromName("#ffffdd") And (IsOffDay(e.Day.Date)) Then
                            Dtype = "W"
                        End If
                        ...
                        If e.Day.Date > Now.Date Then
                            e.Cell.Style.Add("cursor", "Pointer")
                            CalendarCell.Attributes.Add("OnClick", "javascript:onClick=OpenWindow('POP_DefaultPlan.aspx?button=" & UpdateCal.FindControl("Button1").ClientID & "&IRS=N&IsRefresh=N&dayref=" & e.Day.Date.Day & "&DType=" & Dtype & "')")
                        Else

                            e.Cell.Style.Add("cursor", "Cursor")
                        End If
                        ''e.Cell.Style.Add("cursor", "Pointer")
                        '' CalendarCell.Attributes.Add("OnClick", "javascript:onClick=window.open('POP_DefaultPlan.aspx?button=" & UpdateCal.FindControl("Button1").ClientID & "&IRS=N&IsRefresh=N&dayref=" & e.Day.Date.Day & "&DType=" & Dtype & "','CustomerList','width=450,height=300')")


                        Dim HiddenCon As System.Web.UI.HtmlControls.HtmlInputHidden = TryCast(Page.FindControl("ctl00$MainContent$HDay" & e.Day.Date.Day.ToString()), System.Web.UI.HtmlControls.HtmlInputHidden)
            ...
            If (Action_Mode.Value = "MODIFY") Then
                ...
                If (EndDate.Day >= e.Day.Date.Day And e.Day.Date.Day >= StartDate.Day And e.Day.Date.Month = StartDate.Month And e.Day.Date.Month = EndDate.Month) Then
                    ...
                    If e.Day.Date > Now.Date Then
                        ...
                        CalendarCell.Attributes.Add("OnClick", "javascript:onClick=OpenWindow('POP_DefaultPlan.aspx?Mode=MODIFY&IRS=N&IsRefresh=N&dayref=" & e.Day.Date.Day & "&DType=" & Dtype & "')")
                    Else
                        e.Cell.Style.Add("cursor", "Cursor")
                    End If
                    ...
                    Dim CellUrl As String
                    Dim CellBgColor As String = "#ffffdd"
                    If (HDay1.Value <> "" And e.Day.Date.Day.ToString() = "1") Then
                        CellText = SetText(e.Day.Date.Day & "-" & e.Day.Date.Month & "-" & e.Day.Date.Year, HDay1.Value)
                    ...
                    ''e.Cell.Style.Add("cursor", "Pointer")
                    '' ''CalendarCell.Attributes.Add("OnClick", "javascript:onClick=window.open('POP_DefaultPlan.aspx?Mode=MODIFY&IRS=N&IsRefresh=N&dayref=" & e.Day.Date.Day & "&DType=" & Dtype & "','CustomerList','width=450,height=300')")
    ...
    Protected Sub ShowAndRefreshBtn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles ShowAndRefreshBtn.Click
        ...
        Try
            ...
            If (Not StartDate > EndDate And StartDate.Month = EndDate.Month) Then
                ...
                End If
            Else
                MessageBoxValidation("You can not create default plan for a past date", "Validation")
            End If
            'Else
        ...
        End Try
    End Sub
    Function FutureDate() As Boolean
        Dim bretval As Boolean = True
        Dim seldate As String
        seldate = "01-" & CDate(StartTime.SelectedDate).ToString("MMM-yyyy")
        Dim curdate As String
        curdate = "01-" & Now.ToString("MMM-yyyy")
        If CDate(seldate) < CDate(curdate) Then
            bretval = False
        End If
        Return bretval
    End Function
        ...
        If Action_Mode.Value = "MODIFY" Or Action_Mode.Value = "UPDATE" Then
            ...
            Try
                ...
                If (Err_Desc Is Nothing) Then
                    ...
                    Description.Text = ObjRoutePlan.Description
                    Dim TemSDate As Date = ObjRoutePlan.SDate
                    '' Start_Date.SelectedDate = IIf(CInt(TemSDate.Day) < 10, "0" & TemSDate.Day, TemSDate.Day) & "-" & IIf(CInt(TemSDate.Month) < 10, "0" & TemSDate.Month, TemSDate.Month) & "-" & TemSDate.Year
                    Start_Date.SelectedDate = TemSDate
                    Dim TemEDate As Date = ObjRoutePlan.EDate
                    ''  End_Date.SelectedDate = IIf(CInt(TemEDate.Day) < 10, "0" & TemEDate.Day, TemEDate.Day) & "-" & IIf(CInt(TemEDate.Month) < 10, "0" & TemEDate.Month, TemEDate.Month) & "-" & TemEDate.Year
                    End_Date.SelectedDate = TemEDate
    ...
    Protected Sub StartTime_SelectedDateChanged(sender As Object, e As Telerik.Web.UI.Calendar.SelectedDateChangedEventArgs) Handles StartTime.SelectedDateChanged
        ...
        'If Me.StartTime.SelectedDate.Value.Month = 1 Or Me.StartTime.SelectedDate.Value.Month = 3 Or Me.StartTime.SelectedDate.Value.Month = 5 Or Me.StartTime.SelectedDate.Value.Month = 7 Or Me.StartTime.SelectedDate.Value.Month = 8 Or Me.StartTime.SelectedDate.Value.Month = 10 Or StartTime.SelectedDate.Value.Month = 12 Then
        ...
        'End If
        'If Me.StartTime.SelectedDate.Value.Month = 4 Or Me.StartTime.SelectedDate.Value.Month = 6 Or Me.StartTime.SelectedDate.Value.Month = 11 Then
        '    Sdate = DateTime.Parse(Me.StartTime.SelectedDate.Value.Month.ToString() + "-01-" + Me.StartTime.SelectedDate.Value.Year.ToString()).ToString("MM-dd-yyyy")
        ...
        'End If
        'If Me.StartTime.SelectedDate.Value.Month = 2 Then
        '    Sdate = DateTime.Parse(Me.StartTime.SelectedDate.Value.Month.ToString() + "-01-" + Me.StartTime.SelectedDate.Value.Year.ToString()).ToString("MM-dd-yyyy")
        '    If Me.StartTime.SelectedDate.Value.Year Mod 4 = 0 Then
