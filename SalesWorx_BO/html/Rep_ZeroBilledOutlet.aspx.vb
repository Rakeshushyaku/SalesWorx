...
Imports System.Linq
Public Class Rep_ZeroBilledOutlet
    ...
    Private ReportPath As String = "ZeroBillerOutlets"
    Private Const PageID As String = "P357"
    ...
    Sub Export(format As String)
        ...
        rview.ServerReport.SetParameters(New ReportParameter() {OrgId, SID, FromDate, ToDate, UID, Type, OrgName})
    ...
    Private Sub BindReport()
        Try
            ...
            dt = ObjReport.GetZerobilledOutlets(Err_No, Err_Desc, Org, van, CDate(txtFromDate.SelectedDate).ToString("dd-MMM-yyyy"), CDate(txtToDate.SelectedDate).ToString("dd-MMM-yyyy"), CType(Session.Item("USER_ACCESS"), UserAccess).UserID)
            gvRep.DataSource = dt
            gvRep.DataBind()
