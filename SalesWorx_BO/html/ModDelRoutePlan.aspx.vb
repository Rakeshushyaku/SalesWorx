...
Partial Public Class ModDelRoutePlan
        ...
        If (Not IsPostBack) Then
            ...
            Try
                ...
                Else
                    ...
                    Route_ID.DataBind()
                    Route_ID.Items.Insert(0, New RadComboBoxItem("  -- Select an existing plan -- ", 0))
                    Dim i As Integer
    ...
    Protected Sub ModBtn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles ModBtn.Click
        Try
            If Route_ID.SelectedItem.Value <= 0 Then
                MessageBoxValidation("Please select an existing plan", "Validation")
                Exit Sub
            End If
