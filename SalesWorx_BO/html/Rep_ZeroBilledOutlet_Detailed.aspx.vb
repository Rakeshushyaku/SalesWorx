...
Public Class Rep_ZeroBilledOutlet_Detailed
    ...
    Sub LoadVisited()
        Dim dt As New DataTable
        Dim Objreport As New SalesWorx.BO.Common.Reports
        dt = Objreport.GetOverallCoverage_NotVisited(Err_No, Err_Desc, hfOrg.Value, HSID.Value, hfSMonth.Value, hfEMonth.Value)
