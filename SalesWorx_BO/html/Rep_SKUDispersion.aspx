<%@ Page Title="SKU Dispersion" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="Rep_SKUDispersion.aspx.vb" Inherits="SalesWorx_BO.Rep_SKUDispersion" %>
     ...
     <script>
         function createChart3() {
             ...
             var dataSource = {
                 ...
                 transport: {
                     read: {
                         url: "Chart.asmx/SKUDispersion", //specify the URL which should create new records. This is the Create method of the Products.asmx service.
  ...
  <div class="row">
                                     ...
                                     <telerik:RadComboBox Skin="Simple" Filter="Contains"  ID="ddlOrganization"  Width ="100%" AutoPostBack="true"
                                         ...
                                         <telerik:RadComboBox ID="ddl_Van" Skin="Simple" runat="server" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" AutoPostBack="true"
                                            CssClass="inputSM"  EmptyMessage="Select Van/FSR"   Width ="100%"  >
                                                   </telerik:RadComboBox>
                                           </div></div>
          ...
          <telerik:RadAjaxPanel ID="RadAjaxPanel4" runat ="server"  >
                                                    ...
                                                    <MasterTableView AutoGenerateColumns="false" TableLayout="Auto" Width="100%" GridLines="None" BorderColor="LightGray"
                                                        ...
                                                        <Columns>
                                                             ...
                                                             <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Distinct_Line_Item" HeaderText="Distinct Line Item Count<i class='fa fa-info-circle'></i>"
                                                                  SortExpression ="Distinct_Line_Item" HeaderTooltip="Number of distinct line items/SKUs" >
