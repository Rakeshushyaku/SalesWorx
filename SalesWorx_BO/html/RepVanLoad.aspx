<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="RepVanLoad.aspx.vb" Inherits="SalesWorx_BO.RepVanLoad" %>
                ...
                <MasterTableView AutoGenerateColumns="false" TableLayout="Auto" Width="100%" GridLines="None" BorderColor="transparent"
                  ...
                  <PagerStyle Mode="NextPrevAndNumeric"></PagerStyle>
                                                        <Columns>
                                                             ...
                                                             <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left"  DataField="Transfer_Date" HeaderText="Load Date" SortExpression ="Transfer_Date"
                                                             DataFormatString="{0:dd-MMM-yyy hh:mm tt}" >
                                                               <ItemStyle Wrap="false" />
                                                            </telerik:GridBoundColumn>
                                                               
                                                             <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Agency" HeaderText="Agency" SortExpression ="Agency"
                                                               >
                                                                <ItemStyle Wrap="False" HorizontalAlign="Center"  />
                                                            </telerik:GridBoundColumn> 
