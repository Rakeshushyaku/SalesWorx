<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="DashBoardDetailedSalesbyVan.aspx.vb" Inherits="SalesWorx_BO.DashBoardDetailedSalesbyVan" %>
  ...
  <script type="text/javascript">
      ...
      function createChart3() {
          ...
          var dataSource = {
              ...
              transport: {
                  read: {
                      url: "Chart.asmx/GetSalesbyVanForMonth", //specify the URL which should create new records. This is the Create method of the Products.asmx service.
        ...
        valueAxis:
          {
              ...
              labels: { font: "12px Segoe UI", color: "#10C4B2" }, majorGridLines: { visible: false }
          },
        seriesColors: ["#10C4B2", "#33CCFF", "#FF99CC", "#FF9933", "#FFFF99", "#FFCC99", "#9999FF"],
        series: [{
            field: "Amount",
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
       <h4><a href="ASRDashboard.aspx" title="Back"><i class="fa fa-arrow-circle-o-left"></i></a> Sales By Van</h4>
