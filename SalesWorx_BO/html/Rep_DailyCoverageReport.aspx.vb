...
Partial Public Class Rep_DailyCoverageReport
    ...
    Private ReportPath As String = "DailyCoverageReport"

    Private Const PageID As String = "P101"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Try
                ...
                txtFromDate.Text = Format(Now().Date.AddDays(-7), "dd-MMM-yyyy")
    ...
    Private Sub InitReportViewer(ByVal fromdate As Date, ByVal Todate As Date, ByVal UID As Integer)
        Try
            ...
            With RVMain
                ...
                .ServerReport.SetParameters(New ReportParameter() {USRID, OID, SalesRepID, FDate, EDate})
    ...
    Private Sub SearchBtn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SearchBtn.Click
        ...
        If Not (ddlOrganization.SelectedItem.Value = "-- Select a value --") Then
            ...
            If String.IsNullOrEmpty(VanStr) Then
                MessageBoxValidation("Please select a van(s).")
                Exit Sub
            End If
