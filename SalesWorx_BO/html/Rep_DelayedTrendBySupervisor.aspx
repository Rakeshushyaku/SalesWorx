<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Rep_DelayedTrendBySupervisor.aspx.vb" Inherits="SalesWorx_BO.Rep_DelayedTrendBySupervisor"  MasterPageFile="~/html/Site.Master"%>
...
.k-chart svg{
     ...
     <script>
         ...
         function createlineChart() {
             ...
             $("#chart3").kendoChart({
                 ...
                 title: { text: "Delayed % by Supervisor ", align: "center", font: "bold 12px Segoe UI", color: "black" },
                 seriesDefaults: {
                     style: "smooth",
                 ...
                 tooltip: { visible: true, template: "<b>${series.name}</b></br>${category} -- ${value}" ,  font: "12px Segoe UI",
             color: "white",
             background: "black"},
                 series: chartseries,
                 valueAxis: {
                 ...
                 categoryAxis: {
                     ...
                     labels: {
                         rotation: -45,
                         color: "black",font: " 12px Segoe UI",
         ...
         function createChart3() {
             ...
             if (param1 != "" && param2 != "" & param3 != "") {
                 ...
                 $.ajax({
                     type: "POST", contentType: "application/json;charset=utf-8", url: "Chart.asmx/CollectionTrendBySuperVisor", data: '{param1:"' + param1 + '",param2:"' + param2 + '",param3:"' + param3 + '", param4:"' + param4 + '", param5:"' + param5  + '"}', dataType: "json", success: function (response) {
   ...
   <asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
       <h4>Delayed Trend By Supervisor</h4>
