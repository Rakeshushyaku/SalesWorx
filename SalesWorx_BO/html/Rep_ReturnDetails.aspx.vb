...
Public Class Rep_ReturnDetails
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                Else
                    If Request.QueryString("Type").Trim().ToUpper = "LR" Then
                    ...
                    LoadReturnDetail(HDocID.Value, Request.QueryString("OrgID"))
                End If
            End If
    ...
    Sub LoadReturnDetail(RowID As String, OrgId As String)
        Try
            ...
            DtHead = ObjReport.GetReturnHeaderDetails(Err_No, Err_Desc, OrgId, RowID)
            DtDetail = ObjReport.GetReturnItemDetails(Err_No, Err_Desc, OrgId, RowID)
    ...
    Sub BindItems()
        Try
            ...
            Dim DtDetail As New DataTable
            DtDetail = ObjReport.GetReturnItemDetails(Err_No, Err_Desc, HOrgID.Value, HDocID.Value)
    ...
    Sub Export(format As String)
        ...
        rview.ServerReport.ReportPath = String.Format("{0}{1}", AppSettings("ReportPath"), "ReturnDetailsNew")
        ...
        If format = "PDF" Then
            ...
            Response.AddHeader("Content-disposition", "attachment;filename=ReturnDetails.pdf")
            Response.AddHeader("Content-Length", bytes.Length)
        ElseIf format = "Excel" Then
            Response.ContentType = "application/excel"
            Response.AddHeader("Content-disposition", "filename=ReturnDetails.xls")
            Response.AddHeader("Content-Length", bytes.Length)
        End If
