...
Partial Public Class Rep_NearExpiry
    ...
    Protected Sub ddlOrganization_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles ddlOrganization.SelectedIndexChanged
        ...
        Try
            If Not (ddlOrganization.SelectedItem.Value = "-- Select a value --") Then
                ...
                ddlVan.DataBind()
                ddlvan.Items.Insert(0, New RadComboBoxItem("(Select)"))
                ...
                ddlCustomer.Items.Insert(0, New RadComboBoxItem("-- All --", "-1$-1"))
                ...
                ddlSKU.DataBind()
                ddlSKU.Items.Insert(0, New RadComboBoxItem("-- All --", "-1"))
                RVMain.Reset()
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles SearchBtn.Click
        ...
        If txt_nofodays.Text.Trim() = "" Then
            RVMain.Visible = False
            RepSec.Visible = False
            MessageBoxValidation("Please Enter the no of days", "Validation")
            Exit Sub
        End If
        Dim OrgId As New ReportParameter
