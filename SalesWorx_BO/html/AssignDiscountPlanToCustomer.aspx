<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="AssignDiscountPlanToCustomer.aspx.vb" Inherits="SalesWorx_BO.AssignDiscountPlanToCustomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
 ...
 <asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h4>Assign Discount Plan To Customer</h4>
      <telerik:RadWindowManager ID="RadWindowManager1"  Skin="Simple" runat="server" EnableShadow="true">
        ...
        <ContentTemplate>
            <div class="row">
                <div class="col-sm-6">
                     <div class="text-primary" style="font-weight:700;padding-bottom:15px;">
                        <asp:Label Visible="false" ID="lblnote" runat ="server" Text ="Note: Assigning a discount plan to the customer removes any existing plan assigned to the same customer."></asp:Label> 
                                      </div>
                </div>
           ...
           <%-- <p id="pagenote">This screen may be used to assign discount plan to customers</p>--%>
            <div class="row">
                <div class="col-sm-4">
...
<telerik:RadWindow ID="MPEImport" Title= "Import Customer Discount Plan" runat="server" Skin="Windows7" Behaviors="Move,Close"
