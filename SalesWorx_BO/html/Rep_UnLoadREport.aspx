<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="Rep_UnLoadREport.aspx.vb" Inherits="SalesWorx_BO.Rep_UnLoadREport" %>
...
#MainContent_gvRep{
   ...
   <asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <telerik:RadPanelBar runat="server" ID="rpbFilter" Skin="Simple" Width="100%"
            ...
            <telerik:RadComboBox Skin="Simple"  Filter="Contains" ID="ddlVan"   CheckBoxes="true" EnableCheckAllItemsCheckBox="true" 
                ...
                <MasterTableView AutoGenerateColumns="false" TableLayout="Auto" Width="100%" GridLines="None" BorderColor="transparent"
                  ...
                  <PagerStyle Mode="NextPrevAndNumeric"></PagerStyle>
                                                        <Columns>
                                                             ...
                                                             <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Transfer_Date" HeaderText="Transfer Date" SortExpression ="Transfer_Date"
                                                             DataFormatString="{0:dd-MMM-yyy hh:mm tt}" >
                                                                
                                                            </telerik:GridBoundColumn>
                                                               
                                                             <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Transfer_Ref_No" HeaderText="Ref No." SortExpression ="Transfer_Ref_No"
                                                               >
                                                                <ItemStyle Wrap="false" HorizontalAlign="Center"   />
                                                            </telerik:GridBoundColumn> 
                                                                                                                                                            
                                                             <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Item_No" HeaderText="Item Code" SortExpression ="Item_No"
                                                               >
                                                                <ItemStyle Wrap="False" HorizontalAlign="Center" />
                                                            </telerik:GridBoundColumn>
                                                             ...
                                                             <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Lot_Number" HeaderText="Lot Number"
                                                                  SortExpression ="Lot_Number" UniqueName="Lot_Number" >
                                                             ...
                                                             <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Location" HeaderText="Location"
                                                              ...
                                                              <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Lot_Type" HeaderText="Lot Type"
                                                                  SortExpression ="Lot_Type" >
                                                                <ItemStyle Wrap="true" HorizontalAlign="Center" />
                                                            </telerik:GridBoundColumn>
