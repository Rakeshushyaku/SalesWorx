<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="RepCollectionListingTemp2.aspx.vb" Inherits="SalesWorx_BO.RepCollectionListingTemp2" %>
                          ...
                          <ContentTemplate >
                            ...
                            <table border="0" cellspacing="2" cellpadding="2" style="padding:5px 0px 5px" >
                                <tr>
                                    ...
                                    <td>
                                         <telerik:RadComboBox Skin="Simple" ID="ddVan" Width ="200px" runat="server" DataTextField="SalesRep_Name" DataValueField="SalesRep_ID">
                                        </telerik:RadComboBox> &nbsp;
