...
Partial Public Class AdminCustomerSegment
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If (Page.IsValid) Then
            ...
            If Me.txtcode.Text.Trim = "" Then
                ...
                Me.lblMessage.Text = "Customer Segment Code is required."
                Me.MPEDetails.VisibleOnPageLoad = True
                Exit Sub
            End If
            If objCustomerSegment.Validatecode(Me.txtcode.Text) = True Then
                Me.lblMessage.Text = "Customer Segment Code is alreday exists."
            ...
            Try
                ...
                objCustomerSegment.Code = Me.txtcode.Text
    ...
    Private Sub BindData()
        Dt = objCustomerSegment.SearchCustomerSegmentGrid(Err_No, Err_Desc, Me.ddFilterBy.Text, txtFilterVal.Text)
    ...
    Protected Sub btnDeleteAll_Click()
        Try
            ...
            If (Success = True) Then
                ...
                MessageBoxValidation("Customer Segment(s) deleted successfully.", "Information")
                BindData()
                Resetfields()
            Else

                MessageBoxValidation("Some Customer Segment(s) could not be deleted.", "Information")
                BindData()
                Resetfields()
            End If
    ...
    Protected Sub btnDelete_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Try
            ...
            If success = True Then
                ...
                Resetfields()
            Else
                MessageBoxValidation("Could not be deleted.", "Information")
                Resetfields()
            End If
    ...
    Protected Sub btnEdit_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            If Trim(row.Cells(2).Text.Trim()) = "&nbsp;" Then
                ...
                Session("Code") = ""
            Else
                txtcode.Text = Trim(row.Cells(2).Text)
    ...
    Protected Sub btnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
        ...
        dtSeg = objCustomerSegment.LoadExportCustomerSegmentTemplate()
        dtSeg.TableName = "CustomerSegment"
        finalDataSet.Tables.Add(dtSeg)
        ...
        Dim fn As String = "CustomerSegment" + DateTime.Now.ToString("hhmmss") + ".xls"
                            ...
                            If ViewState("FileType") IsNot Nothing And ViewState("FileName") IsNot Nothing Then
                                ...
                                If TempTbl.Rows.Count > 0 Then
                                    ...
                                    For idx = 0 To TempTbl.Rows.Count - 1
                                        ...
                                        If Description <> "" Then
                                            If objCustomerSegment.ValidateDescription(Err_No, Err_Desc, Description) = True Then
                                                RowNo = idx + 2
                                        ...
                                        If Code <> "" Then
                                            If objCustomerSegment.Validatecode(Code) = True Then
                                                RowNo = idx + 2
                                        ...
                                        If isValidRow = True Then
                                            ...
                                            If objCustomerSegment.SaveCustomerSegment(Err_No, Err_Desc, Description, Code) Then
                                ...
                                Session.Remove("dtSegErrors")
                                Session("dtSegErrors") = dtErrors

                                Dim fn As String = System.Configuration.ConfigurationManager.AppSettings("ExcelPath") & "UploadLog\" & "CustomerSegmentLog" & Now.ToString("yyyyMMdd") + ".txt"

                                DataTable2CSV(dtErrors, fn, vbTab)

                                Session.Remove("CustomerSegmentLogFile")
                                Session("CustomerSegmentLogFile") = fn
    ...
    Private Function DoXLSUpload() As DataTable
        ...
        Try
            ...
            Try
                ...
                Dim cmd As New OleDbCommand("SELECT * FROM [CustomerSegment$] WHERE [Description] IS NOT NULL", oledbConn)
    ...
    Protected Sub lbLog_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbLog.Click
        If Not Session("CustomerSegmentLogFile") Is Nothing Then
            Dim fileValue As String = Session("CustomerSegmentLogFile")
