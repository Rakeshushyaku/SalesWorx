<%@ Page Title="Payment Received Summary" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="Rep_PaymentReceived.aspx.vb" Inherits="SalesWorx_BO.Rep_PaymentReceived" %>
...
div[id*="ReportDiv"] {  overflow: hidden  !important;
    ...
    <script>
        ...
        function InitializeRequest(sender, args) {
            $("#ctl00_MainContent_rpbFilter_i0_SearchBtn").attr("disabled", "disabled");
        }
   ...
   <asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
       <h4>Payment Received Summary</h4>
	   ...
	   <telerik:RadPanelBar runat="server" ID="rpbFilter" Skin="Simple" Width="100%"
                                         ...
                                         <div class="col-sm-5">
                                           ...
                                           <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <telerik:RadComboBox Skin="Simple" EmptyMessage="Select Type"  Filter="Contains" ID="ddlPay"  Width ="100%"
                runat="server"  CheckBoxes="true" EnableCheckAllItemsCheckBox="true"  >
                                                   <Items>
                
                <telerik:RadComboBoxItem  Text="Cash" Value="CASH"></telerik:RadComboBoxItem>
                 <telerik:RadComboBoxItem  Text="Current Cheque" Value="CURR-CHQ"></telerik:RadComboBoxItem>
                 <telerik:RadComboBoxItem  Text="PDC" Value="PDC"></telerik:RadComboBoxItem>
                                                       <telerik:RadComboBoxItem  Text="Credit Card"  Value="CC"></telerik:RadComboBoxItem>
                                                       </Items>
                 </telerik:RadComboBox>
                                            </div>
                                          </div>
        ...
        <div id="popoverblkouter">
            ...
            <span class="popoverblk">
              ...
              <p><strong>Payment Type: </strong><asp:Label ID="lbl_payType" runat="server" Text=""></asp:Label></p>  
                                                         ...
                                                         <telerik:GridTemplateColumn uniqueName="Collection_Ref_No"  HeaderStyle-HorizontalAlign="Left"    HeaderStyle-Wrap="false" DataField="Collection_Ref_No" SortExpression ="Collection_Ref_No"
                                                          ...
                                                          <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="SalesREp_Name" HeaderText="Collected By"
                                                             ...
                                                             <telerik:GridTemplateColumn  HeaderStyle-HorizontalAlign="Left"    HeaderStyle-Wrap="false" 
                                                                        HeaderText="Cheque Details"  SortExpression ="Cheque_no">
                                                                    <ItemTemplate >
                                                                        <div class="font-small">
                                                                        <strong>No.:</strong> <asp:Label ID="lblChq" runat="server" Text='<%# Bind("Cheque_no")%>' ></asp:Label></div>
                                                                        <div class="font-small"><strong>Date:</strong> <asp:Label ID="Label1" runat="server" Text='<%# Bind("Cheque_Date", "{0:dd-MMM-yyyy}")%>'  ></asp:Label></div>
                                                                       <div class="font-small"><strong>Bank:</strong><asp:Label ID="Label2" runat="server" Text='<%# Bind("Bank_name")%>' ></asp:Label></div>
                                                                    </ItemTemplate>
                                                                </telerik:GridTemplateColumn>
