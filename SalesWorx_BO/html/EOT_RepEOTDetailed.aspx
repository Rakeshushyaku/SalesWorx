<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="EOT_RepEOTDetailed.aspx.vb" Inherits="SalesWorx_BO.EOT_RepEOTDetailed" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h4><a href="EOT_RepSummary.aspx" title="Back"><i class="fa fa-arrow-circle-o-left"></i></a> EOT Detail Report</h4>
    ...
    <div id="summary" runat="server">
                    ...
                    <div class="dashseccontent">
                        <div class="chart-wrapper" style="padding-top:0;padding-bottom: 0;">
                            <table width="100%" class="visit-statistics" cellspacing="0" cellpadding="0" border="0">
                                  <tr>
                                      <td class="text-center td-col-3" width="33.3%" style="padding:4px 0;">Orders</td>
                                  ...
                                  <tr>
                                      <td class="td-col-3">
                                        <span style="font-size: 14px; font: 'Segoe UI';">Cash Orders
                                  ...
                                  <tr>
                                      <td class="td-col-3">
                                        <span style="font-size: 14px; font: 'Segoe UI';">Credit Orders
                                  ...
                                  <tr>
                                      <td class="td-col-3">
                                        <span style="font-size: 14px; font: 'Segoe UI';">Total Orders
                                  ...
                                  <tr>
                                      <td class="td-col-2" colspan="2">
                                          <span style="font-size: 16px; font: 'Segoe UI'; line-height:24px;">Net Orders</span>
        ...
        <!--<div class="row">
         ...
         <telerik:RadGrid id="gvRepVisits" AllowSorting="True" AutoGenerateColumns="False" Skin="Simple" Width="100%" BorderColor="LightGray"
                ...
                <MasterTableView AutoGenerateColumns="false" TableLayout="Auto" Width="100%" GridLines="None" BorderColor="LightGray"
                  ...
                  <PagerStyle Mode="NextPrevAndNumeric"></PagerStyle>
                                                       ...
                                                       <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Visit_Start_Date" HeaderText="Start Time" SortExpression ="Visit_Start_Date"
                                                              ...
                                                              <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Center" DataField="InvCnt" HeaderText="Order </br>Count"
                                                                  SortExpression ="InvCnt" >
                                                                <ItemStyle Wrap="False"  HorizontalAlign="Right"  />
                                                            </telerik:GridBoundColumn>

                                                            <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Center" DataField="OrderAmt" HeaderText="Order Amount"
            ...
            <p><br /><br /></p>
            <p style="font-size:16px; color:#222; margin:10px 0; font-weight:600;">Orders </p>
                              <div   class="table-responsive">
