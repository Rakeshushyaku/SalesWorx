<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="Admin_DistributionCheck_ctl.aspx.vb" Inherits="SalesWorx_BO.Admin_DistributionCheck_ctl" %>
     ...
     .rcTimePopup    
 {
   display:none ! important;
     ...
     <asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
         ...
         <h4>Distribution Check Control</h4>
            ...
            <ContentTemplate>
                                        ...
                                        <div class="row">
                                         ...
                                         <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <label>Van</label>
                                           <telerik:RadComboBox Skin="Simple" ID="ddl_FilterVan" EmptyMessage="Select Van"    Width ="100%" runat="server" DataTextField="SalesRep_Name" DataValueField="SalesRep_ID" AutoPostBack="true">
                                        </telerik:RadComboBox >
                                            </div>
                                          </div>
         ...
         <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode ="Conditional" >
                        ...
                        <div class="table-responsive">
                         ...
                         <asp:GridView Width="100%" ID="dgvErros"   runat="server" EmptyDataText="No items to display"
                                                    ...
                                                    <telerik:RadWindow ID="MPEAdd" Title= "Add Distribution Check Control" runat="server" Skin="Windows7" Behaviors="Move,Close"
                         ...
                         <ContentTemplate>
                               <asp:HiddenField ID="HidVal" runat="server" Value="-1" />
                                        ...
                                        <div class="row">
		                                    ...
		                                    <div class="col-sm-7">
			                                    <div class="form-group">
                                                     <asp:CheckBox ID="chkIsOptional" TabIndex ="2" runat="server" CssClass="inputSM" TextAlign="Left"  />
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <Columns>
                                                         <asp:TemplateField HeaderText="">
                                                             ...
                                                             <ItemStyle HorizontalAlign="Left" Width="100px" CssClass="display-block"  />
                                                              ...
                                                              <asp:BoundField HeaderStyle-HorizontalAlign="Left"    HeaderStyle-Wrap="false" DataField="Site_No" SortExpression ="Site_No"
                                                                HeaderText="Site No">
                                                                <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                                            </asp:BoundField>

                                                              <asp:BoundField HeaderStyle-HorizontalAlign="Left"    HeaderStyle-Wrap="false" DataField="SalesRep_Number" SortExpression ="SalesRep_Number"
                                                                HeaderText="VAN Code">
                                                                <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                                            </asp:BoundField>

                                                              <asp:BoundField HeaderStyle-HorizontalAlign="Left"    HeaderStyle-Wrap="false" DataField="SalesRep_Name" SortExpression ="SalesRep_Name"
                                                                HeaderText="VAN">
                                                                <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                                            </asp:BoundField>
                                                            ...
                                                            <asp:BoundField HeaderStyle-HorizontalAlign="Left" DataField="IsOptional" HeaderText="Is Optional"
                                                                  SortExpression ="IsOptional" >
                                                           ...
                                                           <asp:TemplateField Visible="False">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="lblDistribution_CTL_ID" runat="server" Text='<%# Bind("Distribution_CTL_ID")%>'></asp:Label>
                                                                 <asp:Label ID="lblIs_Optional" runat="server" Text='<%# Bind("Is_Optional")%>'></asp:Label>
                                                                  <asp:Label ID="lblMAS_Org_ID" runat="server" Text='<%# Bind("MAS_Org_ID")%>'></asp:Label>
                                                                  <asp:Label ID="lblSalesRep_ID" runat="server" Text='<%# Bind("SalesRep_ID")%>'></asp:Label>
