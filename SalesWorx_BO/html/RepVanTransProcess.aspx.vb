...
Partial Public Class RepVanTransProcess
    ...
    Private ReportPath As String = "VanProcessTransaction"

    Private Const PageID As String = "P258"
    ...
    Sub Export(format As String)
        ...
        If format = "PDF" Then
            ...
            Response.AddHeader("Content-disposition", "attachment;filename=VanProcessTransactions.pdf")
            Response.AddHeader("Content-Length", bytes.Length)
        ElseIf format = "Excel" Then
            Response.ContentType = "application/excel"
            Response.AddHeader("Content-disposition", "filename=VanProcessTransactions.xls")
            Response.AddHeader("Content-Length", bytes.Length)
        End If
    ...
    Private Sub BindReport()
        If Not ddlOrganization.SelectedItem Is Nothing Then
            ...
            dt = ObjReport.GetVanProcessTransactions(Err_No, Err_Desc, van, txtFromDate.SelectedDate, txtToDate.SelectedDate)
