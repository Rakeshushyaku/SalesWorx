<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/DashboardSection.Master" CodeBehind="DashboardSalesbyAgencyBar.aspx.vb" Inherits="SalesWorx_BO.DashboardSalesbyAgencyBar" %>
...
$(document).ready(function () {
    ...
    <div class="chart-wrapper">
        <div id="chart5"   style ="width:100%;height:235px;">
        </div>
        </div> 
</asp:Content>
