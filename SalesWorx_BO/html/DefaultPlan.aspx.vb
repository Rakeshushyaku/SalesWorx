...
Partial Public Class DefaultPlan
                ...
                If CType(Session("User_Access"), UserAccess).IsSS <> "N" Then
                    ...
                    If Tbl IsNot Nothing Then
                        ...
                        ElseIf Tbl.Rows.Count > 1 Then
                            ...
                            ddSite.Items.Add(New RadComboBoxItem("-- Select a Organization --", ""))
    ...
    Private Sub DelBtn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles DelBtn.Click
        Dim objRoute As New RoutePlan
        Try
            If RP_ID.SelectedItem.Value <= 0 Then
                MessageBoxValidation("Please select a default plan", "Validation")
                Exit Sub
            End If

            If objRoute.DefaultPlanUsed(RP_ID.SelectedValue, Err_No, Err_Desc) = True Then
                MessageBoxValidation("This plan is in use and cannot be deleted.", "Validation")
                Exit Sub
            End If
