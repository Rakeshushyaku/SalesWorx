<%@ Page Title="Client Logo" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/DefaultLayout.Master" CodeBehind="AdminClientLogo.aspx.vb" Inherits="SalesWorx_BO.AdminClientLogo" %>
        ...
        function TestCheckBox() {
            ...
            for (var n = 0; n < Inputs.length; ++n)
                if (Inputs[n].type == 'checkbox' && Inputs[n].id.indexOf(TargetChildControl, 0) >= 0 && Inputs[n].checked) {
                    return confirm('Would you like to delete the client Logo?');
                return true;
            }
            alert('Select at least one client Logo!');
            return false;
        ...
        <tr>
            <td id="contentofpage" width="100%" height="76%" class="topshadow">
                <div class="pgtitileposition">
                    <span class="pgtitile3">Client Logo</span></div>
                            ...
                            <asp:UpdatePanel ID="ClassUpdatePnl" runat="server" UpdateMode="conditional">
                                <ContentTemplate>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>
                                                <asp:GridView Width="845px" ID="grdCustomerSegment" runat="server" EmptyDataText="No Client Logo"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:ImageButton ToolTip="Delete Client Logo" ID="btnDelete" OnClick="btnDelete_Click"
                                                                    runat="server" CausesValidation="false"  ImageUrl="~/images/delete-13.png" OnClientClick="javascript:return confirm('Would you like to delete this Client Logo?');" />
                                                                <asp:ImageButton ID="btnEdit" ToolTip="Edit Client Logo" runat="server" CausesValidation="false"
                                                                    ImageUrl="~/images/edit-13.png"   OnClick="btnEdit_Click" />
                                                            </ItemTemplate>
                                                            <ItemStyle Width="100px" />
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="Info_Key" HeaderText="Client" SortExpression="Info_Key">
                                                            <ItemStyle Wrap="False" />
                                                              <ItemStyle Width="250px" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="Value_5" HeaderText="Line1" SortExpression="Value_5">
                                                            <ItemStyle Wrap="False" />
                                                             <ItemStyle Width="250px" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="Value_4" HeaderText="Line2" SortExpression="Value_4">
                                                            <ItemStyle Wrap="False" />
                                                             <ItemStyle Width="250px" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="Value_3" HeaderText="Line3" SortExpression="Value_3">
                                                            <ItemStyle Wrap="False" />
                                                             <ItemStyle Width="250px" />
                                                        </asp:BoundField>
