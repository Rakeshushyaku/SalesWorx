...
Public Class RepProductivityByVan
    ...
    Private ReportPath As String = "ProductivityByVan"
    Private Const PageID As String = "P368"
    ...
    Private Sub SearchBtn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SearchBtn.Click
        If ValidateInputs() Then
            ...
            Me.hfSMonth.Value = CDate(Sdate).ToString("dd-MMM-yyyy")
            Me.hTSMonth.Value = DateAdd(DateInterval.Day, -1, DateAdd(DateInterval.Month, 1, CDate(Sdate))).ToString("dd-MMM-yyyy")
    ...
    Sub Export(format As String)
        Try
            ...
            If format = "PDF" Then
                ...
                Response.AddHeader("Content-disposition", "attachment;filename=ProductivityByVan.pdf")
                Response.AddHeader("Content-Length", bytes.Length)


            ElseIf format = "Excel" Then
                Response.ContentType = "application/excel"
                Response.AddHeader("Content-disposition", "filename=ProductivityByVan.xls")
                Response.AddHeader("Content-Length", bytes.Length)
            End If
    ...
    Protected Sub lblBilled_Click(sender As Object, e As EventArgs)
        ...
        Catch ex As Exception
            Err_No = "74066"
            log.Error(Err_Desc)
            Response.Redirect("information.aspx?mode=1&errno=" & Err_No & "&msg=" & AppMsgHandler.GetErrorMessage("C_BO_BillCuts_006") & "&next=RepProductivityByVan.aspx&Title=Message", False)
            If Err_Desc Is Nothing Then
                log.Error(GetExceptionInfo(ex))
            Else
                log.Error(Err_Desc)
