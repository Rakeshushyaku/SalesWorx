...
Partial Public Class ManageDeliveryCalenderold
                        ...
                        Try
                            ...
                            If ViewState("FileType") IsNot Nothing And ViewState("FileName") IsNot Nothing Then
                                ...
                                If TempTbl.Columns.Count >= 3 Then
                                    If Not (TempTbl.Columns(0).ColumnName = "Organization_ID" Or TempTbl.Columns(1).ColumnName = "Date" Or TempTbl.Columns(2).ColumnName = "Is_Working") Then
    ...
    Private Function DoXLSUpload() As DataTable
        ...
        Try
            ...
            Try
                oledbConn.Open()
                Dim cmd As New OleDbCommand("SELECT * FROM [ExceptionDates$]", oledbConn)
    ...
    Protected Sub btndownloadTemplate_Click(sender As Object, e As EventArgs) Handles btndownloadTemplate.Click
        ...
        Dim Filename As String = System.Configuration.ConfigurationManager.AppSettings("ExcelTemplatePath") & "ExceptionDates.xls"
