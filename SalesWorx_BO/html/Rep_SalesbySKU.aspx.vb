...
Public Class Rep_SalesbySKU
    ...
    Private ReportPath As String = "SalesbySKU_V2"

    Private Const PageID As String = "P353"
    ...
    Sub BindOverAllReport()
        Try
            ...
            dt = objRep.GetSalesReturnsbySKU(Err_No, Err_Desc, HorgID.Value, HVan.Value, HUID.Value, HType.Value, Fromdate.ToString("dd-MMM-yyyy"), Todate.ToString("dd-MMM-yyyy"), HAgency.Value, HItem.Value, Hcustomer.Value)
    ...
    Sub Export(format As String)
        ...
        If format = "PDF" Then
            ...
            Response.AddHeader("Content-disposition", "attachment;filename=SalesbySKU.pdf")
            Response.AddHeader("Content-Length", bytes.Length)
        ElseIf format = "Excel" Then
            Response.ContentType = "application/excel"
            Response.AddHeader("Content-disposition", "filename=SalesbySKU.xls")
            Response.AddHeader("Content-Length", bytes.Length)
        End If
    ...
    Private Sub BtnExportBiffExcel_Click(sender As Object, e As EventArgs) Handles BtnExportBiffExcel.Click
        ...
        dt = ObjReport.GetSalesReturnsbySKU(Err_No, Err_Desc, HorgID.Value, HVan.Value, HUID.Value, HType.Value, Fromdate.ToString("dd-MMM-yyyy"), Todate.ToString("dd-MMM-yyyy"), HAgency.Value, HItem.Value, Hcustomer.Value)

        Dim tblData As New DataTable

        tblData = dt.DefaultView.ToTable(False, "Product", "UOM", "Salesqty", "Sales", "Returnsqty", "Returns", "Net", "NetsalesQty", "AvgQtySold")
        ...
        If tblData.Rows.Count > 0 Then
            ...
            Using package As New ExcelPackage()
                ...
                Worksheet.Cells("H3").Value = "Net Sales Qty"
                Worksheet.Cells("I3").Value = "Avg Qty Sold"
                ...
                Response.AddHeader("content-disposition", "attachment;filename= SalesbySKU.xlsx")
