<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="RepSalesbyProducts.aspx.vb" Inherits="SalesWorx_BO.RepSalesbyProducts" %>
            ...
            <telerik:RadGrid ID="gvRep" AllowSorting="True" AutoGenerateColumns="False" Skin="Simple" Width="100%" BorderColor="LightGray"
                ...
                <MasterTableView AutoGenerateColumns="false" TableLayout="Auto" Width="100%" GridLines="None" BorderColor="LightGray"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="CH" HeaderText="Chain ID" UniqueName="CH"
                            SortExpression="CH">
                        ...
                        <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Route" HeaderText="Route" UniqueName="Route"
                        ...
                        <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="OrderNumber" HeaderText="Document  Number"
                         ...
                         <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="erprefno" HeaderText="ERP Ref No." UniqueName="erprefno"
                            SortExpression="erprefno">
                            <ItemStyle Wrap="False" />
                            <HeaderStyle Wrap="False" />
                        </telerik:GridBoundColumn>

                        <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="TransactionType" HeaderText="Customer Type" UniqueName="TrnsType"
                            SortExpression="TransactionType">
                            <ItemStyle Wrap="False" />
                            <HeaderStyle Wrap="False" />
                        </telerik:GridBoundColumn>

                         <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Customercode" HeaderText="Customer Code" UniqueName="CusotmerCode"
                         ...
                         <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="OutletCode" HeaderText="Outlet Code" UniqueName="outletcode"
                         ...
                         <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Outletname" HeaderText="Outlet Name" UniqueName="Outletname"
                        ...
                        <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Category" HeaderText="Product Category" UniqueName="Category"
                            SortExpression="Category">
                            <ItemStyle Wrap="False" />
                            <HeaderStyle Wrap="False" />
                        </telerik:GridBoundColumn>

                         <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="CatDesc" HeaderText="Category Description" UniqueName="Catdesc"
                        ...
                        <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Display_UOM" HeaderText="UOM"
                         ...
                         <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Unit_Selling_Price" HeaderText="Item Price" UniqueName="UP"
                            SortExpression="Unit_Selling_Price" DataType="System.Double" DataFormatString="{0:N2}">
                            <ItemStyle Wrap="False" HorizontalAlign="Right" />
                            <HeaderStyle HorizontalAlign="Center" Wrap="False" />
                        </telerik:GridBoundColumn>

                        <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="tot" HeaderText="Total" UniqueName="tot"
                        ...
                        <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="CustomerGroup" HeaderText="Customer Group" UniqueName="CG"
