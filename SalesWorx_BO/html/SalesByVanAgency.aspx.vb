...
Partial Public Class SalesByVanAgency
    ...
    Private ReportPath As String = "SalesByVanAgencyNew"
    ...
    Private Sub BindData()
        ...
        Try
            ...
            dt = ObjReport.GetSalesbyVanAgency(Err_No, Err_Desc, ddlOrganization.SelectedItem.Value, CType(Session.Item("USER_ACCESS"), UserAccess).UserID)
            Args.Visible = True
    ...
    Sub Export(format As String)
        ...
        If format = "PDF" Then
            ...
            Response.AddHeader("Content-disposition", "attachment;filename=SalesbyVanAgency.pdf")
            Response.AddHeader("Content-Length", bytes.Length)
        ElseIf format = "Excel" Then
            Response.ContentType = "application/excel"
            Response.AddHeader("Content-disposition", "filename=SalesbyVanAgency.xls")
            Response.AddHeader("Content-Length", bytes.Length)
        End If
    ...
    Private Sub gvRep_CellDataBound(sender As Object, e As PivotGridCellDataBoundEventArgs) Handles gvRep.CellDataBound
        If TypeOf e.Cell Is PivotGridDataCell Then
            ...
            If cell.CellType = PivotGridDataCellType.DataCell OrElse cell.CellType = PivotGridDataCellType.RowTotalDataCell Then
                ...
                If TryCast(cell.Field, PivotGridAggregateField).DataField = "QtyM2" Or TryCast(cell.Field, PivotGridAggregateField).DataField = "QtyM1" Or TryCast(cell.Field, PivotGridAggregateField).DataField = "QtyM" Then
                    If cell.DataItem Is Nothing Then
                        cell.Text = Format(Val(cell.Text), lblDecimal.Text)
                    End If
                End If
            End If
        End If
