...
Partial Public Class ManagePOSMSurvey
    ...
    Sub LoadResponseTypes()
        ...
        ddl_Response.Items.Insert(0, New RadComboBoxItem("-- Select a value --", "0"))
    ...
    Sub LoadQuestionGroup()
        ...
        ddl_QGroup.DataBind()
        ddl_QGroup.Items.Insert(0, New RadComboBoxItem("-- Select a value --", "0"))

        ddQGroup.DataSource = dt
        ddQGroup.DataTextField = "code_description"
        ddQGroup.DataValueField = "code_Value"
        ddQGroup.DataBind()
        ddQGroup.Items.Insert(0, New RadComboBoxItem("-- Select a value --", "0"))
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If Me.ddl_QGroup.SelectedItem.Value = "0" Then
            ...
            ''Me.MpInfoError.Show()
            ''Me.MPECurrency.Show()
            lblPop.Text = "Question Group is required."
        ...
        If Me.ddl_Question1.SelectedItem.Value = "0" Then
            ...
            '' ''Me.MpInfoError.Show()
            '' ''Me.MPECurrency.Show()
            lblPop.Text = lbl_Question1.Text & " is required."
            MPEDetails.VisibleOnPageLoad = True
            Exit Sub
        End If
        If Me.ddl_QGroup.SelectedItem.Value = "CP" Then
            If Me.ddl_Question2.SelectedItem.Value = "0" Then
                ...
                '' ''Me.MpInfoError.Show()
                '' ''Me.MPECurrency.Show()
                lblPop.Text = lbl_Question2.Text & " is required."
                MPEDetails.VisibleOnPageLoad = True
                Exit Sub
            End If
        End If
...
Regex("(^[-+]?\d+(,?\d*)*\.?\d*([Ee][-+]\d*)?$)|(^[-+]?\d?(,?\d*)*\.\d+([Ee][-+]\d*)?$)")
    ...
    Protected Sub btnDeleteAll_Click()
        Try
            ...
            If (Success = True) Then
                ...
                If Not ddQGroup.Items.FindItemByValue(sel) Is Nothing Then
                    ddQGroup.ClearSelection()
                    ddQGroup.Items.FindItemByValue(sel).Selected = True
                End If
    ...
    Protected Sub btnEdit_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            If dt.Rows.Count > 0 Then
                If Not ddl_QGroup.Items.FindItemByValue(dt.Rows(0)("Question_Group_1").ToString) Is Nothing Then
                    ddl_QGroup.ClearSelection()
                    ddl_QGroup.Items.FindItemByValue(dt.Rows(0)("Question_Group_1").ToString).Selected = True
                End If
                pnl_details.Visible = True
                loadddlQuestion()

                If Not ddl_Question1.Items.FindItemByValue(dt.Rows(0)("Question_1").ToString) Is Nothing Then
                    ddl_Question1.ClearSelection()
                    ddl_Question1.Items.FindItemByValue(dt.Rows(0)("Question_1").ToString).Selected = True
                End If
                If Not ddl_Question2.Items.FindItemByValue(dt.Rows(0)("Question_2").ToString) Is Nothing Then
                    ddl_Question2.ClearSelection()
                    ddl_Question2.Items.FindItemByValue(dt.Rows(0)("Question_2").ToString).Selected = True
                End If
                If Not ddl_Response.Items.FindItemByValue(dt.Rows(0)("Response_Type").ToString) Is Nothing Then
                    ddl_Response.ClearSelection()
                    ddl_Response.Items.FindItemByValue(dt.Rows(0)("Response_Type").ToString).Selected = True
                End If
            End If
            '' ''MPECurrency.Show()
            MPEDetails.VisibleOnPageLoad = True
    ...
    Sub loadddlQuestion()
        If ddl_QGroup.SelectedItem.Value = "CP" Then
            ...
            ddl_Question1.Items.Insert(0, New RadComboBoxItem("-- Select a value --", "0"))
            ...
            If Not ddl_Response.Items.FindItemByValue(1) Is Nothing Then
                ddl_Response.ClearSelection()
                ddl_Response.Items.FindItemByValue(1).Selected = True
            End If
        ...
        ddl_Question2.Items.Insert(0, New RadComboBoxItem("-- Select a value --", "0"))
