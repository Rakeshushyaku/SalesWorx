...
Partial Public Class ManageAssets
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ddOraganisation.Items.Insert(0, New RadComboBoxItem("-- Select a value --", ""))
        ...
        Else
            ...
            MapImport.VisibleOnPageLoad = False
    ...
    Private Sub LoadCurrency()
        ...
        dtcurrency = ObjReport.GetCurrency(Err_No, Err_Desc, ddOraganisation.SelectedItem.Value)
        ...
        End If
        gvAssets.Columns(6).HeaderText = "Value (" & Me.hfCurrency.Value & ")"
        CType(gvAssets.Columns(6), BoundField).DataFormatString = "{0:N" & HfDecimal.Value & "}"
    ...
    Private Sub ddlCustomer_ItemsRequested(sender As Object, e As RadComboBoxItemsRequestedEventArgs) Handles ddlCustomer.ItemsRequested
        ...
        Try
            ...
            dt = (New SalesWorx.BO.Common.Reports).GetOutletsfromOrgtext(Err_No, Err_Desc, ddOraganisation.SelectedValue, e.Text)
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If String.IsNullOrEmpty(ddlCustomer.SelectedValue) Then
            Me.lblValMsg.Text = "Please select a customer"
        ...
        Else
            ...
            SiteID = ids(1)
        End If
        If Me.ddlAssetType.SelectedIndex <= 0 Then
            ...
            Me.lblValMsg.Text = "Please select asset type"
            Me.lblValMsg.ForeColor = Drawing.Color.Red
            Me.MapWindow.VisibleOnPageLoad = True
            Exit Sub
        End If
        ...
        Try
            ...
            If objAssetType.CheckAssetNo(Err_No, Err_Desc, Me.txtAssetCode.Text, IIf(Me.txtAssetTypeId.Text = "", "0", Me.txtAssetTypeId.Text)) = False Then
                If objAssetType.InsertAssets(Err_No, Err_Desc, CType(Session.Item("USER_ACCESS"), UserAccess).UserID, Me.ddlAssetType.SelectedValue, CustID, SiteID, Me.txtAssetCode.Text, Me.txtDescription.Text, IIf(Me.ChkActive.Checked = True, "Y", "N"), IIf(Me.txtValue.Text = "", "0", Me.txtValue.Text)) = True Then
                    '' MapWindow.VisibleOnPageLoad = False
...
Regex("(^[-+]?\d+(,?\d*)*\.?\d*([Ee][-+]\d*)?$)|(^[-+]?\d?(,?\d*)*\.\d+([Ee][-+]\d*)?$)")
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            If objAssetType.UpdateAssets(Err_No, Err_Desc, CType(Session.Item("USER_ACCESS"), UserAccess).UserID, Me.txtAssetTypeId.Text, Me.ddlAssetType.SelectedValue, CustID, SiteID, Me.txtAssetCode.Text, Me.txtDescription.Text, IIf(Me.ChkActive.Checked = True, "Y", "N"), IIf(Me.txtValue.Text = "", "0", Me.txtValue.Text)) = True Then
                success = True
    ...
    Protected Sub btnDeleteAll_Click()
        Try
            ...
            If (Success = True) Then
                ...
                ''MpInfoError.Show()
                ''btnClose.Focus()
                MessageBoxValidation("Assets deleted successfully.", "Information")
    ...
    Protected Sub btnEdit_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            Dim x As New DataTable
            x = objAssetType.GetAssetByID(Err_No, Err_Desc, lblAssetId.Text, ddOraganisation.SelectedValue)
            ...
            If x.Rows.Count > 0 Then
                ...
                ddlCustomer.Text = x.Rows(0)("Customer").ToString()
                ...
                txtValue.Text = IIf(x.Rows(0)("Custom_Attribute_5") Is DBNull.Value, "0", x.Rows(0)("Custom_Attribute_5").ToString())
            End If
    ...
    Protected Sub btnImportSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnImportSave.Click
        If Me.ExcelFileUpload.FileName = Nothing Then
            ...
            ' Me.MpInfoError.Show()
            MapImport.VisibleOnPageLoad = True
            Exit Sub
        End If
                ...
                Try
                    ...
                    If ViewState("FileType") IsNot Nothing And ViewState("FileName") IsNot Nothing Then
                        ...
                        If TempTbl.Columns.Count = 7 Then
                            ...
                            If Not (TempTbl.Columns(0).ColumnName = "CustomerNo" And TempTbl.Columns(1).ColumnName = "AssetTypeID" And TempTbl.Columns(2).ColumnName = "AssetCode" And TempTbl.Columns(3).ColumnName = "Description" And TempTbl.Columns(4).ColumnName = "CustomerName" And TempTbl.Columns(5).ColumnName = "AssetType" And TempTbl.Columns(6).ColumnName = "AssetValue") Then
                        ...
                        If TempTbl.Rows.Count > 0 Then
                            ...
                            For idx = 0 To TempTbl.Rows.Count - 1
                                ...
                                AssetValue = IIf(TempTbl.Rows(idx)(6) Is DBNull.Value, "0", TempTbl.Rows(idx)(6).ToString())
                                ...
                                If AssetValue <> "" And Not AssetValue Is Nothing Then
                                    If IsNumeric(AssetValue) = False Then
                                        RowNo = idx + 2
                                        TempTbl.Rows(idx)("IsValid") = "N"
                                        TempTbl.Rows(idx)("CustomerID") = "0"
                                        TempTbl.Rows(idx)("SiteID") = "0"
                                        ErrorText = "Asset value should be in numeric"
                                        TotFailed += 1
                                        isValidRow = False
                                    End If
                                End If
    ...
    Protected Sub Export_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExport.Click
        ...
        If Me.ddOraganisation.SelectedIndex > 0 Then
            ...
            For i As Integer = 0 To dtOriginal.Rows.Count - 1
                ...
                drAddItem(6) = dtOriginal.Rows(i)("AssetValue").ToString()
            ...
            If dtTemp.Rows.Count > 0 Then
                ...
                Dim fn As String = "AssetsToCustomer" + Now.ToString("ddMMMyyHHmmss") + ".xls"
