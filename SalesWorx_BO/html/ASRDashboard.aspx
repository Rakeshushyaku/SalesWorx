<%@ Page Title="Dashboard" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master"
    CodeBehind="ASRDashboard.aspx.vb" Inherits="SalesWorx_BO.ASRDashboard" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <telerik:RadAjaxPanel runat="server" ID="RadAjaxPanel10">
                                    ...
                                    <telerik:RadGrid ID="rgZeroBilled" 
                                        ...
                                        <MasterTableView AutoGenerateColumns="false"   ShowFooter="true"  AllowFilteringByColumn ="false" 
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn Visible="false" HeaderStyle-HorizontalAlign="Left" DataField="Van" HeaderText="Van"
                                                                  SortExpression ="Van" >
        ...
        <div class="filter-table">
            <div class="row" >
            <div class="col-sm-3" id="tdctry2"  runat="server">
            <div class="form-group" >
                <label> Country  </label> 
                
                <div class="form-control">
                    <telerik:RadComboBox Skin="Simple" EmptyMessage="Select Country" ID="ddlCountry" Width="100%" runat="server" DataTextField="Country" DataValueField="MAS_ORG_ID" AutoPostBack="true"></telerik:RadComboBox>
                    
                </div>
            </div>
            </div>
                <div class="col-sm-3" id="tdctry3"  runat="server">
                <div class="form-group" >
                <label> Organization  </label> 
                
                <div class="form-control">
                              <telerik:RadComboBox Skin="Simple" Visible ="false" EmptyMessage="Select Sales Org" EnableCheckAllItemsCheckBox="true" CheckBoxes="true" ID="ddlOrganization" Width="100%" runat="server" DataTextField="Description" DataValueField="MAS_Org_ID"  AutoPostBack="true"></telerik:RadComboBox>
                </div>
            </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div id="Div1" runat ="server" visible ="false" class="form-control">
                    <telerik:RadComboBox runat="server"  ID="ddlFSR" Visible="false"  Filter="Contains" Height="200" Width="100%" Skin="Simple" AutoPostBack="true"></telerik:RadComboBox>
                </div>
            </div>
            </div>
            <div class="col-sm-3">
            ...
            <div class="form-group">
                ...
                <div class="form-control" style="padding: 6px 0px;">
            ...
            <div class="form-group text-right" style="display:block;">
                ...
                <div class="form-control" style="padding: 6px 0px; text-align:right;font-weight: 500;" >
                    <asp:HyperLink ID="hyp_IncomingMsg" runat="server" NavigateUrl="~/html/DashboardIncomingMsgs.aspx" Font-Underline="true">Incoming Messages</asp:HyperLink>
                </div>
            </div>
            </div>
            </div>
                                                ...
                                                valueAxis:
    {
        labels: { font: "12px Segoe UI" }
                                                ...
                                                seriesColors: ["#33CCFF", "#688AC9", "#E67A77", "#0B62A4", "#C4C16A", "#CE5F5F", "#688AC9", "#E67A77", "#0B62A4", "#0B62A4", "#7A92A3", "#CE1663", "#FFCC00"],
                                                ...
                                                valueAxis:
    {
        ...
        <div class="overflowx">
                                <telerik:RadAjaxPanel runat="server" ID="g">
                                        ...
                                        <telerik:RadWindow ID="ZeroBilledWindowbyVan" Title ="Zero Billed Customers" runat="server" modal="true"  Behaviors="Move,Close" 
           ReloadOnShow="true"  VisibleStatusbar="false" Height ="515px" BorderColor ="Black"  Width ="700px"  skin="Windows7"  >
               <ContentTemplate>
                           <telerik:RadAjaxPanel runat="server" ID="RadAjaxPanel2">
                                    <telerik:RadGrid ID="rgZeroBilled_byvan" 
                                        AllowSorting="True" AutoGenerateColumns="False" Width="100%" BorderStyle="None"
                                        PageSize="9" AllowPaging="True" runat="server" Skin="Simple" AllowFilteringByColumn="false" ShowFooter="true"
                                        GridLines="None">
                                        ...
                                        <MasterTableView AutoGenerateColumns="false"   ShowFooter="true"  AllowFilteringByColumn ="false" 
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="Customer" HeaderText="Customer" SortExpression="Customer"
                                                     ShowFilterIcon="false" AllowFiltering="true"  FilterControlToolTip="Type customer and press enter"
                                                    CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" Aggregate="Count" FooterText="Total Customers : ">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                    <FooterStyle HorizontalAlign="Left" Font-Bold="true" BackColor="#eff9ff" ForeColor="#000" Font-Size="15px" />
                                    ...
                                    <telerik:RadGrid ID="gvLog" DataSourceID="sqlLog"
                                        ...
                                        <MasterTableView AutoGenerateColumns="false" DataSourceID="sqlLog" ShowFooter="true"  AllowFilteringByColumn ="true" 
                                       ...
                                       <asp:ImageButton ID="Button" runat="server" AlternateText="Clear filter" ToolTip="Clear filter" OnClick="Button_Click" ImageUrl="~/images/Clearfilter.png" />
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="SalesRep_Name" HeaderText="Van" SortExpression="SalesRep_Name" HeaderTooltip="Name of the Van"
                                                     ShowFilterIcon="false" AllowFiltering="true"  FilterControlToolTip="Type van name and press enter"  
                                                    CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" Aggregate="Count" FooterText="Total Vans : " >
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                    <FooterStyle HorizontalAlign="Left" Font-Bold="true" BackColor="#eff9ff" ForeColor="#000" Font-Size="15px" />
                                                </telerik:GridBoundColumn>
                                                 <telerik:GridBoundColumn DataField="TNetSales" SortExpression="TNetSales" Aggregate="Sum" AllowFiltering="false" ShowFilterIcon="false" HeaderText="Net Sales <i class='fa fa-info-circle'></i>" HeaderTooltip="Net Sales Amount">
                                                    <HeaderStyle HorizontalAlign="right" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                    <FooterStyle HorizontalAlign="Right" Font-Bold="true" BackColor="#eff9ff" ForeColor="#000" Font-Size="15px" />
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn DataField="TSales" SortExpression="TSales" Aggregate="Sum" AllowFiltering="false" ShowFilterIcon="false" HeaderText="Total Sales <i class='fa fa-info-circle'></i>" HeaderTooltip="Total Order Amount">
                                                    <HeaderStyle HorizontalAlign="right" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                    <FooterStyle HorizontalAlign="Right" Font-Bold="true" BackColor="#eff9ff" ForeColor="#000" Font-Size="15px" />
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn DataField="TCreditNote" AllowFiltering="false" ShowFilterIcon="false" Aggregate="Sum" DataFormatString="{0:N2}" HeaderText="Total Returns <i class='fa fa-info-circle'></i>" SortExpression="TCreditNote" HeaderTooltip="Total Return Amount">
                                                    <HeaderStyle HorizontalAlign="right" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                    <FooterStyle HorizontalAlign="Right" Font-Bold="true" BackColor="#eff9ff" ForeColor="#000" Font-Size="15px" />
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn DataField="Payment" HeaderText="Total Collections <i class='fa fa-info-circle'></i>" SortExpression="Payment" Aggregate="Sum" AllowFiltering="false" ShowFilterIcon="false" HeaderTooltip="Total Collection Amount">
                                                    <HeaderStyle HorizontalAlign="Right" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                    <FooterStyle HorizontalAlign="Right" Font-Bold="true" BackColor="#eff9ff" ForeColor="#000" Font-Size="15px" />
                                                </telerik:GridBoundColumn>
                                                ...
                                                <telerik:GridTemplateColumn UniqueName="ProdColumn" AllowFiltering="false" DataField ="ProdCalls" Aggregate ="Sum" FooterAggregateFormatString="{0:N0}" HeaderTooltip="No. of Calls in which invoice is taken"
                                                    InitializeTemplatesFirst="false" HeaderText="Productive Calls <i class='fa fa-info-circle'></i>" SortExpression ="ProdCalls">
                                               ...
                                               <%-- <telerik:GridBoundColumn DataField="TotCalls" HeaderText="Total Calls" Aggregate="Sum" SortExpression="TotCalls" FooterAggregateFormatString="{0:N0}" AllowFiltering="false" ShowFilterIcon="false">
                                                ...
                                                <telerik:GridTemplateColumn UniqueName="TotCallsColumn" AllowFiltering="false" DataField ="TotCalls" Aggregate ="Sum" FooterAggregateFormatString="{0:N0}"
                                                    InitializeTemplatesFirst="false" HeaderText="Total Calls <i class='fa fa-info-circle'></i>"  SortExpression ="TotCalls" HeaderTooltip="No. of Calls in which Distribution Check is done">
                                                ...
                                                <telerik:GridTemplateColumn UniqueName="ZeroBilled" AllowFiltering="false" DataField ="ZeroBilled" Aggregate ="Sum" FooterAggregateFormatString="{0:N0}"
                                                    InitializeTemplatesFirst="false" HeaderText="Zero Billed Customers <i class='fa fa-info-circle'></i>"  SortExpression ="ZeroBilled" HeaderTooltip="No. of Customers not billed from JP">


                                                    <ItemTemplate>

                                                        <asp:LinkButton runat="server" Font-Underline ="true"  ToolTip ="View zero biller customers" ForeColor="Navy" ID="hyp_zero" Text='<%# Bind("ZeroBilled")%>' OnClick="hyp_zero_Click"></asp:LinkButton>
                                                        <asp:HiddenField runat="server" ID="HVanID" Value='<%# Bind("SalesRep_ID")%>' />
                                                         <asp:HiddenField runat="server" ID="Horg" Value='<%# Bind("OrgID")%>' />
                                                    </ItemTemplate>
                                    ...
                                    <asp:HiddenField ID="ZeroVan" runat="server" />
        <asp:HiddenField ID="ZeroHorg" runat="server" />

                                    <asp:SqlDataSource ID="sqlLog" runat="server" ConnectionString="<%$ ConnectionStrings:SWXConnectionString %>"
                                        SelectCommand="app_DashVANLog" SelectCommandType ="StoredProcedure"  OnSelecting="sqlLog_Selecting" >

                                        <SelectParameters >
                                            <asp:ControlParameter ControlID="hfAllVan" Name="VanList" DefaultValue="0" />
