...
Partial Public Class AdminBonusSimple
    ...
    Protected Sub btnAddItems_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAddItems.Click
        ...
        Try
            ...
            If Me.txtDesc.Text = "" Or Me.txtDesc.Text = "0" Then
            ...
            If Me.btnAddItems.Text = "Add" Or (Me.btnAddItems.Text = "Update" And Me.txtDesc.Text <> Me.lblPlanName.Text) Then
                If objProduct.CheckSimpleBonusPlan(Err_No, Err_Desc, Me.ddl_org.SelectedValue.ToString(), Me.txtDesc.Text) = True Then
            ...
            If Me.btnAddItems.Text = "Add" Then
                ...
                PlanId = objProduct.SaveSimpleBonusPlan(Err_No, Err_Desc, Me.ddl_org.SelectedValue.ToString(), Me.txtDesc.Text, CType(Session("User_Access"), UserAccess).UserID, PlanId, Me.ddlType.SelectedValue, ddl_transactionType.SelectedItem.Value)
                ...
                If Not PlanId Is Nothing Then
                    ...
                    objProduct.SaveBonusCategoryMap(Err_No, Err_Desc, Me.lblPlanId.Text, dtCategory, CType(Session("User_Access"), UserAccess).UserID, ddlType.SelectedItem.Value, "N", ddl_org.SelectedItem.Value, ddl_transactionType.SelectedItem.Value, dt)
                    Me.lblinfo1.Text = "Confirmation"
                    Me.lblmessage1.Text = "Scheme successfully saved.Would you like to define the bonus for this plan  '" + Me.txtDesc.Text + "'?."
            ...
            If Me.btnAddItems.Text = "Update" Then
                Dim success As Boolean = objProduct.UpdateSimpleBonusPlan(Err_No, Err_Desc, Me.lblPlanId.Text, Me.txtDesc.Text, CType(Session("User_Access"), UserAccess).UserID, ddl_transactionType.SelectedItem.Value)
                Dim dtCategory As New DataTable
                dtCategory.Columns.Add("Category")
                For Each item As RadComboBoxItem In ddl_Category.CheckedItems
                    Dim dr As DataRow
                ...
                dtCurrentCategory = objProduct.GetSimpleBonusCategoryMap(Err_No, Err_Desc, Me.lblPlanId.Text)
                ...
                success = objProduct.SaveBonusCategoryMap(Err_No, Err_Desc, Me.lblPlanId.Text, dtCategory, CType(Session("User_Access"), UserAccess).UserID, ddlType.SelectedItem.Value, "U", ddl_org.SelectedItem.Value, ddl_transactionType.SelectedItem.Value, dt)
                Dim Msg As String = ""
                ...
                End If
                objLogin.SaveUserLog(Err_No, Err_Desc, "I", "MAIN MENU", "SIMPLE BONUS", Me.lblPlanId.Text, "ID: " & Me.lblPlanId.Text & Msg, CType(Session("User_Access"), UserAccess).UserID.ToString(), "0", "0")
    ...
    Private Sub dgv_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles dgv.RowCommand
        ...
        Try
            If (e.CommandName = "AddItems") Then
                ...
                Else
                    Response.Redirect("BonusDefinitionByValue.aspx?Desc=" & PlanName.Text & "&PGID=" & PlanID & "&ORGID=" & ORGID.Text & "&ORGNAME=" & ORGName, False)
                End If
            ...
            If (e.CommandName = "EditPlan") Then
                ...
                LoadCategory()
                Dim dtCategory As New DataTable
                dtCategory = objProduct.GetSimpleBonusCategoryMap(Err_No, Err_Desc, PlanID)
                ddl_Category.ClearCheckedItems()
