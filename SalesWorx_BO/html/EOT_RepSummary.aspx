<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EOT_RepSummary.aspx.vb" Inherits="SalesWorx_BO.EOT_RepSummary" MasterPageFile="~/html/Site.Master"  %>
 ...
 <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
   ...
   <div class="row">
            ...
            <div class="row">
                 ...
                 <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Sales Rep</label><telerik:RadComboBox Skin="Simple" EmptyMessage="Select Sales Rep"  Filter="Contains"  CheckBoxes="true" EnableCheckAllItemsCheckBox="true"  ID="ddlVan" Width ="100%" 
       ...
       <div class="col-sm-2 col-md-2 col-lg-2">
        ...
        <div id="popoverblkouter">
            ...
            <span class="popoverblk">
              ...
              <p><strong>Sales Rep: </strong> <asp:Label ID="lbl_van" runat="server" Text=""></asp:Label></p>
