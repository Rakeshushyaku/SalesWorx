<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="Rep_SalesbyCustomer.aspx.vb" Inherits="SalesWorx_BO.Rep_SalesbyCustomer" %>
  ...
  <script type="text/javascript">
      ...
      function createChart3() {
          ...
          var dataSource = {
              ...
              transport: {
                  read: {
                      url: "Chart.asmx/GetRepSalesbyCustomer", //specify the URL which should create new records. This is the Create method of the Products.asmx service.
      ...
      function createChart4() {
          ...
          var dataSource = {
              ...
              transport: {
                  read: {
                      url: "Chart.asmx/GetRepNetSalesbyCustomer", //specify the URL which should create new records. This is the Create method of the Products.asmx service.
                      contentType: "application/json; charset=utf-8", // tells the web service to serialize JSON
                      type: "POST", //use HTTP POST request as the default GET is not allowed for ASMX
                      dataType: "json"
                  }
          ...
          $("#chart4").kendoChart({
              ...
              tooltip: {
                  ...
                  color: "white",
                  background: "black",
                  template: "Customer : ${category}  <br> Net  Sales : #=dataItem.Amount# ",
              },
  ...
  EnableLoadOnDemand="True" 
     ...
     <telerik:RadMultiPage ID="RadMultiPage21" runat="server" SelectedIndex="0">
                       <telerik:RadPageView ID="RadPageView1" runat="server">
                           ...
                           <div class="overflowx" >
                                            <div class="chart-wrapper padding0" style="height:650px" id="Chartwrapper1" runat="server" >
 ...
 <div class="overflowx">
                        ...
                        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl ="../assets/img/export-excel.png" OnClientClick="clickExportBiffExcel()" ></asp:ImageButton>
                                        ...
                                        <telerik:RadPageView ID="RadPageView2" runat="server">
                                            ...
                                            <p><br /></p>
                                             <div class="overflowx" >
                                            <div class="chart-wrapper padding0" style="height:650px" id="Chartwrapper" runat="server" >
