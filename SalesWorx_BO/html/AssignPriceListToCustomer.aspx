<%@ Page Title="Assign Price List To Customer" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master"
    CodeBehind="AssignPriceListToCustomer.aspx.vb" Inherits="SalesWorx_BO.AssignPriceListToCustomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
 ...
 <asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h4>Assign Price List To Customer</h4>
      <telerik:RadWindowManager ID="RadWindowManager1"  Skin="Simple" runat="server" EnableShadow="true">
        ...
        <ContentTemplate>
            <div class="row">
                <div class="col-sm-8">
                   <div class="text-primary" style="font-weight:700;padding-bottom:15px;">
                                      <asp:Label ID="lblnote" runat ="server" Text ="Note: Assigning a price list to the customer removes any existing price list assigned to the same customer."></asp:Label>
           ...
           <%-- <p id="pagenote">This screen may be used to assign price list to customers</p>--%>
            <div class="row">
                <div class="col-sm-6 col-md-4">
                      <div class="form-group"><label>
                             Organization <em><span>&nbsp;</span>*</em>
                                    ...
                                    <telerik:RadComboBox Skin="Simple"   ID="ddOraganisation"  AutoPostBack="true"  Width ="100%" runat="server" CssClass="inputSM">
                                      </telerik:RadComboBox>
                                </div>
                      </div>
                <div class="col-sm-6 col-md-4">         
                           <div class="form-group"><label>
                              Price List<em><span>&nbsp;</span>*</em>
                              </label>
                                <telerik:RadComboBox Skin="Simple" ID="ddlPriceList" AutoPostBack="true" Width ="100%" runat="server" CssClass="inputSM"></telerik:RadComboBox>
            ...
            <div class="row">
                     ...
                     <div class="col-sm-6 col-md-4">
                              ...
                              <telerik:RadTextBox runat ="server" ID="txtFilter" EmptyMessage ="Filter By Customer" Skin ="Simple"  Width ="100%"   ></telerik:RadTextBox>
...
<telerik:RadWindow ID="MPEImport" Title= "Import Customer Price List" runat="server" Skin="Windows7" Behaviors="Move,Close"
