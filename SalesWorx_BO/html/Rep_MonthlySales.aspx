<%@ Page Title="Monthly Sales" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="Rep_MonthlySales.aspx.vb" Inherits="SalesWorx_BO.Rep_MonthlySales" %>
   ...
   <div id="Args" runat="server" visible="false">
        <div id="popoverblkouter">
            ...
            <span class="popoverblk">
             ...
             <h6>Note: The report shows Sold quantity and Returned quantity of the selected month</h6>
               <telerik:RadPivotGrid  RenderMode="Lightweight" AllowPaging="true"  PageSize="10" EnableViewState ="true" 
                                                    ...
                                                    <Fields>
                                                        ...
                                                        <telerik:PivotGridColumnField   ShowGroupsWhenNoData="false" DataField="Day" SortOrder="None"  CellStyle-CssClass="nowhitespace" >
                                                         ...
                                                         <telerik:PivotGridAggregateField  IgnoreNullValues="true" DataField="Sold"  SortOrder="None" DataFormatString="{0:#,##0.00}">                 
                                                        </telerik:PivotGridAggregateField>
                                                         <telerik:PivotGridAggregateField  IgnoreNullValues="true" DataField="Returned"  SortOrder="None" DataFormatString="{0:#,##0.00}">                 
                                                        </telerik:PivotGridAggregateField>
