<%@ Page Title="Assortment Plan Details" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master"
    CodeBehind="AssortmentDefinitionValue.aspx.vb" Inherits="SalesWorx_BO.AssortmentDefinitionValue" %>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <label>UOM</label>
                                                            <div class="form-group">
                                                                <telerik:RadComboBox Skin="Simple"  ID="ddlOrdUOM" Filter="Contains"  EmptyMessage ="Select UOM"
                                                                   EnableLoadOnDemand="True" TabIndex="1"  Sort ="Ascending"   AutoPostBack ="true" 
                                                                    MinimumFilterLength="1"  runat="server"  
                                                                    Height="200px" Width="100%">
                                                                </telerik:RadComboBox>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <label>UOM</label>
                                                            <div class="form-group">
                                                                <telerik:RadComboBox Skin="Simple"  ID="ddlGetUOM" Filter="Contains"  EmptyMessage ="Select UOM"
                                                                   EnableLoadOnDemand="True" TabIndex="1"  Sort ="Ascending"   AutoPostBack ="true" 
                                                                    MinimumFilterLength="1"  runat="server"  
                                                                    Height="200px" Width="100%">
                                                                </telerik:RadComboBox>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="">
                                                                  ...
                                                                  <telerik:RadNumericTextBox Skin="Simple" CssClass ="inputSM"  runat="server" ID="txtToQty" Width="100%"
                                                                        ...
                                                                        ErrorMessage="To Value > From Value">
