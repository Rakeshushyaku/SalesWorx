<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="Rep_SalesbySKU.aspx.vb" Inherits="SalesWorx_BO.Rep_SalesbySKU" %>
  ...
  <script type="text/javascript">
      ...
      function createChart3() {
          ...
          var dataSource = {
              ...
              transport: {
                  read: {
                      url: "Chart.asmx/GetRepSalesbySku", //specify the URL which should create new records. This is the Create method of the Products.asmx service.
          ...
          $("#chart3").kendoChart({
              ...
              title: {
                  text: "Sales Vs Returns " + Currency + c,
                  color: "Black",
              ...
              seriesColors: ["#4d5ec1", "#eb6357", "#FF99CC", "#FF9933", "#FFFF99", "#FFCC99", "#9999FF"],
              series: [{
                  name: "Sales",
                  field: "Amount",
                  ...
                  tooltip: {
                      ...
                      format: "{0:N2}",
                      font: "12px Segoe UI",
                      template: "SKU : ${category}  <br>Sales: #=dataItem.Amount# ",
                      color: "white",
                      background: "black"
                  },
              },

               {
                   ...
                   tooltip: {
                       ...
                       format: "{0:N2}",
                       font: "12px Segoe UI",
                       template: "SKU : ${category}  <br>Returns: #=dataItem.ReturnAmount# ",
                       color: "white",
                       background: "black"
                   },
      ...
      function createChart4() {
          ...
          var dataSource = {
              ...
              transport: {
                  read: {
                      url: "Chart.asmx/GetRepNetSalesbySKU", //specify the URL which should create new records. This is the Create method of the Products.asmx service.
                      contentType: "application/json; charset=utf-8", // tells the web service to serialize JSON
                      type: "POST", //use HTTP POST request as the default GET is not allowed for ASMX
                      dataType: "json"
                  }
          ...
          $("#chart4").kendoChart({
              ...
              tooltip: {
                  visible: true,
                  template: "SKU : ${category}  <br> Net  Sales : #=dataItem.Amount# ",
                  format: "{0:N2}",
                  font: "12px Segoe UI",
                  color: "white",
                  background: "black"
  ...
  EnableLoadOnDemand="True" 
     ...
     <telerik:RadMultiPage ID="RadMultiPage21" runat="server" SelectedIndex="0">
                       <telerik:RadPageView ID="RadPageView1" runat="server">
                           ...
                           <div class="overflowx" >
                                            <div class="chart-wrapper padding0" style="height:900px" id="Chartwrapper1" runat="server" >
 ...
 <div class="overflowx">
                    ...
                    <CommandItemSettings ShowExportToExcelButton="false" ShowRefreshButton="false" ShowAddNewRecordButton="false"/>
                                                        <Columns>
                                                             ...
                                                             <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Salesqty" HeaderText="Total Qty Sold<i class='fa fa-info-circle'></i>"
                                                                  SortExpression ="Salesqty" DataType="System.Double" DataFormatString="{0:N2}" HeaderTooltip="Total units sold">
                                                            ...
                                                            <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Sales" HeaderText="Total Sales<i class='fa fa-info-circle'></i>"
                                                                  SortExpression ="Sales" DataType="System.Double" DataFormatString="{0:N2}" HeaderTooltip="Total value of sales">
                                                                <ItemStyle Wrap="False"  HorizontalAlign="Right"  />
                                                                 <HeaderStyle HorizontalAlign="Center" />

                                                           </telerik:GridBoundColumn>
                                                            <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Returnsqty" HeaderText="Total Qty Returned<i class='fa fa-info-circle'></i>"
                                                                  SortExpression ="Returnsqty" DataType="System.Double" DataFormatString="{0:N2}" HeaderTooltip="Total units returned">
                                                                <ItemStyle Wrap="False"  HorizontalAlign="Right"  />
                                                                 <HeaderStyle HorizontalAlign="Center" />
                                                            ...
                                                            <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Returns" HeaderText="Total Returns<i class='fa fa-info-circle'></i>"
                                                                  SortExpression ="Returns" DataType="System.Double" DataFormatString="{0:N2}" HeaderTooltip="Total value of returns">
                                                                <ItemStyle Wrap="False"  HorizontalAlign="Right"  />
                                                                 <HeaderStyle HorizontalAlign="Center" />
                                                            ...
                                                            <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="NetsalesQty" HeaderText="Net Sales Qty<i class='fa fa-info-circle'></i>"  
                                                                  SortExpression ="NetsalesQty" DataType="System.Double" DataFormatString="{0:N2}" HeaderTooltip="Net Sales Quantity">
                                                                <ItemStyle Wrap="False"  HorizontalAlign="Right"  />
                                                                 <HeaderStyle HorizontalAlign="Center" />
                                                             ...
                                                             <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="AvgQtySold" HeaderText="Avg Qty Sold<i class='fa fa-info-circle'></i>"
                                                                  SortExpression ="AvgQtySold" DataType="System.Double" DataFormatString="{0:N2}" HeaderTooltip="Average quantity sold per invoice">
                                                                <ItemStyle Wrap="False"  HorizontalAlign="Right"  />
                                                                 <HeaderStyle HorizontalAlign="Center" />
                                        ...
                                        <telerik:RadPageView ID="RadPageView2" runat="server">
                                            ...
                                            <p><br /></p>
                                             <div class="overflowx" >
                                            <div class="chart-wrapper padding0" style="height:900px" id="Chartwrapper" runat="server" >
