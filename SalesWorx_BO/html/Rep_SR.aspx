<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="Rep_SR.aspx.vb" Inherits="SalesWorx_BO.Rep_SR" %>
                                               ...
                                               <div class="col-sm-10 col-md-10 col-lg-10">
                                                   <div class="row">
                                                       ...
                                                       <div class="col-sm-3">
                                                           <div class="form-group">
                                                               <label>Van </label>
                                                               <telerik:RadComboBox Skin="Simple" ID="ddlVan" EmptyMessage="Select Van" Width="100%" runat="server" DataTextField="SalesRep_Name" DataValueField="SalesRep_ID" Filter="Contains" CheckBoxes="true" EnableCheckAllItemsCheckBox="true">
                                                               </telerik:RadComboBox>
                                                           </div>
                                                       </div>
                                                       <div class="col-sm-3">
                    ...
                    runat="server" >
                           ...
                           <telerik:RadGrid ID="gvRep" AllowSorting="True" AutoGenerateColumns="False" Skin="Simple" Width="100%" BorderColor="LightGray" EnableHeaderContextMenu="true"
                            ...
                            <HeaderStyle HorizontalAlign="Center" />
                                       ...
                                       <telerik:GridBoundColumn HeaderStyle-HorizontalAlign="Left" DataField="Customer_Ref_No" HeaderText="Order Ref No."
                                           SortExpression="Order_Ref_No">
                                           <ItemStyle Wrap="True" />
                                       </telerik:GridBoundColumn>

                                       <telerik:GridTemplateColumn UniqueName="Order_Ref_No" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Wrap="false" DataField="Order_Ref_No" SortExpression="Order_Ref_No"
                                           HeaderText="Order Ref No.">
                                           <ItemTemplate>
                                               <asp:HiddenField ID="OID" runat="server" Value='<%# Bind("RowID")%>'></asp:HiddenField>
                                                <asp:HiddenField ID="OID2" runat="server" Value='<%# Bind("Order_Ref_No")%>'></asp:HiddenField>
                                               <asp:LinkButton ID="Lnk_OrderRefID" runat="server" Text='<%# Bind("Order_Ref_No")%>' ForeColor="SteelBlue" Font-Underline="true" OnClientClick='<%# String.Format("OpenViewWindow(""{0}"", ""{1}"");", Eval("RowID"), Eval("Order_Ref_No"))%>'></asp:LinkButton>
                                           </ItemTemplate>
                                              <ItemStyle Wrap="false" />
                                       </telerik:GridTemplateColumn>
