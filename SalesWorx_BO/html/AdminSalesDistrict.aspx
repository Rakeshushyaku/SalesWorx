<%@ Page Title="Sales Districts" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/Site.Master" CodeBehind="AdminSalesDistrict.aspx.vb" Inherits="SalesWorx_BO.AdminSalesDistrict" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function TestCheckBox() {
            ...
            for (var n = 0; n < Inputs.length; ++n)
                ...
                return confirm('Would you like to delete the selected sales districts?');
                return true;
            }
            alert('Select at least one sales districts!');
            return false;
   ...
   <h4>Sales District Management</h4>
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <telerik:RadComboBox Skin="Simple"  ID="ddFilterBy" Width="100%" Height="250px" TabIndex="2" runat="server">
                                                    <Items>
                                                        ...
                                                        <telerik:RadComboBoxItem Value="District Code" Text="District Code"></telerik:RadComboBoxItem>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <asp:Button ID="btnclearFilter" runat="server" CausesValidation="false" CssClass ="btn btn-default"  OnClick="btnclearFilter_Click" TabIndex="3" Text="Clear Filter" />
                                       ...
                                       <div class="mrgbtm">
                                            ...
                                            <div class="form-group">
                                                 ...
                                                 <telerik:RadButton ID="btnExport" Skin="Simple" Text="Export Sales Districts" runat="server" CssClass="btn btn-primary"></telerik:RadButton>
                ...
                <label>
                    ...
                    <telerik:RadToolTip RenderMode="Lightweight" runat="server" ID="RadToolTip1" RelativeTo="Element" Width="300px" AutoCloseDelay="30000" BackColor="WhiteSmoke"
                        ...
                        <p style="color: darkolivegreen; padding-left: 10px; font-size: 12px;">
                            ...
                            New Sales Districts will be uploaded. Existing Districts and invalid rows are ignored.

           <br />
                            <br />
                            <b style="color: green;"><u>Validations</u></b><br />
                            <ul>
                                <li type="square">Description is mandatory.</li>
                                <li type="square">SalesDistricts Sheet contains only two columns named as Description,Code.</li>
                                <li type="square">SalesDistricts Sheet name should be SalesDistrict.</li>
                            </ul>
                    ...
                    <telerik:RadButton ID="btnClear" Skin="Simple" Visible="false" runat="server" CssClass="btn btn-default" Text="Reset">
                            ...
                            <asp:UpdatePanel ID="ClassUpdatePnl" runat="server" UpdateMode="conditional">
                                <ContentTemplate>
                                                ...
                                                <asp:GridView Width="100%" ID="grdSalesDistrict" runat="server" EmptyDataText="No Sales District to Display"
                                                    EmptyDataRowStyle-Font-Bold="true"  AutoGenerateColumns="False"
                                                    AllowPaging="True" AllowSorting="true"  PageSize="25" CellPadding="0" 
                                                    CellSpacing="0" CssClass="tablecellalign">
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:ImageButton ToolTip="Delete Sales District" ID="btnDelete" OnClick="btnDelete_Click"
                                                                    runat="server" CausesValidation="false"  ImageUrl="~/images/delete-13.png" OnClientClick="javascript:return confirm('Would you like to delete the selected sales district?');" />
                                                                <asp:ImageButton ID="btnEdit" ToolTip="Edit Sales District" runat="server" CausesValidation="false"
                                                                    ImageUrl="~/images/edit-13.png"   OnClick="btnEdit_Click" />
                                                            </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="Left" Width="100px" CssClass="display-block"  />
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="Description" HeaderText="Sales District" SortExpression="Description">
                                                            <ItemStyle Wrap="False" />
                                                        </asp:BoundField>
                                                        
                                                         <asp:BoundField DataField="Sales_District_Code" HeaderText="Sales District Code" SortExpression="Sales_District_Code">
                                                            <ItemStyle Wrap="False" />
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:TemplateField Visible="False">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblSales_District" runat="server" Text='<%# Bind("Sales_District_ID") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                   ...
                                   <telerik:RadWindow ID="MPEDetails" Title= "Sales District Details" runat="server" Skin="Windows7" Behaviors="Move,Close"
                                ...
                                <ContentTemplate>
                                    <div class="popupcontentblk">
                                            ...
                                            <div class="row">
		                                        ...
		                                        <div class="col-sm-7">
			                                        <div class="form-group">
                                                        <asp:TextBox ID="txtDescription" runat="server" TabIndex="1" CssClass="inputSM" Width="100%"></asp:TextBox>
                                         ...
                                         <div class="row">
		                                        <div class="col-sm-5">
			                                        <label>Sales District Code</label>
		                                        </div>
		                                        <div class="col-sm-7">
			                                        <div class="form-group">
                                                        <asp:TextBox ID="txtcode" runat="server" TabIndex="1" CssClass="inputSM" Width="100%"></asp:TextBox>
