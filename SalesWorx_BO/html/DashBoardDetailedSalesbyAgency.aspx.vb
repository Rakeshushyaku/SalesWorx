...
Imports log4net
Public Class DashBoardDetailedSalesbyAgency
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Try
                ...
                dt = (New SalesWorx.BO.Common.Reports).GetSalesbyAgency(Err_No, Err_Desc, HUID.Value, CDate(txtFromDate.SelectedDate).ToString("MM-yyyy"))
