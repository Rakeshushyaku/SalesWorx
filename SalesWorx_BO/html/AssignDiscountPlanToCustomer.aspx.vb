...
Public Class AssignDiscountPlanToCustomer
    ...
    Private Sub AssignBonusPlanToCustomer_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        Me.Title = "Assign Discount Plan To Customer"
    End Sub
    Protected Sub lbLog_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbLog.Click
        Try


            If Not Session("CustDiscountLogInfo") Is Nothing Then
                Dim fileValue As String = Session("CustDiscountLogInfo")
    ...
    Private Sub btnImport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnImport.Click
        ...
        If Me.ExcelFileUpload.FileName = Nothing Then
            ...
            Exit Sub
        End If
        Session("dtCustDiscountPlan") = Nothing
                ...
                Try
                    ...
                    If ViewState("FileType") IsNot Nothing And ViewState("FileName") IsNot Nothing Then
                        ...
                        If TempTbl.Columns.Count = 3 Then
                            ...
                            If Not (TempTbl.Columns(0).ColumnName.ToLower = "customerno" And TempTbl.Columns(1).ColumnName.ToLower = "siteid" And TempTbl.Columns(2).ColumnName.ToLower = "discountplanid") Then
                            ...
                            For idx = 0 To TempTbl.Rows.Count - 1
                                ...
                                Else
                                    ...
                                    If IsNumeric(BonusPlanID) = False Then
                                        RowNo = idx + 2
                                        ErrorText = ErrorText + "Discount plan id should be numeric" + ","
                                        TotFailed += 1
                                        isValidRow = False
                                    End If
                                    If ObjCustomer.CheckDiscountPlanIsValid(Err_No, Err_Desc, OrgID, BonusPlanID) = False Then
                                        RowNo = idx + 2
                                        ErrorText = ErrorText + "Discount plan id is invalid." + ","
                                        TotFailed += 1
                                        isValidRow = False
                                    End If
                        ...
                        If ObjCustomer.UploadCustDiscountPlan(TempTbl, Me.ddOraganisation.SelectedValue, Err_No, Err_Desc, CType(Session("User_Access"), UserAccess).UserID.ToString(), DtError) = True Then
                    ...
                    Session.Remove("dtCustDiscountPlan")
                    Session("dtCustDiscountPlan") = dtErrors.Copy
                    ...
                    If dtErrors.Rows.Count > 0 Then
                        lbLog.Visible = True
                    End If
                    Session.Remove("CustDiscountLogInfo")
                    Session("CustDiscountLogInfo") = fn
    ...
    Private Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        Try
            ...
            If Me.ddOraganisation.SelectedIndex > 0 Then
                ...
                dtOriginal = ObjCustomer.ExportCustomerDiscountPlan(Err_No, Err_Desc, OrgID)
                ...
                dtTemp.Columns.Add("DiscountPlanID")
                ...
                For i As Integer = 0 To dtOriginal.Rows.Count - 1
                    ...
                    drAddItem(2) = CInt(dtOriginal.Rows(i)("Discount_Plan_ID").ToString())
                ...
                If dtTemp.Rows.Count > 0 Then
                    ...
                    Dim fn As String = "CustomerDiscountPlan" + Now.ToString("ddMMMyyHHmmss") + ".xls"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not IsPostBack Then
                ...
                Dim Custdiscountflag As Boolean = False

                Custdiscountflag = objProduct.CheckCustDiscountFlag(Err_No, Err_Desc)
                If Custdiscountflag = False Then
    ...
    Private Sub LoadBonusPlan()
        If ddOraganisation.SelectedItem.Text <> "-- Select a Organization --" Then
            ...
            ddlBonusPlan.DataSource = objProduct.LoadDiscountPlan(Err_No, Err_Desc, CType(Session("User_Access"), UserAccess).UserID, ddOraganisation.SelectedValue)
            ddlBonusPlan.Items.Clear()
            ddlBonusPlan.Items.Add(New RadComboBoxItem("-- Select a Plan --"))
            ddlBonusPlan.AppendDataBoundItems = True
            ddlBonusPlan.DataValueField = "Discount_Plan_ID"
    ...
    Private Sub BindDefault()
        ...
        Try
            Err_Desc = Nothing
            Err_No = Nothing
            TempTbl = ObjCustomer.GetAvailableCustomersDiscountPlan(Err_No, Err_Desc, IIf(Me.ddlBonusPlan.SelectedIndex <= 0, "0", Me.ddlBonusPlan.SelectedItem.Value), IIf(Me.ddOraganisation.SelectedIndex <= 0, "0", Me.ddOraganisation.SelectedItem.Value))
    ...
    '        Err_No = "98214"
    '        log.Error(Err_Desc)
    '        Response.Redirect("information.aspx?mode=1&errno=" & Err_No & "&msg=" & AppMsgHandler.GetErrorMessage("PHX_006") & "&next=AssignProducttoEmp.aspx&Title=Message", False)
    '        If Err_Desc Is Nothing Then
    '            log.Error(GetExceptionInfo(ex))
    '        Else
    '            log.Error(Err_Desc)
    ...
    Private Sub BindSelected()
        ...
        Try
            ...
            TempTbl = ObjCustomer.GetAssignedCustomersDiscountPlan(Err_No, Err_Desc, IIf(Me.ddOraganisation.SelectedIndex <= 0, "0", Me.ddOraganisation.SelectedItem.Value), IIf(Me.ddlBonusPlan.SelectedIndex <= 0, "0", Me.ddlBonusPlan.SelectedItem.Value))
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAdd.Click
                ...
                For Each Item As RadListBoxItem In lstDefault.Items
                    If Item.Selected Then
                        If Item.Value <> "0" Then
                            ...
                            ObjCustomer.InsertDiscountPlanToCustomer(CustSite(0).ToString(), CustSite(1).ToString(), Me.ddOraganisation.SelectedItem.Value, Me.ddlBonusPlan.SelectedItem.Value, "Single", Err_No, Err_Desc, DtError)
        ...
        End If
    End Sub
    Function IsValidAssignemnt(CustomerID As String, SiteID As String, PlanID As String)
        ...
        If Me.ddOraganisation.SelectedIndex > 0 And ddlBonusPlan.SelectedItem.Text <> "-- Select a Plan --" Then
            ...
            Try
                ...
                For Each Item As RadListBoxItem In lstSelected.Items
                    If Item.Selected Then
                        CustSite = Item.Value.Split("$")
                        ObjCustomer.DeleteDiscountPlanToCustomer(CustSite(0).ToString(), CustSite(1).ToString(), Me.ddOraganisation.SelectedItem.Value, Me.ddlBonusPlan.SelectedItem.Value, "Single", Err_No, Err_Desc)
                    End If
                Next
                BindDefault()
                BindSelected()
    ...
    Protected Sub btnAddAll_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAddAll.Click
        ...
        If Me.ddOraganisation.SelectedIndex > 0 And ddlBonusPlan.SelectedItem.Text <> "-- Select a Plan --" Then
            Try
                ...
                Dim DtError As New DataTable
                DtError.Columns.Add("Error")
                ObjCustomer.InsertDiscountPlanToCustomer(0, 0, Me.ddOraganisation.SelectedItem.Value, Me.ddlBonusPlan.SelectedItem.Value, "ALL", Err_No, Err_Desc, DtError)
    ...
    Protected Sub btnRemoveAll_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnRemoveAll.Click
        If Me.ddOraganisation.SelectedIndex > 0 And ddlBonusPlan.SelectedItem.Text <> "-- Select a Plan --" Then
            Try
                ...
                ObjCustomer.DeleteDiscountPlanToCustomer(0, 0, Me.ddOraganisation.SelectedItem.Value, Me.ddlBonusPlan.SelectedItem.Value, "ALL", Err_No, Err_Desc)
    ...
    Protected Sub btnBack_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBack.Click
        Response.Redirect("AdminDiscountPlan.aspx", False)
    End Sub
End Class
