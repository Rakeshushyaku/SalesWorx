<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/html/ReportMaster.Master" CodeBehind="RepProductSales.aspx.vb" Inherits="SalesWorx_BO.RepProductSales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<span class="pgtitile3">Product Sales Report</span></div>
...
<table  border="0" cellspacing="2" cellpadding="2">
          <tr>
            ...
            <td><asp:DropDownList CssClass="inputSM" ID="ddlOrganization"  Width ="150px"
                 ...
                 <td  class="txtSMBold">Salesman :</td>
            <td>
                
                
                  <telerik:RadComboBox ID="ddlVan" Filter="Contains"  
          ...
          <tr> 
            ...
            <td>
                <asp:TextBox  ID="txtFromDate" Width ="170px" CssClass="inputSM" runat="server"></asp:TextBox>&nbsp;
            ...
            <td>
                <asp:TextBox  ID="txtToDate" Width ="170px" CssClass="inputSM" runat="server"></asp:TextBox>&nbsp;
          ...
          <tr> 
            ...
            <td>
                  ...
                  <telerik:RadComboBox ID="ddlCustomer" Filter="Contains"  
                                                   EnableLoadOnDemand="True" TabIndex="1" Skin ="Default"   
                                                    MinimumFilterLength="1"  runat="server" 
            ...
            <td>
               ...
               <telerik:RadComboBox ID="ddlRegion" Filter="Contains"  
                                                   EnableLoadOnDemand="True" TabIndex="1" Skin ="Default"   
                                                    MinimumFilterLength="1"  runat="server" 
                                                    Height="200px" Width="170px">
                                                </telerik:RadComboBox>  
              ...
              <tr> 
            <td class="txtSMBold">Channel :</td>
            <td>
                
                
                  <telerik:RadComboBox ID="ddlChannel" Filter="Contains"  
                                                   EnableLoadOnDemand="True" TabIndex="1" Skin ="Default"   
                                                    MinimumFilterLength="1"  runat="server" 
                                                    Height="200px" Width="170px">
                                                </telerik:RadComboBox>          
            ...
            <td>
               ...
               <telerik:RadComboBox ID="ddlSubChannel" Filter="Contains" 
                                                   EnableLoadOnDemand="True" TabIndex="1" Skin ="Default"   
                                                    MinimumFilterLength="1"  runat="server" 
                                                    Height="200px" Width="170px">
                                                </telerik:RadComboBox>  
            ...
            <td>
                  ...
                  <telerik:RadComboBox ID="ddlProduct" Filter="Contains" 
                                                   EnableLoadOnDemand="True" TabIndex="1" Skin ="Default"   
                                                    MinimumFilterLength="1"  runat="server" 
                                                    Height="200px" Width="300px">
                                                </telerik:RadComboBox>          
            ...
            <td>
                ...
                <asp:DropDownList ID="ddlGroupType"  Width ="170px" runat="server" CssClass="inputSM">
                    <asp:ListItem Value="P">Product wise</asp:ListItem>
                    <asp:ListItem Value="C">Customer wise</asp:ListItem>
                    <asp:ListItem Value="S">Salesman wise</asp:ListItem>
                    <asp:ListItem Value="R">Region wise</asp:ListItem>
                    <asp:ListItem Value="A">Channel wise</asp:ListItem>
                    <asp:ListItem Value="T">Sub Channel wise</asp:ListItem>
                </asp:DropDownList>
