...
Public Class DAL_Dashboard
    ...
    Public Function LoadDashTRXStatistics(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal Van As String, ByVal MonthYear As String) As DataTable
        ...
        Try
            objSQLConn = _objDB.GetSQLConnection
            Dim QueryString As String = "Rep_DashVisitTransStatistics"
            objSQLCmd = New SqlCommand(QueryString, objSQLConn)
            objSQLCmd.CommandType = CommandType.StoredProcedure
            objSQLCmd.CommandTimeout = 600
            objSQLCmd.Parameters.AddWithValue("@VanList", Van)
        ...
        Return dt
    End Function
    Public Function LoadDashVisitStatistics(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal Van As String, ByVal MonthYear As String) As DataTable
        Dim objSQLConn As SqlConnection
        Dim objSQLCmd As SqlCommand
        Dim dt As New DataTable
        Try
            objSQLConn = _objDB.GetSQLConnection
            Dim QueryString As String = "Rep_DashVisitStatistics"
            objSQLCmd = New SqlCommand(QueryString, objSQLConn)
            objSQLCmd.CommandType = CommandType.StoredProcedure
            objSQLCmd.CommandTimeout = 600
            objSQLCmd.Parameters.AddWithValue("@VanList", Van)
    ...
    Public Function GetRouteCoverage(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal FSRID As String, ByVal StartDate As String, ByVal EndDate As String, ByVal OID As String) As DataSet
        ...
        End Try
    End Function
    Public Function LoadDashBoard(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal Van As String, ByVal MonthYear As String) As DataSet
        Dim objSQLConn As SqlConnection
        Dim objSQLCmd As SqlCommand
        Dim dt As New DataSet
        Try
            objSQLConn = _objDB.GetSQLConnection
            Dim QueryString As String = "Rep_DashBoard"
            objSQLCmd = New SqlCommand(QueryString, objSQLConn)
            objSQLCmd.CommandType = CommandType.StoredProcedure
            objSQLCmd.CommandTimeout = 600
            objSQLCmd.Parameters.AddWithValue("@VanList", Van)
        ...
        dt = Nothing
    End Function
    Public Function LoadDashBoardVanLog(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal Van As String, ByVal MonthYear As String) As DataSet
        Dim objSQLConn As SqlConnection
        Dim objSQLCmd As SqlCommand
        Dim dt As New DataSet
        Try
            objSQLConn = _objDB.GetSQLConnection
            Dim QueryString As String = "app_DashVANLog"
            objSQLCmd = New SqlCommand(QueryString, objSQLConn)
            objSQLCmd.CommandType = CommandType.StoredProcedure
            objSQLCmd.CommandTimeout = 600
            objSQLCmd.Parameters.AddWithValue("@VanList", Van)
