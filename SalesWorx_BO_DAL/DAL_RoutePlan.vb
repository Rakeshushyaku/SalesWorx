...
Public Class DAL_RoutePlan
    ...
    Public Function DeleteHoliday(ByRef Err_No As Long, ByRef Err_Desc As String, ID As String) As Boolean
        ...
        Try
            ...
            objSQLCmd = New SqlCommand("Delete from TBL_Holiday where ID=@ID", objSQLConn)
            objSQLCmd.CommandType = CommandType.Text
            objSQLCmd.Parameters.Add(New SqlParameter("@ID", SqlDbType.Int))
        ...
        Finally
            ...
            End If
        End Try
        DeleteHoliday = sRetVal
    End Function

    Public Function SaveHoliday(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal HDate As String, Description As String, UserID As String) As Boolean
        Dim objSQLConn As SqlConnection
        Dim objSQLCmd As SqlCommand
        Dim sRetVal As Boolean = False
        Try
            ...
            objSQLCmd = New SqlCommand("app_SaveHoliday", objSQLConn)
            objSQLCmd.CommandType = CommandType.StoredProcedure
            objSQLCmd.Parameters.Add(New SqlParameter("@Date", SqlDbType.VarChar))
            objSQLCmd.Parameters("@Date").Value = HDate
    ...
    Public Function IsPlanUsed(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal _sPlanID As Integer) As Boolean
        ...
        IsPlanUsed = sRetVal
    End Function
    Public Function GetDefaultPlanDetails(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal PlanID As String) As DataTable
        Dim objSQLConn As SqlConnection
        Dim objSQLCmd As SqlCommand
        Try
            'getting MSSQL DB connection.....
            ...
            objSQLCmd.CommandType = CommandType.StoredProcedure
            objSQLCmd.Parameters.Add(New SqlParameter("@Rp_ID", SqlDbType.BigInt))
            objSQLCmd.Parameters("@Rp_ID").Value = PlanID

            Dim SalesRepDs As New DataTable
            Dim SqlAd As SqlDataAdapter
            SqlAd = New SqlDataAdapter(objSQLCmd)
            SqlAd.Fill(SalesRepDs)
            GetDefaultPlanDetails = SalesRepDs
            objSQLCmd.Dispose()
    ...
    Public Function ShowSalesRepsByUD(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal UD_SUB_QRY As String) As DataTable
        ...
        End Try
    End Function
    Public Function GetAllDefaultPlans(ByRef Err_No As Long, ByRef Err_desc As String) As DataTable
        Dim objSQLConn As SqlConnection
        Dim objSQLCmd As SqlCommand
        ...
        Try
            ...
            objSQLCmd = New SqlCommand("app_GetDefPlanAll", objSQLConn)
            objSQLCmd.CommandType = CommandType.StoredProcedure
            ...
            GetAllDefaultPlans = DefRouteDs.Tables("DefaultPlan")
            objSQLCmd.Dispose()
    ...
    Public Function GetCustomerListForRoutePlan(ByRef Error_No As Long, ByRef Error_Desc As String, ByVal SalesRepID As Int64, Optional ByVal Searchfield As String = "", Optional ByVal SearchValue As String = "") As DataTable
        ...
        Try
            ...
            '  sQry = "SELECT A.Customer_ID, A.Site_Use_ID, (A.Customer_Name+'-'+ISNULL(A.Location,'N/A')) As Customer_Name, B.Customer_Class, B.Address, B.City FROM TBL_Customer_Ship_Address  AS A INNER JOIN TBL_Customer As B ON A.Customer_ID=B.Customer_ID  "
            ' sQry = "SELECT A.Customer_ID, A.Site_Use_ID, (A.Customer_Name+'-'+ISNULL(A.Location,'N/A')) As Customer_Name,B.Customer_Class,A.Address, A.City FROM V_FSR_CustomerShipAddress As A inner join TBL_Customer As B ON A.Customer_ID=B.Customer_ID And A.Site_Use_ID = B.Site_Use_ID where A.SalesRep_Id=" & SalesRepID
            sQry = "SELECT DISTINCT  A.Customer_ID, A.Site_Use_ID, (A.Customer_Name) As Customer_Name,A.Customer_No,B.Customer_Class,A.Address, A.City ,S.Cust_Lat As Lat,S.Cust_Long As  Long" +
                    " FROM V_FSR_CustomerShipAddress As A INNER JOIN TBL_Customer_Ship_Address_Map AS Q ON Q.Ship_To_Customer_ID=A.Customer_ID AND Q.Ship_To_Site_ID=A.Site_Use_ID " +
                    " INNER join TBL_Customer As B ON Q.Inv_To_Customer_ID=B.Customer_ID And Q.Inv_To_Site_ID = B.Site_Use_ID  " +
                    " INNER join TBL_Customer_Ship_Address As S ON S.Customer_ID=Q.Ship_To_Customer_ID And S.Site_Use_ID = Q.Ship_To_Site_ID " +
                    " where A.SalesRep_Id=@SalesRepID " & Searchfield & "  Order By A.Customer_Name"
            objSQLConn = _objDB.GetSQLConnection
    ...
    Public Function GetHolidayList(ByRef Err_No As Long, ByRef Err_Desc As String, SearchDateFrom As String, SearchDateTo As String, Description As String) As DataTable
        ...
        Try
            ...
            objSQLConn = _objDB.GetSQLConnection
            Dim Sql As String
            Sql = "Select * from TBL_Holiday where 1=1"
            If (SearchDateFrom <> "") Then
                Sql = Sql & " and Holiday_Date>=convert(datetime,@SearchDateFrom,103)"
            End If
            If (SearchDateTo <> "") Then
                Sql = Sql & " and Holiday_Date<=convert(datetime,@SearchDateTo,103)"
            End If
            If (Description <> "") Then
                Sql = Sql & " and Description like @Description"
            End If
            Sql = Sql & " Order by Holiday_Date"
            objSQLCmd = New SqlCommand(Sql, objSQLConn)
            objSQLCmd.CommandType = CommandType.Text
            If (SearchDateFrom <> "") Then
                objSQLCmd.Parameters.Add(New SqlParameter("@SearchDateFrom", SqlDbType.VarChar))
                objSQLCmd.Parameters("@SearchDateFrom").Value = SearchDateFrom
            End If
            If (SearchDateTo <> "") Then
                objSQLCmd.Parameters.Add(New SqlParameter("@SearchDateTo", SqlDbType.VarChar))
                objSQLCmd.Parameters("@SearchDateTo").Value = SearchDateTo & " 23:59:59"
            End If
            If (Description <> "") Then
                objSQLCmd.Parameters.Add(New SqlParameter("@Description", SqlDbType.VarChar))
                objSQLCmd.Parameters("@Description").Value = "%" & Description & "%"
            ...
            GetHolidayList = DefRouteDs.Tables("ClassList")
            objSQLCmd.Dispose()
    ...
    Public Function InsertFSRPlanDetailsbyDay(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal FSRPlanID As Integer, ByVal Day As Integer, ByVal CustomerID As Integer, ByVal SiteID As Integer, ByVal STime As Date, ByVal ETime As Date, ByRef SqlConn As SqlConnection, ByRef objSQLCmd As SqlCommand, ByRef transaction As SqlTransaction, ByVal DayType As Char, ByVal UserComm As String, ByVal Sequence As String, ByVal Allow_Optimization As String) As Boolean
        ...
        Try
            ...
            objSQLConn = SqlConn
            objSQLCmd = New SqlCommand("app_InsertFSRPlanDetails_byday", objSQLConn)
            objSQLCmd.Transaction = transaction
            objSQLCmd.CommandType = CommandType.StoredProcedure
    ...
    End Function
    Public Function ShowPlanListForReveiwByUD(ByRef Error_No As Long, ByRef Error_Desc As String, ByVal SubQuery As String) As DataTable
        Dim objSQLConn As SqlConnection
        Dim objSQLCmd As SqlCommand
        Dim sQry As String
        ...
        Try
            ...
            sQry = String.Format("Select B.FSR_Plan_ID,A.SalesRep_Name,C.Description,C.Start_Date, C.End_Date,C.No_of_Working_Days,B.Default_Plan_ID,B.SalesRep_ID,C.Site,(CASE WHEN B.Approved='Y' THEN 'Approved' ELSE 'Not Approved' END)AS Status from TBL_FSR as A, TBL_Route_Plan_FSR as B,TBL_Route_Plan_Default as C where A.SalesRep_ID = B.SalesRep_ID AND B.Default_Plan_ID = C.Default_Plan_ID   AND A.SalesRep_ID IN ({0}) ORDER By C.Start_Date DESC, A.SalesRep_Name ASC", SubQuery)
            ...
            ShowPlanListForReveiwByUD = AppPlansDs.Tables("PlansForApproval")
            objSQLCmd.Dispose()
            objSQLCmd = New SqlCommand(sQry, objSQLConn)
            objSQLCmd.ExecuteReader(CommandBehavior.CloseConnection)
            objSQLCmd.Dispose()
    ...
    Function RouteplanForExport(ByRef Err_No As Long, ByRef Err_desc As String, FSR_Plan_ID As String) As DataSet
        ...
        Try
            ...
            Dim sQry As String = "app_RoutePlanForExport"
            objSQLCmd = New SqlCommand(sQry, objSQLConn)
            objSQLCmd.CommandType = CommandType.StoredProcedure
            objSQLCmd.Parameters.Add("@FSR_Plan_ID", FSR_Plan_ID)
            Dim DefRouteDs As New DataSet
            Dim SqlAd As SqlDataAdapter
            SqlAd = New SqlDataAdapter(objSQLCmd)
            SqlAd.Fill(DefRouteDs, "DefaultPlan")
            RouteplanForExport = DefRouteDs
            objSQLCmd.Dispose()
            objSQLCmd.Dispose()
    ...
    Public Function CopyFSRPlan(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal CopyFromDefID As Int64, ByVal CopyFromFSRID As Int64, ByVal CopyToDefID As Int64, ByVal SalesRep_ID As Int64) As Boolean
                    ...
                    If (CInt(ToEndDate.Day) >= DaR("Day")) Then
                        ...
                        If DaR("Day_Type") = "V" Then
                            If Not IsOffDay(TempToDate, dayoff) Then
                                TempCmd = New SqlCommand("SELECT Can_Plan_Visits FROM TBL_Route_Plan_Default_Details where Day=@Day AND Default_Plan_ID=" & CopyToDefID, TempCon)
                                TempCmd.CommandType = CommandType.Text
                                TempCmd.Parameters.AddWithValue("@Day", DaR("Day"))
                                Dr = TempCmd.ExecuteReader()
                                Dim CanPlanVisit As String = "N"
                                If Dr.Read() Then
                                    CanPlanVisit = Dr("Can_Plan_Visits")
                                End If
                                Dr.Close()
                                TempCmd.Dispose()
                                If CanPlanVisit = "Y" Then
        ...
        End Try
    End Function
    'Public Function CopyFSRPlanByWeekDaysFromCS(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal CopyFromDefID As Int64, ByVal CopyFromFSRID As Int64, ByVal CopyToDefID As Int64, ByVal SalesRep_ID As Int64) As Boolean
    '    Dim objSQLConn As SqlConnection
    '    Dim objSQLCmd As SqlCommand
    '    Dim sRetVal As Boolean = False
    '    Dim transaction As SqlTransaction
    ...
    '        TempCmd = New SqlCommand("SELECT   DISTINCT  A.FSR_Plan_Detail_ID, A.FSR_Plan_ID, A.Day, A.Customer_ID, A.Site_Use_ID, A.Start_Time, A.End_Time, A.Day_Type, A.User_Comments FROM         TBL_Route_Plan_FSR_Details AS A INNER JOIN   V_FSR_CustomerShipAddress AS B ON A.Customer_ID = B.Customer_ID AND A.Site_Use_ID = B.Site_Use_ID where B.SalesRep_ID IN(SELECT Salesrep_ID FROM TBL_Route_Plan_FSR WHERE FSR_Plan_ID=A.Fsr_Plan_ID) AND A.FSR_Plan_ID=" & CopyFromFSRID, TempCon)
    '        TempCmd.CommandType = CommandType.Text
    '        SqlAd = New SqlDataAdapter(TempCmd)
    '        FSRDS = New DDL_TBL_Route_Plan_Default_Details
    '        SqlAd.Fill(FSRDS, "FSRTblDetails")
    ...
    '                objSQLCmd = New SqlCommand("SELECT dbo.GetWeekDayNumberOfMonth(@PlanDate)", objSQLConn)
    '                objSQLCmd.Parameters.AddWithValue("@PlanDate", TempDate)
    '                Week_Of_the_Year = objSQLCmd.ExecuteScalar()
    '                objSQLCmd.Dispose()
    ...
    '                    objSQLCmd = New SqlCommand("SELECT dbo.GetWeekDayNumberOfMonth(@PlanDate)", objSQLConn)
    '                    objSQLCmd.Parameters.AddWithValue("@PlanDate", TempToDate)
    '                    To_Week_Of_the_Year = objSQLCmd.ExecuteScalar()
    '                    objSQLCmd.Dispose()
    ...
    '                        tempDBVal = IIf(IsDBNull(tempDBVal), DBNull.Value, tempDBVal)
    '                        MyRow(7) = tempDBVal 'Convert.ToDateTime("1/1/2001
    '                        If DaR("Day_Type") = "V" And IsOffDay(Convert.ToDateTime(ToStartDate.Month & "/" & DaR("Day") & "/" & ToStartDate.Year)) = False Then

    '                            TempCmd = New SqlCommand("SELECT Can_Plan_Visits FROM TBL_Route_Plan_Default_Details where Day=@Day AND Default_Plan_ID=" & CopyToDefID, TempCon)
    '                            TempCmd.CommandType = CommandType.Text
    '                            TempCmd.Parameters.AddWithValue("@Day", TempToDate.Day)
    '                            Dr = TempCmd.ExecuteReader()
    '                            Dim CanPlanVisit As String = "N"
    '                            If Dr.Read() Then
    '                                CanPlanVisit = Dr("Can_Plan_Visits")
    ...
    Public Function CopyFSRPlanByWeekDays(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal CopyFromDefID As Int64, ByVal CopyFromFSRID As Int64, ByVal CopyToDefID As Int64, ByVal SalesRep_ID As Int64) As Boolean
        ...
        Try
            log.Debug("In CopyFSRPlanByWeekDays")
            'getting MSSQL DB connection.....
            objSQLConn = _objDB.GetSQLConnection()
           ...
           GetType(String)))
            ...
            If (FSRPlanDS.Tables("FSRTBL").Rows.Count() = 0) Then
                ...
                For Each DaR As DataRow In FSRDS.Tables("FSRTblDetails").Rows
                    ...
                    'Week_Of_the_Year = objSQLCmd.ExecuteScalar()
                    'objSQLCmd.Dispose()
                    Week_Of_the_Year = GetWeekNumber(TempDate)
                    For i = 1 To CInt(ToEndDate.Day)
                        Dim TempToDate As Date
                        TempToDate = Convert.ToDateTime(ToStartDate.Month & "/" & i & "/" & ToStartDate.Year)
                        Dim To_Week_Of_the_Year As Integer
                        ...
                        To_Week_Of_the_Year = GetWeekNumber(TempToDate)
    ...
    Public Function CopyFSRPlanByWeekDays_bk(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal CopyFromDefID As Int64, ByVal CopyFromFSRID As Int64, ByVal CopyToDefID As Int64, ByVal SalesRep_ID As Int64) As Boolean

        ''Copying first sunday of source to fisrt sunday of destination
        ...
        End Try
    End Function
    Public Function GetWeekNumber_bk(Tdate As Date) As String
        Try
...
Public Function GetCustomerVisitMonth(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal OrgID As String) As DataTable
    ...
    Public Function DefaultPlanUsed(ByVal DefPlanID As Integer, ByRef Err_No As Long, ByRef Err_Desc As String) As Boolean
        ...
        Try
            ...
            objSQLConn = _objDB.GetSQLConnection
            'Dim sQry As String = String.Format("Select Default_Plan_ID,Description,Start_Date,End_Date,No_Of_Working_Days from TBL_Route_Plan_Default where Site='{1}' AND Default_Plan_ID Not In (select Default_Plan_ID from TBL_Route_Plan_FSR where SalesRep_ID='{0}' AND (Approved='Y' OR Approved='U')) and End_Date > getdate() order by Start_Date ASC", SalesRepId, Site)
            Dim sQry As String = "SELECT COUNT(*) FROM TBL_Route_Plan_FSR WHERE Default_Plan_ID =@DefPlanID"
            objSQLCmd = New SqlCommand(sQry, objSQLConn)
            objSQLCmd.Parameters.Add("@DefPlanID", SqlDbType.Int).Value = DefPlanID
            objSQLCmd.CommandType = CommandType.Text
            Cnt = Convert.ToInt32(objSQLCmd.ExecuteScalar())
        ...
        End Try
    End Function
    Public Function GetHolidays(ByVal Month As Integer, ByVal Year As Integer) As DataTable
        Dim objSQLConn As SqlConnection
        Dim objSQLCmd As SqlCommand
        ...
        Try
            'getting MSSQL DB connection.....
            objSQLConn = _objDB.GetSQLConnection
            Dim sQry As String = String.Format("Select * from TBL_Holiday where MONTH(Holiday_Date) = {0} AND YEAR(Holiday_Date) = {1}", Month, Year)
            objSQLCmd = New SqlCommand(sQry, objSQLConn)
            objSQLCmd.CommandType = CommandType.Text
            Dim DefRouteDs As New DataSet
            Dim SqlAd As SqlDataAdapter
            SqlAd = New SqlDataAdapter(objSQLCmd)
            SqlAd.Fill(DefRouteDs, "Holiday")
            GetHolidays = DefRouteDs.Tables("Holiday")
            objSQLCmd.Dispose()
            objSQLCmd.Dispose()
    ...
    End Function
    Public Function GetSiteNew(ByRef Error_No As Long, ByRef Error_Desc As String, ByVal SalesRepID As Int64) As DataTable
        Dim objSQLConn As SqlConnection
        Dim objSQLCmd As SqlCommand
        Dim sQry As String
        ...
        Try
            ...
            sQry = "select * from TBL_FSR F inner join TBL_Org_CTL_DTL O on F.SalesRep_ID=O.SalesRep_ID where F.SalesRep_ID='" & SalesRepID & "'"
            ...
            Dim SqlAd As SqlDataAdapter
            SqlAd = New SqlDataAdapter(objSQLCmd)
            SqlAd.Fill(DefRouteDs, "SiteDetails")

            GetSiteNew = DefRouteDs.Tables("SiteDetails")
            objSQLCmd.Dispose()
            objSQLCmd = New SqlCommand(sQry, objSQLConn)
            objSQLCmd.ExecuteReader(CommandBehavior.CloseConnection)
    ...
    Public Function GetFSRPlanStartEnd_Map(ByRef Err_No As Long, ByRef Err_Desc As String, FSRPlanID As String) As DataTable
        ...
        Try
            ...
            objSQLConn = _objDB.GetSQLConnection
            Dim SqlStr As String
            objSQLCmd = New SqlCommand("app_GetFSRPlanStartEnd_Map", objSQLConn)
            objSQLCmd.CommandType = CommandType.StoredProcedure
            objSQLCmd.Parameters.Add(New SqlParameter("@FSRPlanID", SqlDbType.BigInt))
            objSQLCmd.Parameters("@FSRPlanID").Value = FSRPlanID

            Dim SalesRepDs As New DataTable
            Dim SqlAd As SqlDataAdapter
            SqlAd = New SqlDataAdapter(objSQLCmd)
            SqlAd.Fill(SalesRepDs)
            GetFSRPlanStartEnd_Map = SalesRepDs
            objSQLCmd.Dispose()
