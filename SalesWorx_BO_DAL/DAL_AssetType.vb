...
Public Class DAL_AssetType
    ...
    Public Function GetCustomerandsiteId(ByVal CustNo As String, ByVal OrgID As String, ByRef Err_No As Long, ByRef Err_Desc As String) As DataRow
        ...
        Return row
    End Function
    Public Function InsertAssets(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal userid As Integer, ByVal AssetType As Integer, ByVal CustID As Integer, ByVal SiteID As String, ByVal AssetCode As String, ByVal Description As String, ByVal IsActive As String, ASsetValue As Decimal) As Boolean
        Dim objSQLConn As SqlConnection
        Dim objSQLCmd As SqlCommand
        Dim bRetVal As Boolean = False
        Try
            ...
            objSQLCmd.Parameters.AddWithValue("@UserID", userid)
            objSQLCmd.Parameters.AddWithValue("@AssetValue", ASsetValue)
            objSQLCmd.ExecuteNonQuery()
            bRetVal = True
            objSQLCmd.Dispose()
            objSQLCmd = Nothing
    ...
    Public Function UpdateAssets(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal AssetID As String, ByVal AssetType As Integer, ByVal userid As Integer, ByVal CustID As Integer, ByVal SiteID As String, ByVal AssetCode As String, ByVal Description As String, ByVal IsActive As String, AssetValue As Decimal) As Boolean
        Dim objSQLConn As SqlConnection
        Dim objSQLCmd As SqlCommand
        Dim bRetVal As Boolean = False
        Try
    ...
    Public Function FillAssetTypeGrid(ByRef Err_No As Long, ByRef Err_Desc As String) As DataTable
        ...
        Return h
    End Function
    Public Function GetAssetID(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal AssetID As String, ByVal orgId As String) As DataTable
        Dim objSQLConn As SqlConnection
        Dim objSQLDA As SqlDataAdapter
        Dim h As New DataTable
        Try
            objSQLConn = _objDB.GetSQLConnection
            objSQLDA = New SqlDataAdapter("SELECT *,(Select Customer_no + ' - '+ Customer_name as Customer from dbo.app_GetOrgCustomerShipAddress(@OrgID) A where A.Customer_ID=B.Customer_ID and A.Site_Use_ID=B.Site_Use_ID) as Customer FROM TBL_Assets B WHERE Asset_ID=@AssetID", objSQLConn)
            objSQLDA.SelectCommand.CommandType = CommandType.Text
        ...
        Try
            ...
            For Each r As DataRow In dtData.Rows
                If r("IsValid").ToString() = "Y" Then
                    ...
                    objSQLCmd.Parameters.AddWithValue("@AssetValue", CDec(IIf(r("AssetValue").ToString() = "" Or r("AssetValue") Is DBNull.Value, 0, r("AssetValue").ToString())))
