...
Public Class DAL_DivConfig
    ...
    End Function
    Public Function InsertDivConfig(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal OrgID As Integer, ByVal Allow_Manual_FOC As String, ByVal Odo_Reading_At_Visit As String, ByVal Advance_PDC_Posting As Integer, ByVal FSRConfigList As ArrayList, ByVal PrintFormat As String, ByVal CollectionOutputFolder As String, ByVal CNLimit As Decimal, ByVal CreatedBy As Integer, ByVal CustomerSeq As Decimal, ByVal TRN As String, ByVal DeliveryCutoffTime As String) As Boolean
        Dim objSQLConn As SqlConnection
        ...
        Try
            ...
            objSQLCmd.Parameters.Add(New SqlParameter("@CustSeq", SqlDbType.VarChar, 100))
            objSQLCmd.Parameters("@CustSeq").Value = CStr(CustomerSeq)
            objSQLCmd.Parameters.Add(New SqlParameter("@CreatedBy", SqlDbType.Int))
            objSQLCmd.Parameters("@CreatedBy").Value = CreatedBy

            objSQLCmd.Parameters.Add(New SqlParameter("@TRN", SqlDbType.VarChar, 50))
            objSQLCmd.Parameters("@TRN").Value = TRN

            objSQLCmd.Parameters.Add(New SqlParameter("@DeliveryCutoffTime", SqlDbType.VarChar, 50))
            objSQLCmd.Parameters("@DeliveryCutoffTime").Value = DeliveryCutoffTime
    ...
    Public Function UpdateDivConfig(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal OrgID As Integer, ByVal Allow_Manual_FOC As String, ByVal Odo_Reading_At_Visit As String, ByVal Advance_PDC_Posting As Integer, ByVal DivConfigID As Integer, ByVal FSRConfigList As ArrayList, ByVal PrintFormat As String, ByVal CollectionOutputFolder As String, ByVal CNLimit As Decimal, ByVal Updatedby As Integer, ByVal CustomerSeq As Decimal, ByVal TRN As String, ByVal DeliveryCutoffTime As String) As Boolean
        Dim objSQLConn As SqlConnection
        Dim objSQLCmd As SqlCommand
        Dim bRetVal As Boolean = False
        Try
