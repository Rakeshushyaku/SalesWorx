...
Public Class DAL_AppControl
    ...
    Public Function LoadAppControlParams(ByRef Error_No As Long, ByRef Error_Desc As String, ByVal ParentNode As String) As DataTable
        ...
        Return dt
    End Function
    Public Function AppCodeExists(ByVal CodeType As String, Code As String) As Boolean
        Dim objSQLConn As SqlConnection
        Dim objSQLCmd As SqlCommand
        Dim sQry As String
        ...
        Try
            ...
            sQry = "SELECT COUNT(*) FROM TBL_App_Codes  WHERE Code_Type=@CodeType and Code_Value=@Code and isnull(Custom_Attribute_3,'N')='Y'"


            objSQLCmd = New SqlCommand(sQry, objSQLConn)
            objSQLCmd.CommandType = CommandType.Text
            objSQLCmd.Parameters.AddWithValue("@CodeType", CodeType)
    ...
    Public Function SaveAppCodes(ByRef Error_No As Long, ByRef Error_Desc As String, CodeType As String, Code As String, Description As String, CreatedBy As Integer) As Boolean
        ...
        Catch ex As Exception
            ...
            Error_No = 13551
            Error_Desc = String.Format("Error while saving: {0}", ex.Message)
    ...
    Public Function DeleteAppcode(ByRef Err_No As Long, ByRef Err_Desc As String, Type As String, Key As String) As Boolean
        ...
        Try
            ...
            objSQLCmd = New SqlCommand("update TBL_App_Codes set Custom_Attribute_3='N' where Code_Type=@Code_Type and Code_Value=@Code_Value", objSQLConn)
            objSQLCmd.CommandType = CommandType.Text
            objSQLCmd.Parameters.Add(New SqlParameter("@Code_Type", SqlDbType.VarChar, 50))
            objSQLCmd.Parameters("@Code_Type").Value = Key
            objSQLCmd.Parameters.Add(New SqlParameter("@Code_Value", SqlDbType.VarChar, 50))
            objSQLCmd.Parameters("@Code_Value").Value = Type
            objSQLCmd.ExecuteNonQuery()
            sRetVal = True
            objSQLCmd.Dispose()
        Catch ex As Exception
    ...
    Public Function LoadReturnPurpose(ByRef Error_No As Long, ByRef Error_Desc As String, Type As String) As DataTable
        ...
        Try
            objSQLConn = _objDB.GetSQLConnection
            objSQLCmd = New SqlCommand("SELECT Code_Type,Code_Value,Code_Description, Last_Updated_At,(SELECT UserName FROM TBL_User WHERE User_ID=A.Last_Updated_By)AS LastUpdatedBy FROM TBL_App_Codes AS A WHERE Code_Type='" & Type & "'", objSQLConn)
            Dim MsgDs As New DataSet
            Dim SqlAd As SqlDataAdapter
            SqlAd = New SqlDataAdapter(objSQLCmd)
            SqlAd.Fill(dt)
    ...
    Public Function LoadAppCodeTypes(ByRef Error_No As Long, ByRef Error_Desc As String) As DataTable
        ...
        Try
            objSQLConn = _objDB.GetSQLConnection
            objSQLCmd = New SqlCommand("SELECT DISTINCT Code_Type AS Code,Code_Type  AS Description FROM TBL_App_Codes WHERE ISNULL(Custom_attribute_2,'System')<>'System' and  ISNULL(Custom_attribute_3,'N')='Y' ORDER BY Description ", objSQLConn)
            Dim MsgDs As New DataSet
            Dim SqlAd As SqlDataAdapter
            SqlAd = New SqlDataAdapter(objSQLCmd)
            SqlAd.Fill(dt)
    ...
    Public Function LoadParamDropdown(ByRef Error_No As Long, ByRef Error_Desc As String, ByVal ControlKey As String) As DataTable
        ...
        Try
            objSQLConn = _objDB.GetSQLConnection
            If ControlKey = "ROUTEPLAN_DAY_OFF" Then
                objSQLCmd = New SqlCommand("SELECT Code_Value as Code, Code_Description As Description FROM TBL_App_Codes WHERE Code_Type=@ControlKey Order By CAST(ISNULL(Custom_Attribute_1,'0')AS  INT)", objSQLConn)
            Else
    ...
    Public Function LoadRecipientType(ByRef Error_No As Long, ByRef Error_Desc As String) As DataTable
        ...
        Try
            objSQLConn = _objDB.GetSQLConnection
            objSQLCmd = New SqlCommand("SELECT DISTINCT Code_Value AS Code,Code_Description  AS Description FROM TBL_App_Codes WHERE Code_Type='PUSH_RECIPIENT_TYPE' ORDER BY Description ", objSQLConn)
            Dim MsgDs As New DataSet
            Dim SqlAd As SqlDataAdapter
            SqlAd = New SqlDataAdapter(objSQLCmd)
            SqlAd.Fill(dt)
        ...
        Return dt
    End Function
    Public Function SavePushNotification(ByRef Error_No As Long, ByRef Error_Desc As String, Title As String, Description As String, RecipientType As String, RecipientList As String, CreatedBy As Integer) As Boolean
        Dim objSQLConn As SqlConnection
        Dim objSQLCmd As SqlCommand
        Dim sQry As String
        ...
        Try
            ...
            objSQLCmd.Parameters.AddWithValue("@Description", Description)
            objSQLCmd.Parameters.AddWithValue("@ReceipientType", RecipientType)
            objSQLCmd.Parameters.AddWithValue("@CreatedBy", CreatedBy)
            objSQLCmd.Parameters.AddWithValue("@RecipientList", RecipientList)
    ...
    Public Function LoadRecipientUsers(ByRef Error_No As Long, ByRef Error_Desc As String, UID As Integer) As DataTable
        ...
        Try
            objSQLConn = _objDB.GetSQLConnection
            objSQLCmd = New SqlCommand("app_GetMsgRecipientUsers", objSQLConn)
            objSQLCmd.CommandType = CommandType.StoredProcedure
    ...
    Public Function LoadRecipientsforReview(ByRef Error_No As Long, ByRef Error_Desc As String, UID As Integer) As DataTable
        ...
        Try
            objSQLConn = _objDB.GetSQLConnection
            objSQLCmd = New SqlCommand("app_MSgRecipientsForRecall", objSQLConn)
            objSQLCmd.CommandType = CommandType.StoredProcedure
            objSQLCmd.Parameters.AddWithValue("@UID", UID)
            Dim MsgDs As New DataSet
            Dim SqlAd As SqlDataAdapter
    ...
    Public Function LoadRecipients(ByRef Error_No As Long, ByRef Error_Desc As String, UID As Integer) As DataTable
        ...
        Try
            objSQLConn = _objDB.GetSQLConnection
            objSQLCmd = New SqlCommand("SELECT Username AS UserID  ,(SELECT TOP 1 SalesRep_Name FROM TBL_FSR WHERE SalesRep_ID =A.SalesRep_ID)AS UserName FROM TBL_User AS A WHERE Is_SS='N' AND SalesRep_ID  IN(SELECT SalesRep_ID FROM dbo.app_GetControlInfo(@UID))  order by Username ASC ", objSQLConn)
            objSQLCmd.Parameters.AddWithValue("@UID", UID)
            Dim MsgDs As New DataSet
            Dim SqlAd As SqlDataAdapter
            SqlAd = New SqlDataAdapter(objSQLCmd)
