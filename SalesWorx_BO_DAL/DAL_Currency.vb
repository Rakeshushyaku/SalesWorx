...
Public Class DAL_Currency
    ...
    Public Function InsertCurrency(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal CurrencyCode As String, ByVal Description As String, ByVal ConvertRate As Decimal, ByVal DecimalDigits As Integer, Country As String) As Boolean
        Dim objSQLConn As SqlConnection
        Dim objSQLCmd As SqlCommand
        ...
        Try
            ...
            objSQLCmd.Parameters.Add(New SqlParameter("@Country", SqlDbType.VarChar, 100))
    ...
    Public Function UpdateCurrency(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal CurrencyCode As String, ByVal Description As String, ByVal ConvertRate As Decimal, ByVal DecimalDigits As Integer, Country As String) As Boolean
        Dim objSQLConn As SqlConnection
        Dim objSQLCmd As SqlCommand
        Dim bRetVal As Boolean = False
    ...
    Public Function FillCountry(ByRef Err_No As Long, ByRef Err_Desc As String) As DataTable
        ...
        Try
            objSQLConn = _objDB.GetSQLConnection
            objSQLDA = New SqlDataAdapter("SELECT * FROM TBL_App_Codes where Code_Type='COUNTRY' ORDER BY Code_Value", objSQLConn)
            objSQLDA.Fill(dtCountry)
            objSQLDA.Dispose()
        Catch ex As Exception
            Err_No = "740021"
            Err_Desc = ex.Message
