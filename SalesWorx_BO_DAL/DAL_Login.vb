...
Public Class DAL_Login
    ...
    Public Function LoadRights(ByRef Error_No As Long, ByRef Error_Desc As String) As DataTable
        ...
        Catch ex As Exception
            Error_No = 75001
            Error_Desc = String.Format("Error while loading rights: {0}", ex.Message)
        Finally
            objSQLCmd = Nothing
    ...
    Function SaveGroup(ByRef Err_No As Long, ByRef Err_Desc As String, name As String, SalesRepIDs As String, ByVal ID As String, UserID As String, Org_HE_ID As String) As Boolean
        ...
        Try
            ...
            Dim QueryString As String = "app_SaveUserGroup"
            objSQLCmd = New SqlCommand(QueryString, objSQLConn)
            objSQLCmd.CommandType = CommandType.StoredProcedure
            objSQLCmd.Parameters.Add("@ID", SqlDbType.Int).Value = ID
            objSQLCmd.Parameters.Add("@Name", SqlDbType.VarChar).Value = name
            objSQLCmd.Parameters.Add("@SalesRepID", SqlDbType.VarChar).Value = SalesRepIDs
            objSQLCmd.Parameters.Add("@UserID", SqlDbType.Int).Value = UserID
            objSQLCmd.Parameters.Add("@Org_HE_ID", SqlDbType.VarChar).Value = Org_HE_ID
            objSQLCmd.ExecuteNonQuery()
            success = True
            objSQLCmd.Dispose()
        Catch ex As Exception
        ...
        Return success
    End Function
    Public Function DeleteGroup(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal ID As String) As Boolean
        Dim objSQLConn As SqlConnection
        Dim objSQLCmd As SqlCommand
        Dim success As Boolean = False
        Try
            ...
            Dim QueryString As String = "DeleteUserGroup"
            objSQLCmd = New SqlCommand(QueryString, objSQLConn)
            objSQLCmd.CommandType = CommandType.StoredProcedure
            objSQLCmd.Parameters.Add("@ID", SqlDbType.Int).Value = ID
            objSQLCmd.ExecuteNonQuery()
        ...
        Return success
    End Function
    Public Function GetuserGroups(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal SearchParams As String) As DataTable
        Dim objSQLConn As SqlConnection
        Dim dt As New DataTable
        ...
        Try
            objSQLConn = _objDB.GetSQLConnection
            objSQLDA = New SqlDataAdapter("app_GetUserGroups", objSQLConn)
            objSQLDA.SelectCommand.CommandType = CommandType.StoredProcedure

            objSQLDA.SelectCommand.Parameters.AddWithValue("@Name", SearchParams)
    ...
    Public Function GetUserGroupDetails(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal ID As String) As DataTable
        ...
        Try
            objSQLConn = _objDB.GetSQLConnection
            objSQLDA = New SqlDataAdapter("app_GetUserGroupsDetails", objSQLConn)
            objSQLDA.SelectCommand.CommandType = CommandType.StoredProcedure
    ...
    Public Function IfGroupNameExists(ByRef Err_No As Long, ByRef Err_Desc As String, ByVal ID As String, Name As String) As Boolean
        ...
        Try
            objSQLConn = _objDB.GetSQLConnection
            objSQLDA = New SqlDataAdapter("app_IfGroupNameExists", objSQLConn)
            objSQLDA.SelectCommand.CommandType = CommandType.StoredProcedure
